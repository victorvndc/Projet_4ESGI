...
__copyright__ = 'Copyright 2015-2023 VMware, Inc.  All rights reserved. -- VMware Confidential'  # pylint: disable=line-too-long
        ...
        for service in services:
            ...
            if service:
                ...
                try:
                    ...
                    spec = inspect.getfullargspec(register_fn)
                    if spec.args:  # pylint: disable=W1505
