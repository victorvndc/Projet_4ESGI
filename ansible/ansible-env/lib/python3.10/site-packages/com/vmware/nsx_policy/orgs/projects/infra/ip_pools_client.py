...
#
# vAPI stub file for package com.vmware.nsx_policy.orgs.projects.infra.ip_pools.
#---------------------------------------------------------------------------
...
class IpAllocations(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.orgs.projects.infra.ip_pools.ip_allocations'
    """
...
class IpSubnets(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.orgs.projects.infra.ip_pools.ip_subnets'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    def delete(self,
        ...
        :type  ignore_ip_allocations: :class:`bool` or ``None``
        :param ignore_ip_allocations: Flag to specify whether to ignore ip allocations. (optional,
            default to false)
        :raise: :class:`com.vmware.vapi.std.errors_client.InvalidRequest` 
            Bad Request, Precondition Failed
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized` 
        ...
        return self._invoke('delete',
                            ...
                            'ignore_ip_allocations': ignore_ip_allocations,
                            })
...
class _IpAllocationsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        delete_rest_metadata = OperationRestMetadata(
            http_method='DELETE',
            url_template='/policy/api/v1/orgs/{org-id}/projects/{project-id}/infra/ip-pools/{ip-pool-id}/ip-allocations/{ip-allocation-id}',
            path_variables={
                'org_id': 'org-id',
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/orgs/{org-id}/projects/{project-id}/infra/ip-pools/{ip-pool-id}/ip-allocations',
            path_variables={
                'org_id': 'org-id',
                'project_id': 'project-id',
                'ip_pool_id': 'ip-pool-id',
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.orgs.projects.infra.ip_pools.ip_allocations',
...
class _IpSubnetsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        delete_input_type = type.StructType('operation-input', {
            ...
            'ignore_ip_allocations': type.OptionalType(type.BooleanType()),
        })
        delete_error_dict = {
            'com.vmware.vapi.std.errors.invalid_request':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidRequest'),
        ...
        delete_rest_metadata = OperationRestMetadata(
            http_method='DELETE',
            url_template='/policy/api/v1/orgs/{org-id}/projects/{project-id}/infra/ip-pools/{ip-pool-id}/ip-subnets/{ip-subnet-id}',
            path_variables={
                'org_id': 'org-id',
                'project_id': 'project-id',
                'ip_pool_id': 'ip-pool-id',
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/orgs/{org-id}/projects/{project-id}/infra/ip-pools/{ip-pool-id}/ip-subnets',
            path_variables={
                'org_id': 'org-id',
                'project_id': 'project-id',
                'ip_pool_id': 'ip-pool-id',
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.orgs.projects.infra.ip_pools.ip_subnets',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
