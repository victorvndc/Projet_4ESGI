...
#
# vAPI stub file for package com.vmware.nsx_policy.infra.realized_state.enforcement_points.services.
#---------------------------------------------------------------------------
...
class Nsservices(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.realized_state.enforcement_points.services.nsservices'
    """
    ...
    def get(self,
        ...
        :type  nsservice_name: :class:`str`
        :param nsservice_name: NSService Name (required)
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx_policy.infra.realized_state.enforcement_points.services.Nsservices.get is deprecated.', DeprecationWarning)
        return self._invoke('get',
                            {
                            'enforcement_point_name': enforcement_point_name,
                            'nsservice_name': nsservice_name,
                            })
    ...
    def list(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx_policy.infra.realized_state.enforcement_points.services.Nsservices.list is deprecated.', DeprecationWarning)
...
class _NsservicesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/realized-state/enforcement-points/{enforcement-point-name}/services/nsservices/{nsservice-name}',
            path_variables={
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/realized-state/enforcement-points/{enforcement-point-name}/services/nsservices',
            path_variables={
                'enforcement_point_name': 'enforcement-point-name',
            },
             header_parameters={
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.realized_state.enforcement_points.services.nsservices',
