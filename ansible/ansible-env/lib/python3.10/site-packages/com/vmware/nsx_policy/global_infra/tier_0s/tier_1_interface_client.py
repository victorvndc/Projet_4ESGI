...
#
# vAPI stub file for package com.vmware.nsx_policy.global_infra.tier_0s.tier_1_interface.
#---------------------------------------------------------------------------
...
class ArpTable(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.global_infra.tier_0s.tier_1_interface.arp_table'
    """
...
class Statistics(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.global_infra.tier_0s.tier_1_interface.statistics'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    def get(self,
        ...
        """
        Get tier-0 router link statistics information for a given linked tier-1
        interface.
...
class _ArpTableStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/global-infra/tier-0s/{tier-0-id}/tier-1-interface/arp-table',
            path_variables={
                'tier0_id': 'tier-0-id',
            },
             header_parameters={
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.global_infra.tier_0s.tier_1_interface.arp_table',
...
class _StatisticsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/global-infra/tier-0s/{tier-0-id}/tier-1-interface/statistics',
            path_variables={
                'tier0_id': 'tier-0-id',
            },
             header_parameters={
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.global_infra.tier_0s.tier_1_interface.statistics',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class StubFactory(StubFactoryBase):
    _attrs = {
        ...
        'statistics': 'com.vmware.nsx_policy.global_infra.tier_0s.tier_1_interface.statistics_client.StubFactory',
    }
