...
#
# vAPI stub file for package com.vmware.nsx_policy.cluster.restore.
#---------------------------------------------------------------------------
...
class Config(VapiInterface):
    ...
    def get(self):
        ...
        server(where backed-up files are stored) details durign restore.
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx_policy.cluster.restore.Config.get is deprecated.', DeprecationWarning)
    ...
    def update(self,
        ...
        Please use API /cluster/backups/config, to configure remote file
        server(where backed-up files are stored) details during restore.
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx_policy.cluster.restore.Config.update is deprecated.', DeprecationWarning)
...
class _BackuptimestampsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/cluster/restore/backuptimestamps',
            path_variables={
            },
             header_parameters={
                       },
        ...
        operations = {
            'get': {
                ...
                'output_type': type.ReferenceType('com.vmware.nsx_policy.model_client', 'ClusterBackupInfoListResult'),
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.cluster.restore.backuptimestamps',
...
class _ConfigStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/cluster/restore/config',
            path_variables={
            },
             header_parameters={
             },
        ...
        update_input_type = type.StructType('operation-input', {
            'restore_configuration': type.ReferenceType('com.vmware.nsx_policy.model_client', 'RestoreConfiguration'),
        })
        update_error_dict = {
            'com.vmware.vapi.std.errors.invalid_request':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidRequest'),
        ...
        operations = {
            'get': {
                'input_type': get_input_type,
                'output_type': type.ReferenceType('com.vmware.nsx_policy.model_client', 'RestoreConfiguration'),
                'errors': get_error_dict,
                'input_value_validator_list': get_input_value_validator_list,
                'output_validator_list': get_output_validator_list,
                'task_type': TaskType.NONE,
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.cluster.restore.config',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class _InstructionResourcesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/cluster/restore/instruction-resources',
            path_variables={
            },
             header_parameters={
                         },
        ...
        operations = {
            'get': {
                'input_type': get_input_type,
                'output_type': type.ReferenceType('com.vmware.nsx_policy.model_client', 'ActionableResourceListResult'),
                'errors': get_error_dict,
                'input_value_validator_list': get_input_value_validator_list,
                'output_validator_list': get_output_validator_list,
                'task_type': TaskType.NONE,
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.cluster.restore.instruction_resources',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class StubFactory(StubFactoryBase):
    _attrs = {
        ...
        'action': 'com.vmware.nsx_policy.cluster.restore.action_client.StubFactory',
    }
