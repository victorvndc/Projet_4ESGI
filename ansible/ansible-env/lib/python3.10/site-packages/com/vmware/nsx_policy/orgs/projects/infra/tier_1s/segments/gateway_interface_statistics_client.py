...
#
# vAPI stub file for package com.vmware.nsx_policy.orgs.projects.infra.tier_1s.segments.gateway_interface_statistics.
#---------------------------------------------------------------------------
...
class Summary(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.orgs.projects.infra.tier_1s.segments.gateway_interface_statistics.summary'
    """
...
class _SummaryStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/orgs/{org-id}/projects/{project-id}/infra/tier-1s/{tier-1-id}/segments/{segment-id}/gateway-interface-statistics/summary',
            path_variables={
                'org_id': 'org-id',
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.orgs.projects.infra.tier_1s.segments.gateway_interface_statistics.summary',
