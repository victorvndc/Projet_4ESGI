...
#
# vAPI stub file for package com.vmware.nsx_policy.infra.tier_1s.locale_services.endpoints.
#---------------------------------------------------------------------------
...
class VirtualEndpoints(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.tier_1s.locale_services.endpoints.virtual_endpoints'
    """
...
class _VirtualEndpointsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        delete_rest_metadata = OperationRestMetadata(
            http_method='DELETE',
            url_template='/policy/api/v1/infra/tier-1s/{tier-1-id}/locale-services/{locale-service-id}/endpoints/virtual-endpoints/{virtual-endpoint-id}',
            path_variables={
                'tier1_id': 'tier-1-id',
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/tier-1s/{tier-1-id}/locale-services/{locale-service-id}/endpoints/virtual-endpoints',
            path_variables={
                'tier1_id': 'tier-1-id',
                'locale_service_id': 'locale-service-id',
            },
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.tier_1s.locale_services.endpoints.virtual_endpoints',
