...
#
# vAPI stub file for package com.vmware.nsx_policy.aaa.vidm.
#---------------------------------------------------------------------------
...
class Groups(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.aaa.vidm.groups'
    """
...
class Search(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.aaa.vidm.search'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class Users(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.aaa.vidm.users'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    def __init__(self, config):
        ...
        operations = {
            'list': {
                ...
                'output_type': type.ReferenceType('com.vmware.nsx_policy.model_client', 'VidmInfoListResult'),
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.aaa.vidm.groups',
...
class _SearchStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        create_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/policy/api/v1/aaa/vidm/search',
            path_variables={
            },
             header_parameters={
                         },
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.aaa.vidm.search',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class _UsersStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.aaa.vidm.users',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
