...
#
# vAPI stub file for package com.vmware.nsx_policy.infra.tier_1s.locale_services.service_instances.
#---------------------------------------------------------------------------
...
class Statistics(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.tier_1s.locale_services.service_instances.statistics'
    """
    ...
    def get(self,
        ...
        :rtype: :class:`com.vmware.nsx_policy.model_client.PolicyServiceInstanceStatistics`
...
class _StatisticsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/tier-1s/{tier-1-id}/locale-services/{locale-service-id}/service-instances/{service-instance-id}/statistics',
            path_variables={
                'tier1_id': 'tier-1-id',
        ...
        operations = {
            'get': {
                ...
                'output_type': type.ReferenceType('com.vmware.nsx_policy.model_client', 'PolicyServiceInstanceStatistics'),
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.tier_1s.locale_services.service_instances.statistics',
