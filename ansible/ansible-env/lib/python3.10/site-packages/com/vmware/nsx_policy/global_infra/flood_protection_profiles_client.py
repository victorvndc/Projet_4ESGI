...
#
# vAPI stub file for package com.vmware.nsx_policy.global_infra.flood_protection_profiles.
#---------------------------------------------------------------------------
...
class Bindings(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.global_infra.flood_protection_profiles.bindings'
    """
...
class _BindingsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/global-infra/flood-protection-profiles/{flood-protection-profile-id}/bindings',
            path_variables={
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.global_infra.flood_protection_profiles.bindings',
