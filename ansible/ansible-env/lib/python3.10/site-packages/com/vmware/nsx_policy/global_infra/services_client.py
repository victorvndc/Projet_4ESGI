...
#
# vAPI stub file for package com.vmware.nsx_policy.global_infra.services.
#---------------------------------------------------------------------------
...
class ServiceEntries(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.global_infra.services.service_entries'
    """
...
class _ServiceEntriesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/global-infra/services/{service-id}/service-entries/{service-entry-id}',
            path_variables={
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/global-infra/services/{service-id}/service-entries',
            path_variables={
                'service_id': 'service-id',
            },
             header_parameters={
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.global_infra.services.service_entries',
