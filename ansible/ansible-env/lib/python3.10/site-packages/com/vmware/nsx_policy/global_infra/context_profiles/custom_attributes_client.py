...
#
# vAPI stub file for package com.vmware.nsx_policy.global_infra.context_profiles.custom_attributes.
#---------------------------------------------------------------------------
...
class Default(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.global_infra.context_profiles.custom_attributes.default'
    """
...
class _DefaultStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        create_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/policy/api/v1/global-infra/context-profiles/custom-attributes/default',
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.global_infra.context_profiles.custom_attributes.default',
