...
#
# vAPI stub file for package com.vmware.nsx_policy.global_infra.domains.gateway_policies.rules.
#---------------------------------------------------------------------------
...
class Statistics(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.global_infra.domains.gateway_policies.rules.statistics'
    """
...
class _StatisticsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/global-infra/domains/{domain-id}/gateway-policies/{gateway-policy-id}/rules/{rule-id}/statistics',
            path_variables={
                'domain_id': 'domain-id',
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.global_infra.domains.gateway_policies.rules.statistics',
