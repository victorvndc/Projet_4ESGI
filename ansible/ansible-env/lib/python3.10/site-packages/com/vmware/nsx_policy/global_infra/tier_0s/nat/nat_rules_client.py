...
#
# vAPI stub file for package com.vmware.nsx_policy.global_infra.tier_0s.nat.nat_rules.
#---------------------------------------------------------------------------
...
class Statistics(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.global_infra.tier_0s.nat.nat_rules.statistics'
    """
    ...
    def list(self,
        ...
        """
        Get NAT Rule Statistics from Tier-0 denoted by Tier-0 ID, under NAT
...
class _StatisticsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/global-infra/tier-0s/{tier-0-id}/nat/{nat-id}/nat-rules/{nat-rule-id}/statistics',
            path_variables={
                'tier0_id': 'tier-0-id',
                'nat_id': 'nat-id',
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.global_infra.tier_0s.nat.nat_rules.statistics',
