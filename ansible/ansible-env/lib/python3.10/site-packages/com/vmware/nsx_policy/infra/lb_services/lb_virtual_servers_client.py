...
#
# vAPI stub file for package com.vmware.nsx_policy.infra.lb_services.lb_virtual_servers.
#---------------------------------------------------------------------------
...
class DetailedStatus(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.lb_services.lb_virtual_servers.detailed_status'
    """
    ...
    def get(self,
        ...
        """
        Get LBVirtualServer detailed status information. - no enforcement point
        path specified: Information will be aggregated from each enforcement
        point. - {enforcement_point_path}: Information will be retrieved only
        from the given enforcement point. This API is deprecated for the NSX-T
        ...
        :rtype: :class:`com.vmware.nsx_policy.model_client.AggregateLBVirtualServerStatus`
...
class Statistics(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.lb_services.lb_virtual_servers.statistics'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    def get(self,
        ...
        """
        Get LBVirtualServerStatistics information. - no enforcement point path
        ...
        :type  source: :class:`str` or ``None``
        :param source: Data source type. (optional)
        :rtype: :class:`com.vmware.nsx_policy.model_client.AggregateLBVirtualServerStatistics`
...
class _DetailedStatusStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/lb-services/{lb-service-id}/lb-virtual-servers/{lb-virtual-server-id}/detailed-status',
            path_variables={
        ...
        operations = {
            'get': {
                ...
                'output_type': type.ReferenceType('com.vmware.nsx_policy.model_client', 'AggregateLBVirtualServerStatus'),
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.lb_services.lb_virtual_servers.detailed_status',
...
class _StatisticsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/lb-services/{lb-service-id}/lb-virtual-servers/{lb-virtual-server-id}/statistics',
            path_variables={
                'lb_service_id': 'lb-service-id',
                'lb_virtual_server_id': 'lb-virtual-server-id',
            },
        ...
        operations = {
            'get': {
                'input_type': get_input_type,
                'output_type': type.ReferenceType('com.vmware.nsx_policy.model_client', 'AggregateLBVirtualServerStatistics'),
                'errors': get_error_dict,
                'input_value_validator_list': get_input_value_validator_list,
                'output_validator_list': get_output_validator_list,
                'task_type': TaskType.NONE,
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.lb_services.lb_virtual_servers.statistics',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
