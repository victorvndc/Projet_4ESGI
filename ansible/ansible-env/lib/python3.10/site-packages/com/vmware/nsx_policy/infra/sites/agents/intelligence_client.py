...
#
# vAPI stub file for package com.vmware.nsx_policy.infra.sites.agents.intelligence.
#---------------------------------------------------------------------------
...
class Maintenance(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.sites.agents.intelligence.maintenance'
    """
...
class _MaintenanceStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/sites/agents/intelligence/maintenance',
            path_variables={
            },
             header_parameters={
             },
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.sites.agents.intelligence.maintenance',
