...
#
# vAPI stub file for package com.vmware.nsx_policy.infra.tier_0s.inter_vrf_routing.
#---------------------------------------------------------------------------
...
class AdvertisedNetworks(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.tier_0s.inter_vrf_routing.advertised_networks'
    """
...
class _AdvertisedNetworksStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/tier-0s/{tier-0-id}/inter-vrf-routing/{inter-vrf-routing-id}/advertised-networks',
            path_variables={
                'tier0_id': 'tier-0-id',
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.tier_0s.inter_vrf_routing.advertised_networks',
