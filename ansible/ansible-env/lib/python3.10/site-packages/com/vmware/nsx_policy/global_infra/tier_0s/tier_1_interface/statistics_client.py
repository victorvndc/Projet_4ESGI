...
#
# vAPI stub file for package com.vmware.nsx_policy.global_infra.tier_0s.tier_1_interface.statistics.
#---------------------------------------------------------------------------
...
class Summary(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.global_infra.tier_0s.tier_1_interface.statistics.summary'
    """
    ...
    def get(self,
        ...
        """
        Get tier-0 router link statistics summary information. In case tier 1
        is A/A, and the edge cluster is not the response will have
        interface_policy_path and logical_router_port_id empty because all
        logical router port stats are aggregated from all edge nodes.

        :type  tier0_id: :class:`str`
        :param tier0_id: (required)
        :type  tier1_path: :class:`str`
        :param tier1_path: Policy path of tier1 (required)
        ...
        :rtype: :class:`com.vmware.nsx_policy.model_client.PolicyInterfaceStatisticsSummary`
...
class _SummaryStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/global-infra/tier-0s/{tier-0-id}/tier-1-interface/statistics/summary',
            path_variables={
                'tier0_id': 'tier-0-id',
            },
             header_parameters={
        ...
        operations = {
            'get': {
                ...
                'output_type': type.ReferenceType('com.vmware.nsx_policy.model_client', 'PolicyInterfaceStatisticsSummary'),
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.global_infra.tier_0s.tier_1_interface.statistics.summary',
