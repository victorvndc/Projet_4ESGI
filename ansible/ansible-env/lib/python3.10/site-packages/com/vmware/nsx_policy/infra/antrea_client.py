...
#
# vAPI stub file for package com.vmware.nsx_policy.infra.antrea.
#---------------------------------------------------------------------------
...
class Traceflows(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.antrea.traceflows'
    """
    ...
    def create(self,
        ...
        :rtype: :class:`com.vmware.nsx_policy.model_client.AntreaTraceflowConfig`
    ...
    def list(self,
        ...
        :rtype: :class:`com.vmware.nsx_policy.model_client.AntreaTraceflowConfigListResult`
    ...
    def patch(self,
              traceflow_id,
              antrea_traceflow_config,
              ):
        """
        If an Antrea traceflow config with the traceflow-id is not already
        present, create a new traceflow config.

        :type  traceflow_id: :class:`str`
        :param traceflow_id: (required)
        :type  antrea_traceflow_config: :class:`com.vmware.nsx_policy.model_client.AntreaTraceflowConfig`
        :param antrea_traceflow_config: (required)
        :raise: :class:`com.vmware.vapi.std.errors_client.InvalidRequest` 
            Bad Request, Precondition Failed
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized` 
            Forbidden
        ...
        return self._invoke('patch',
                            {
                            'traceflow_id': traceflow_id,
                            'antrea_traceflow_config': antrea_traceflow_config,
                            })
...
class _TraceflowsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        create_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/policy/api/v1/infra/antrea/traceflows/{traceflow-id}',
            path_variables={
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/antrea/traceflows',
            path_variables={
            },
             header_parameters={
                         },
        ...
        patch_input_type = type.StructType('operation-input', {
            'traceflow_id': type.StringType(),
            'antrea_traceflow_config': type.ReferenceType('com.vmware.nsx_policy.model_client', 'AntreaTraceflowConfig'),
        })
        patch_error_dict = {
            'com.vmware.vapi.std.errors.invalid_request':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidRequest'),
        ...
        patch_rest_metadata = OperationRestMetadata(
            http_method='PATCH',
            url_template='/policy/api/v1/infra/antrea/traceflows/{traceflow-id}',
            request_body_parameter='antrea_traceflow_config',
            path_variables={
                'traceflow_id': 'traceflow-id',
            },
             header_parameters={
        ...
        operations = {
            'create': {
                ...
                'output_type': type.ReferenceType('com.vmware.nsx_policy.model_client', 'AntreaTraceflowConfig'),
            ...
            'list': {
                ...
                'output_type': type.ReferenceType('com.vmware.nsx_policy.model_client', 'AntreaTraceflowConfigListResult'),
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.antrea.traceflows',
...
class StubFactory(StubFactoryBase):
    _attrs = {
        ...
        'traceflows': 'com.vmware.nsx_policy.infra.antrea.traceflows_client.StubFactory',
    }
