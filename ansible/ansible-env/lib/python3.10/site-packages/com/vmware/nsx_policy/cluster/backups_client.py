...
class Config(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.cluster.backups.config'
    """
...
class History(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.cluster.backups.history'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class Overview(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.cluster.backups.overview'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    def list(self,
        ...
        :rtype: :class:`com.vmware.nsx_policy.model_client.BackupOverview`
...
class Status(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.cluster.backups.status'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class _OverviewStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/cluster/backups/overview',
            path_variables={
            },
             header_parameters={
                             },
        ...
        operations = {
            'list': {
                ...
                'output_type': type.ReferenceType('com.vmware.nsx_policy.model_client', 'BackupOverview'),
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.cluster.backups.overview',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
