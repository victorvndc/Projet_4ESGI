...
#
# vAPI stub file for package com.vmware.nsx_policy.global_infra.firewall.
#---------------------------------------------------------------------------
...
class Policies(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.global_infra.firewall.policies'
    """
    ...
    def list(self,
        ...
        :param scope: Scope filter criteria (required)
        ...
        :param parent_path: Path of the parent object of the entities (optional)
...
class Rules(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.global_infra.firewall.rules'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    def list(self,
        ...
        based on the given criteria. Parent path is mandatory.
...
class _PoliciesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/global-infra/firewall/policies',
            path_variables={
            },
             header_parameters={
                   },
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.global_infra.firewall.policies',
...
class _RulesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/global-infra/firewall/rules',
            path_variables={
            },
             header_parameters={
                   },
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.global_infra.firewall.rules',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
