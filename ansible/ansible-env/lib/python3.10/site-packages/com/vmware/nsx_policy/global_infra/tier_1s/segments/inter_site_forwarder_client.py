...
#
# vAPI stub file for package com.vmware.nsx_policy.global_infra.tier_1s.segments.inter_site_forwarder.
#---------------------------------------------------------------------------
...
class SiteSpanInfo(VapiInterface):
    ...
    """
    Possible value for ``bgpNeighborType`` of method :func:`SiteSpanInfo.get`.
    ...
    """
    Possible value for ``source`` of method :func:`SiteSpanInfo.get`.
    ...
    """
    Possible value for ``statsType`` of method :func:`SiteSpanInfo.get`.

    """

    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.global_infra.tier_1s.segments.inter_site_forwarder.site_span_info'
    """
    ...
    def get(self,
        ...
        :rtype: :class:`com.vmware.nsx_policy.model_client.SegmentL2ForwarderSiteSpanInfo`
...
class Status(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.global_infra.tier_1s.segments.inter_site_forwarder.status'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    def get(self,
        ...
        :type  transport_node_id: :class:`str` or ``None``
        :param transport_node_id: Transport Node Id (optional)
        :rtype: :class:`com.vmware.nsx_policy.model_client.SegmentCrossSiteTrafficStats`
...
class _SiteSpanInfoStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/global-infra/tier-1s/{tier-1-id}/segments/{segment-id}/inter-site-forwarder/site-span-info',
            path_variables={
                'tier1_id': 'tier-1-id',
        ...
        operations = {
            'get': {
                ...
                'output_type': type.ReferenceType('com.vmware.nsx_policy.model_client', 'SegmentL2ForwarderSiteSpanInfo'),
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.global_infra.tier_1s.segments.inter_site_forwarder.site_span_info',
...
class _StatusStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/global-infra/tier-1s/{tier-1-id}/segments/{segment-id}/inter-site-forwarder/status',
            path_variables={
                'tier1_id': 'tier-1-id',
                'segment_id': 'segment-id',
            },
        ...
        operations = {
            'get': {
                'input_type': get_input_type,
                'output_type': type.ReferenceType('com.vmware.nsx_policy.model_client', 'SegmentCrossSiteTrafficStats'),
                'errors': get_error_dict,
                'input_value_validator_list': get_input_value_validator_list,
                'output_validator_list': get_output_validator_list,
                'task_type': TaskType.NONE,
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.global_infra.tier_1s.segments.inter_site_forwarder.status',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
