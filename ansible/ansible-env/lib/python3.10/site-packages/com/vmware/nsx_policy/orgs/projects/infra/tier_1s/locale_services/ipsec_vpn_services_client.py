...
#
# vAPI stub file for package com.vmware.nsx_policy.orgs.projects.infra.tier_1s.locale_services.ipsec_vpn_services.
#---------------------------------------------------------------------------
...
class Summary(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.orgs.projects.infra.tier_1s.locale_services.ipsec_vpn_services.summary'
    """
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx_policy.orgs.projects.infra.tier_1s.locale_services.ipsec_vpn_services.Summary.get is deprecated.', DeprecationWarning)
...
class _SummaryStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/orgs/{org-id}/projects/{project-id}/infra/tier-1s/{tier-1-id}/locale-services/{locale-service-id}/ipsec-vpn-services/{service-id}/summary',
            path_variables={
                'org_id': 'org-id',
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.orgs.projects.infra.tier_1s.locale_services.ipsec_vpn_services.summary',
...
class StubFactory(StubFactoryBase):
    _attrs = {
        'Summary': Summary,
        'sessions': 'com.vmware.nsx_policy.orgs.projects.infra.tier_1s.locale_services.ipsec_vpn_services.sessions_client.StubFactory',
    }
