...
#
# vAPI stub file for package com.vmware.nsx_policy.orgs.projects.vpcs.gateway_policies.rules.
#---------------------------------------------------------------------------
...
class Statistics(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.orgs.projects.vpcs.gateway_policies.rules.statistics'
    """
    ...
    def list(self,
        ...
        """
        Get statistics of N-S Firewall rule. - no enforcement point path
        ...
        :rtype: :class:`com.vmware.nsx_policy.model_client.RuleStatisticsListResult`
...
class _StatisticsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/orgs/{org-id}/projects/{project-id}/vpcs/{vpc-id}/gateway-policies/{gateway-policy-id}/rules/{rule-id}/statistics',
            path_variables={
                'org_id': 'org-id',
        ...
        operations = {
            'list': {
                ...
                'output_type': type.ReferenceType('com.vmware.nsx_policy.model_client', 'RuleStatisticsListResult'),
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.orgs.projects.vpcs.gateway_policies.rules.statistics',
