...
#
# vAPI stub file for package com.vmware.nsx_policy.orgs.projects.infra.domains.intrusion_service_policies.
#---------------------------------------------------------------------------
...
class Rules(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.orgs.projects.infra.domains.intrusion_service_policies.rules'
    """
    ...
    def get(self,
        ...
        :type  rule_id: :class:`str`
        :param rule_id: Rule ID (required)
        :rtype: :class:`com.vmware.nsx_policy.model_client.IdsRule`
    ...
    def list(self,
        ...
        :rtype: :class:`com.vmware.nsx_policy.model_client.IdsRuleListResult`
    ...
    def patch(self,
        ...
        :type  rule_id: :class:`str`
        :param rule_id: Rule ID (required)
        :type  ids_rule: :class:`com.vmware.nsx_policy.model_client.IdsRule`
        :param ids_rule: (required)
        :raise: :class:`com.vmware.vapi.std.errors_client.InvalidRequest` 
            Bad Request, Precondition Failed
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized` 
            Forbidden
...
class Statistics(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.orgs.projects.infra.domains.intrusion_service_policies.statistics'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    def list(self,
        ...
        """
        Get statistics of a IDS security policy. - no enforcement point path
        ...
        :type  domain_id: :class:`str`
        :param domain_id: Domain id (required)
        :type  ids_policy_id: :class:`str`
        :param ids_policy_id: IDS Security policy id (required)
        ...
        :rtype: :class:`com.vmware.nsx_policy.model_client.IdsSecurityPolicyStatisticsListResult`
...
class _RulesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        delete_rest_metadata = OperationRestMetadata(
            http_method='DELETE',
            url_template='/policy/api/v1/orgs/{org-id}/projects/{project-id}/infra/domains/{domain-id}/intrusion-service-policies/{policy-id}/rules/{rule-id}',
            path_variables={
                'org_id': 'org-id',
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/orgs/{org-id}/projects/{project-id}/infra/domains/{domain-id}/intrusion-service-policies/{policy-id}/rules',
            path_variables={
                'org_id': 'org-id',
                'project_id': 'project-id',
                'domain_id': 'domain-id',
        ...
        patch_input_type = type.StructType('operation-input', {
            ...
            'policy_id': type.StringType(),
            'rule_id': type.StringType(),
            'ids_rule': type.ReferenceType('com.vmware.nsx_policy.model_client', 'IdsRule'),
        })
        patch_error_dict = {
            'com.vmware.vapi.std.errors.invalid_request':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidRequest'),
        ...
        patch_rest_metadata = OperationRestMetadata(
            http_method='PATCH',
            url_template='/policy/api/v1/orgs/{org-id}/projects/{project-id}/infra/domains/{domain-id}/intrusion-service-policies/{policy-id}/rules/{rule-id}',
            request_body_parameter='ids_rule',
            path_variables={
                'org_id': 'org-id',
                'project_id': 'project-id',
                'domain_id': 'domain-id',
        ...
        revise_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/policy/api/v1/orgs/{org-id}/projects/{project-id}/infra/domains/{domain-id}/intrusion-service-policies/{policy-id}/rules/{rule-id}?action=revise',
            request_body_parameter='ids_rule',
            path_variables={
                'org_id': 'org-id',
                'project_id': 'project-id',
        ...
        operations = {
            ...
            'get': {
                ...
                'output_type': type.ReferenceType('com.vmware.nsx_policy.model_client', 'IdsRule'),
            ...
            'list': {
                ...
                'output_type': type.ReferenceType('com.vmware.nsx_policy.model_client', 'IdsRuleListResult'),
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.orgs.projects.infra.domains.intrusion_service_policies.rules',
...
class _StatisticsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/orgs/{org-id}/projects/{project-id}/infra/domains/{domain-id}/intrusion-service-policies/{ids-policy-id}/statistics',
            path_variables={
                'org_id': 'org-id',
                'project_id': 'project-id',
                'domain_id': 'domain-id',
                'ids_policy_id': 'ids-policy-id',
            },
             header_parameters={
                         },
            query_parameters={
        ...
        operations = {
            'list': {
                'input_type': list_input_type,
                'output_type': type.ReferenceType('com.vmware.nsx_policy.model_client', 'IdsSecurityPolicyStatisticsListResult'),
                'errors': list_error_dict,
                'input_value_validator_list': list_input_value_validator_list,
                'output_validator_list': list_output_validator_list,
                'task_type': TaskType.NONE,
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.orgs.projects.infra.domains.intrusion_service_policies.statistics',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class StubFactory(StubFactoryBase):
    _attrs = {
        ...
        'rules': 'com.vmware.nsx_policy.orgs.projects.infra.domains.intrusion_service_policies.rules_client.StubFactory',
    }
