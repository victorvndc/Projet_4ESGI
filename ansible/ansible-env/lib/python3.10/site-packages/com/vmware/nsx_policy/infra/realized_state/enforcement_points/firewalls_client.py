...
#
# vAPI stub file for package com.vmware.nsx_policy.infra.realized_state.enforcement_points.firewalls.
#---------------------------------------------------------------------------
...
class FirewallSections(VapiInterface):
    """
    
    """

    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.realized_state.enforcement_points.firewalls.firewall_sections'
    """
    ...
    def __init__(self, config):
        ...
        """
        VapiInterface.__init__(self, config, _FirewallSectionsStub)
    ...
    def get(self,
        ...
        :type  firewall_section_id: :class:`str`
        :param firewall_section_id: Firewall Section Id (required)
        :rtype: :class:`com.vmware.nsx_policy.model_client.RealizedFirewallSection`
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx_policy.infra.realized_state.enforcement_points.firewalls.FirewallSections.get is deprecated.', DeprecationWarning)
        return self._invoke('get',
                            {
                            'enforcement_point_name': enforcement_point_name,
                            'firewall_section_id': firewall_section_id,
                            })
    ...
    def list(self,
        ...
        :rtype: :class:`com.vmware.nsx_policy.model_client.RealizedFirewallSectionListResult`
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx_policy.infra.realized_state.enforcement_points.firewalls.FirewallSections.list is deprecated.', DeprecationWarning)
...
class _FirewallSectionsStub(ApiInterfaceStub):
    def __init__(self, config):
...
class StubFactory(StubFactoryBase):
    _attrs = {
        'FirewallSections': FirewallSections,
    }
