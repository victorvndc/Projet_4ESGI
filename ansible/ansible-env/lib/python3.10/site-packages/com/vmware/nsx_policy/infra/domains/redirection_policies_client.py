...
class Rules(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.domains.redirection_policies.rules'
    """
    ...
    def patch(self,
        ...
        redirection policy, prefer below mentioned API for optimal performance.
        ...
        :param domain_id: Domain id (required)
        :type  redirection_policy_id: :class:`str`
        :param redirection_policy_id: RedirectionPolicy id (required)
        :type  rule_id: :class:`str`
        :param rule_id: rule id (required)
