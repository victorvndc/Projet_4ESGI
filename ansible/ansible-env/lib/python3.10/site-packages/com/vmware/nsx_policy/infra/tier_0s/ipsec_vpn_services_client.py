...
#
# vAPI stub file for package com.vmware.nsx_policy.infra.tier_0s.ipsec_vpn_services.
#---------------------------------------------------------------------------
...
class LocalEndpoints(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.tier_0s.ipsec_vpn_services.local_endpoints'
    """
    ...
    def delete(self,
        ...
        """
        Delete IPSec VPN local endpoint for a given ipsec vpn service under
        Tier-0.
    ...
    def get(self,
        ...
        """
        Get IPSec VPN local endpoint for a given ipsec vpn service under
        Tier-0.
...
class Sessions(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.tier_0s.ipsec_vpn_services.sessions'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    def get(self,
        ...
        """
        Get IPSec VPN session without sensitive data for a given ipsec vpn
    ...
    def patch(self,
        ...
        """
        Create or patch an IPSec VPN session for a given ipsec vpn service
        under Tier-0.
    ...
    def showsensitivedata(self,
        ...
        """
        Get IPSec VPN session with senstive data for a given ipsec vpn service
        under Tier-0.
    ...
    def update(self,
        ...
        """
        Create or fully replace IPSec VPN session for a given ipsec vpn service
...
class Summary(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.tier_0s.ipsec_vpn_services.summary'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class _LocalEndpointsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        delete_rest_metadata = OperationRestMetadata(
            http_method='DELETE',
            url_template='/policy/api/v1/infra/tier-0s/{tier-0-id}/ipsec-vpn-services/{service-id}/local-endpoints/{local-endpoint-id}',
            path_variables={
                'tier0_id': 'tier-0-id',
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/tier-0s/{tier-0-id}/ipsec-vpn-services/{service-id}/local-endpoints',
            path_variables={
                'tier0_id': 'tier-0-id',
                'service_id': 'service-id',
            },
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.tier_0s.ipsec_vpn_services.local_endpoints',
...
class _SessionsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        delete_rest_metadata = OperationRestMetadata(
            http_method='DELETE',
            url_template='/policy/api/v1/infra/tier-0s/{tier-0-id}/ipsec-vpn-services/{service-id}/sessions/{session-id}',
            path_variables={
                'tier0_id': 'tier-0-id',
                'service_id': 'service-id',
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/tier-0s/{tier-0-id}/ipsec-vpn-services/{service-id}/sessions',
            path_variables={
                'tier0_id': 'tier-0-id',
                'service_id': 'service-id',
            },
        ...
        showsensitivedata_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/tier-0s/{tier-0-id}/ipsec-vpn-services/{service-id}/sessions/{session-id}?action=show_sensitive_data',
            path_variables={
                'tier0_id': 'tier-0-id',
                'service_id': 'service-id',
                'session_id': 'session-id',
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.tier_0s.ipsec_vpn_services.sessions',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class _SummaryStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/tier-0s/{tier-0-id}/ipsec-vpn-services/{service-id}/summary',
            path_variables={
                'tier0_id': 'tier-0-id',
                'service_id': 'service-id',
            },
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.tier_0s.ipsec_vpn_services.summary',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class StubFactory(StubFactoryBase):
    _attrs = {
        ...
        'Sessions': Sessions,
        'Summary': Summary,
        'sessions': 'com.vmware.nsx_policy.infra.tier_0s.ipsec_vpn_services.sessions_client.StubFactory',
    }
