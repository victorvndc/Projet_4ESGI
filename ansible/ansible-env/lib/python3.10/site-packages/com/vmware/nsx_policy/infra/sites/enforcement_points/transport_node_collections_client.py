...
#
# vAPI stub file for package com.vmware.nsx_policy.infra.sites.enforcement_points.transport_node_collections.
#---------------------------------------------------------------------------
...
class State(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.sites.enforcement_points.transport_node_collections.state'
    """
    ...
    def get(self,
        ...
        :rtype: :class:`com.vmware.nsx_policy.model_client.TransportNodeCollectionState`
...
class _StateStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/sites/{site-id}/enforcement-points/{enforcementpoint-id}/transport-node-collections/{transport-node-collection-id}/state',
            path_variables={
                'site_id': 'site-id',
        ...
        operations = {
            'get': {
                ...
                'output_type': type.ReferenceType('com.vmware.nsx_policy.model_client', 'TransportNodeCollectionState'),
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.sites.enforcement_points.transport_node_collections.state',
