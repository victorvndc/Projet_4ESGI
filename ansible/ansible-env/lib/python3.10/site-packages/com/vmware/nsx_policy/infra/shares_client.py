...
#
# vAPI stub file for package com.vmware.nsx_policy.infra.shares.
#---------------------------------------------------------------------------
...
class Resources(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.shares.resources'
    """
...
class _ResourcesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        delete_rest_metadata = OperationRestMetadata(
            http_method='DELETE',
            url_template='/policy/api/v1/infra/shares/{share-id}/resources/{shared-resource-id}',
            path_variables={
                'share_id': 'share-id',
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/shares/{share-id}/resources',
            path_variables={
                'share_id': 'share-id',
            },
             header_parameters={
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.shares.resources',
