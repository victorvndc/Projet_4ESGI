...
#
# vAPI stub file for package com.vmware.nsx_policy.infra.ip_pools.
#---------------------------------------------------------------------------
...
class IpAllocations(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.ip_pools.ip_allocations'
    """
...
class IpSubnets(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.ip_pools.ip_subnets'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class _IpAllocationsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        delete_rest_metadata = OperationRestMetadata(
            http_method='DELETE',
            url_template='/policy/api/v1/infra/ip-pools/{ip-pool-id}/ip-allocations/{ip-allocation-id}',
            path_variables={
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/ip-pools/{ip-pool-id}/ip-allocations',
            path_variables={
                'ip_pool_id': 'ip-pool-id',
            },
             header_parameters={
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.ip_pools.ip_allocations',
