...
#
# vAPI stub file for package com.vmware.nsx_policy.infra.tier_1s.locale_services.interface_groups.
#---------------------------------------------------------------------------
...
class Statistics(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.tier_1s.locale_services.interface_groups.statistics'
    """
...
class _StatisticsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/tier-1s/{tier-1-id}/locale-services/{locale-service-id}/interface-groups/{interface-group-id}/statistics',
            path_variables={
                'tier1_id': 'tier-1-id',
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.tier_1s.locale_services.interface_groups.statistics',
