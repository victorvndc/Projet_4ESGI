...
#
# vAPI stub file for package com.vmware.nsx_policy.infra.sites.
#---------------------------------------------------------------------------
...
class EnforcementPoints(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.sites.enforcement_points'
    """
...
class ListenerCertificate(VapiInterface):
    """
    
    """

    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.sites.listener_certificate'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
        ...
        :param config: Configuration to be used for creating the stub.
        """
        VapiInterface.__init__(self, config, _ListenerCertificateStub)
        self._VAPI_OPERATION_IDS = {}
    ...
    def get(self,
        ...
        """
        Connects to the given IP and port, and, if an SSL listener is present,
        returns the certificate of the listener. Intent of this API is \"Do you
        ...
        :rtype: :class:`com.vmware.nsx_policy.model_client.TlsListenerCertificate`
...
class _EnforcementPointsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        delete_rest_metadata = OperationRestMetadata(
            http_method='DELETE',
            url_template='/policy/api/v1/infra/sites/{site-id}/enforcement-points/{enforcementpoint-id}',
            path_variables={
                'site_id': 'site-id',
        ...
        # properties for fullsync operation
        fullsync_input_type = type.StructType('operation-input', {
            'site_id': type.StringType(),
        ...
        fullsync_input_value_validator_list = [
        ]
        fullsync_output_validator_list = [
        ]
        fullsync_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/policy/api/v1/infra/sites/{site-id}/enforcement-points/{enforcement-point-id}?action=full-sync',
            path_variables={
                'site_id': 'site-id',
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/sites/{site-id}/enforcement-points',
            path_variables={
                'site_id': 'site-id',
            },
             header_parameters={
        ...
        reload_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/policy/api/v1/infra/sites/{site-id}/enforcement-points/{enforcementpoint-id}?action=reload',
            path_variables={
                'site_id': 'site-id',
                'enforcementpoint_id': 'enforcementpoint-id',
            },
        ...
        operations = {
            ...
            'fullsync': {
                'input_type': fullsync_input_type,
                'output_type': type.VoidType(),
                'errors': fullsync_error_dict,
                'input_value_validator_list': fullsync_input_value_validator_list,
                'output_validator_list': fullsync_output_validator_list,
                'task_type': TaskType.NONE,
            },
            'get': {
        ...
        rest_metadata = {
            ...
            'fullsync': fullsync_rest_metadata,
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.sites.enforcement_points',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)

class _ListenerCertificateStub(ApiInterfaceStub):
    def __init__(self, config):
        # properties for get operation
        get_input_type = type.StructType('operation-input', {
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/sites/listener_certificate',
            path_variables={
            },
             header_parameters={
                 },
        ...
        operations = {
            'get': {
                'input_type': get_input_type,
                'output_type': type.ReferenceType('com.vmware.nsx_policy.model_client', 'TlsListenerCertificate'),
                'errors': get_error_dict,
                'input_value_validator_list': get_input_value_validator_list,
                'output_validator_list': get_output_validator_list,
                'task_type': TaskType.NONE,
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.sites.listener_certificate',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class StubFactory(StubFactoryBase):
    _attrs = {
        ...
        'agents': 'com.vmware.nsx_policy.infra.sites.agents_client.StubFactory',
        'enforcement_points': 'com.vmware.nsx_policy.infra.sites.enforcement_points_client.StubFactory',
        'napp': 'com.vmware.nsx_policy.infra.sites.napp_client.StubFactory',
    }
