...
#
# vAPI stub file for package com.vmware.nsx_policy.infra.tier_1s.locale_services.byod_service_instances.
#---------------------------------------------------------------------------
...
class ServiceInstanceEndpoints(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.tier_1s.locale_services.byod_service_instances.service_instance_endpoints'
    """
    ...
    def delete(self,
        ...
        :param service_instance_endpoint_id: Tier1 Service instance endpoint id (required)
...
class _ServiceInstanceEndpointsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        delete_rest_metadata = OperationRestMetadata(
            http_method='DELETE',
            url_template='/policy/api/v1/infra/tier-1s/{tier-1-id}/locale-services/{locale-service-id}/byod-service-instances/{service-instance-id}/service-instance-endpoints/{service-instance-endpoint-id}',
            path_variables={
                'tier1_id': 'tier-1-id',
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/tier-1s/{tier-1-id}/locale-services/{locale-service-id}/byod-service-instances/{service-instance-id}/service-instance-endpoints',
            path_variables={
                'tier1_id': 'tier-1-id',
                'locale_service_id': 'locale-service-id',
                'service_instance_id': 'service-instance-id',
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.tier_1s.locale_services.byod_service_instances.service_instance_endpoints',
