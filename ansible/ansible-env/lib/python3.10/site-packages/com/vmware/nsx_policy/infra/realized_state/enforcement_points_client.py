...
class VirtualMachines(VapiInterface):
    ...
    def list(self,
        ...
        NSX Manager. 
        This API has been deprecated. Please use the new API GET
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx_policy.infra.realized_state.enforcement_points.VirtualMachines.list is deprecated.', DeprecationWarning)
        return self._invoke('list',
                            {
                            'enforcement_point_name': enforcement_point_name,
                            'cursor': cursor,
    ...
    def updatetags(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx_policy.infra.realized_state.enforcement_points.VirtualMachines.updatetags is deprecated.', DeprecationWarning)
...
class _VifsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/realized-state/enforcement-points/{enforcement-point-name}/vifs',
            path_variables={
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.realized_state.enforcement_points.vifs',
...
class StubFactory(StubFactoryBase):
    _attrs = {
        ...
        'virtual_machines': 'com.vmware.nsx_policy.infra.realized_state.enforcement_points.virtual_machines_client.StubFactory',
    }
