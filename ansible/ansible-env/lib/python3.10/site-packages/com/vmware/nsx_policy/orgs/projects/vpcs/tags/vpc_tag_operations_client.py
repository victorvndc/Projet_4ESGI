...
#
# vAPI stub file for package com.vmware.nsx_policy.orgs.projects.vpcs.tags.vpc_tag_operations.
#---------------------------------------------------------------------------
...
class Status(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.orgs.projects.vpcs.tags.vpc_tag_operations.status'
    """
    ...
    def get(self,
        ...
        """
        Get status of tag bulk operation with details of tag operation on each
        virtual machine.
        ...
        :rtype: :class:`com.vmware.nsx_policy.model_client.TagBulkOperationStatus`
...
class _StatusStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/orgs/{org-id}/projects/{project-id}/vpcs/{vpc-id}/tags/vpc-tag-operations/{operation-id}/status',
            path_variables={
                'org_id': 'org-id',
        ...
        operations = {
            'get': {
                ...
                'output_type': type.ReferenceType('com.vmware.nsx_policy.model_client', 'TagBulkOperationStatus'),
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.orgs.projects.vpcs.tags.vpc_tag_operations.status',
