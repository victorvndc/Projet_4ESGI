...
#
# vAPI stub file for package com.vmware.nsx_policy.global_infra.tier_1s.locale_services.interface_groups.
#---------------------------------------------------------------------------
...
class Statistics(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.global_infra.tier_1s.locale_services.interface_groups.statistics'
    """
    ...
    def get(self,
        ...
        :type  interface_group_id: :class:`str`
        :param interface_group_id: (required)
        ...
        :rtype: :class:`com.vmware.nsx_policy.model_client.PolicyInterfaceGroupStatistics`
        :return: com.vmware.nsx_policy.model.PolicyInterfaceGroupStatistics
...
class _StatisticsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_input_type = type.StructType('operation-input', {
            ...
            'interface_group_id': type.StringType(),
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/global-infra/tier-1s/{tier-1-id}/locale-services/{locale-service-id}/interface-groups/{interface-group-id}/statistics',
            path_variables={
                'tier1_id': 'tier-1-id',
        ...
        operations = {
            'get': {
                ...
                'output_type': type.ReferenceType('com.vmware.nsx_policy.model_client', 'PolicyInterfaceGroupStatistics'),
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.global_infra.tier_1s.locale_services.interface_groups.statistics',
