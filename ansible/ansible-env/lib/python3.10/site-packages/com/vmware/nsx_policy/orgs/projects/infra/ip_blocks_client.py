...
#
# vAPI stub file for package com.vmware.nsx_policy.orgs.projects.infra.ip_blocks.
#---------------------------------------------------------------------------
...
class Usage(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.orgs.projects.infra.ip_blocks.usage'
    """
    ...
    def get(self,
        ...
        :rtype: :class:`com.vmware.nsx_policy.model_client.IpAddressBlockUsage`
...
class _UsageStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/orgs/{org-id}/projects/{project-id}/infra/ip-blocks/{ip-block-id}/usage',
            path_variables={
                'org_id': 'org-id',
        ...
        operations = {
            'get': {
                ...
                'output_type': type.ReferenceType('com.vmware.nsx_policy.model_client', 'IpAddressBlockUsage'),
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.orgs.projects.infra.ip_blocks.usage',
