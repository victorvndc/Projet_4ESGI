...
#
# vAPI stub file for package com.vmware.nsx_policy.infra.settings.firewall.
#---------------------------------------------------------------------------
...
class CpuMemThresholdsProfileBindingMaps(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.settings.firewall.cpu_mem_thresholds_profile_binding_maps'
    """
    ...
    def delete(self,
               cpu_mem_thresholds_profile_binding_map_id,
               ):
        """
        API will delete Firewall CPU Memory Thresholds Profile Binding.

        :type  cpu_mem_thresholds_profile_binding_map_id: :class:`str`
        :param cpu_mem_thresholds_profile_binding_map_id: Firewall CPU Memory Thresholds Profile Binding Map ID (required)
        ...
        return self._invoke('delete',
                            {
                            'cpu_mem_thresholds_profile_binding_map_id': cpu_mem_thresholds_profile_binding_map_id,
                            })
    ...
    def get(self,
        ...
        :type  cpu_mem_thresholds_profile_binding_map_id: :class:`str`
        :param cpu_mem_thresholds_profile_binding_map_id: Firewall CPU Memory Thresholds Profile Binding Map ID (required)
        :rtype: :class:`com.vmware.nsx_policy.model_client.PolicyFirewallCPUMemThresholdsProfileBindingMap`
    ...
    def patch(self,
        ...
        """
        API will create or update Firewall CPU Memory Thresholds Profile
        binding map.

        :type  cpu_mem_thresholds_profile_binding_map_id: :class:`str`
        :param cpu_mem_thresholds_profile_binding_map_id: Firewall CPU Memory Thresholds Profile Binding Map ID (required)
        :type  policy_firewall_cpu_mem_thresholds_profile_binding_map: :class:`com.vmware.nsx_policy.model_client.PolicyFirewallCPUMemThresholdsProfileBindingMap`
        :param policy_firewall_cpu_mem_thresholds_profile_binding_map: (required)
        :raise: :class:`com.vmware.vapi.std.errors_client.InvalidRequest` 
            Bad Request, Precondition Failed
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized` 
            Forbidden
        ...
        return self._invoke('patch',
                            {
                            'cpu_mem_thresholds_profile_binding_map_id': cpu_mem_thresholds_profile_binding_map_id,
                            'policy_firewall_cpu_mem_thresholds_profile_binding_map': policy_firewall_cpu_mem_thresholds_profile_binding_map,
                            })
...
class CpuMemThresholdsProfiles(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.settings.firewall.cpu_mem_thresholds_profiles'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class Export(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.settings.firewall.export'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class Import(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.settings.firewall.import'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class Security(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.settings.firewall.security'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class Stats(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.settings.firewall.stats'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class _CpuMemThresholdsProfileBindingMapsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        delete_input_type = type.StructType('operation-input', {
            'cpu_mem_thresholds_profile_binding_map_id': type.StringType(),
        })
        delete_error_dict = {
        ...
        delete_rest_metadata = OperationRestMetadata(
            http_method='DELETE',
            url_template='/policy/api/v1/infra/settings/firewall/cpu-mem-thresholds-profile-binding-maps/{cpu-mem-thresholds-profile-binding-map-id}',
            path_variables={
                'cpu_mem_thresholds_profile_binding_map_id': 'cpu-mem-thresholds-profile-binding-map-id',
            },
             header_parameters={
               },
            query_parameters={
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/settings/firewall/cpu-mem-thresholds-profile-binding-maps',
            path_variables={
            },
             header_parameters={
                         },
        ...
        patch_input_type = type.StructType('operation-input', {
            'cpu_mem_thresholds_profile_binding_map_id': type.StringType(),
            'policy_firewall_CPU_mem_thresholds_profile_binding_map': type.ReferenceType('com.vmware.nsx_policy.model_client', 'PolicyFirewallCPUMemThresholdsProfileBindingMap'),
        })
        patch_error_dict = {
            'com.vmware.vapi.std.errors.invalid_request':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidRequest'),
        ...
        patch_rest_metadata = OperationRestMetadata(
            http_method='PATCH',
            url_template='/policy/api/v1/infra/settings/firewall/cpu-mem-thresholds-profile-binding-maps/{cpu-mem-thresholds-profile-binding-map-id}',
            request_body_parameter='policy_firewall_CPU_mem_thresholds_profile_binding_map',
            path_variables={
                'cpu_mem_thresholds_profile_binding_map_id': 'cpu-mem-thresholds-profile-binding-map-id',
            },
             header_parameters={
        ...
        operations = {
            ...
            'get': {
                ...
                'output_type': type.ReferenceType('com.vmware.nsx_policy.model_client', 'PolicyFirewallCPUMemThresholdsProfileBindingMap'),
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.settings.firewall.cpu_mem_thresholds_profile_binding_maps',
...
class _CpuMemThresholdsProfilesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        delete_rest_metadata = OperationRestMetadata(
            http_method='DELETE',
            url_template='/policy/api/v1/infra/settings/firewall/cpu-mem-thresholds-profiles/{profile-id}',
            path_variables={
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/settings/firewall/cpu-mem-thresholds-profiles',
            path_variables={
            },
             header_parameters={
                         },
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.settings.firewall.cpu_mem_thresholds_profiles',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class _ExportStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        cancel_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/policy/api/v1/infra/settings/firewall/export?action=cancel',
            path_variables={
            },
             header_parameters={
             },
        ...
        create_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/policy/api/v1/infra/settings/firewall/export',
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.settings.firewall.export',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class _ImportStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        cancel_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/policy/api/v1/infra/settings/firewall/import?action=cancel',
            path_variables={
            },
             header_parameters={
             },
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/settings/firewall/import',
            path_variables={
            },
             header_parameters={
             },
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.settings.firewall.import',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class _SecurityStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/settings/firewall/security',
            path_variables={
            },
             header_parameters={
             },
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.settings.firewall.security',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class _StatsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        reset_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/policy/api/v1/infra/settings/firewall/stats?action=reset',
            path_variables={
            },
             header_parameters={
                   },
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.settings.firewall.stats',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class StubFactory(StubFactoryBase):
    _attrs = {
        ...
        'Security': Security,
        'Stats': Stats,
        'gateway': 'com.vmware.nsx_policy.infra.settings.firewall.gateway_client.StubFactory',
        'idfw': 'com.vmware.nsx_policy.infra.settings.firewall.idfw_client.StubFactory',
        'security': 'com.vmware.nsx_policy.infra.settings.firewall.security_client.StubFactory',
    }
