...
#
# vAPI stub file for package com.vmware.nsx_policy.infra.domains.intrusion_service_gateway_policies.rules.
#---------------------------------------------------------------------------
...
class Statistics(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.domains.intrusion_service_gateway_policies.rules.statistics'
    """
    ...
    def list(self,
        ...
        """
        Get statistics of a IDS gateway rule. - no enforcement point path
...
class _StatisticsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/domains/{domain-id}/intrusion-service-gateway-policies/{policy-id}/rules/{rule-id}/statistics',
            path_variables={
                'domain_id': 'domain-id',
                'policy_id': 'policy-id',
                'rule_id': 'rule-id',
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.domains.intrusion_service_gateway_policies.rules.statistics',
