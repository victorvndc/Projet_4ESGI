...
#
# vAPI stub file for package com.vmware.nsx_policy.infra.realized_state.virtual_machines.
#---------------------------------------------------------------------------
...
class Tags(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.realized_state.virtual_machines.tags'
    """
    ...
    def create(self,
        ...
        tags limit exceeded, etc. NOTE: The \"virtual_machine_id\" field in the
        payload will be ignored and the virtual machine ID provided in the URL
        will be honored.
...
class _TagsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        create_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/policy/api/v1/infra/realized-state/virtual-machines/{virtual-machine-id}/tags',
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.realized_state.virtual_machines.tags',
