...
#
# vAPI stub file for package com.vmware.nsx_policy.infra.realized_state.enforcement_points.ip_sets.
#---------------------------------------------------------------------------
...
class IpSetsNsxt(VapiInterface):
    """
    
    """

    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.realized_state.enforcement_points.ip_sets.ip_sets_nsxt'
    """
    ...
    def __init__(self, config):
        ...
        """
        VapiInterface.__init__(self, config, _IpSetsNsxtStub)
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx_policy.infra.realized_state.enforcement_points.ip_sets.IpSetsNsxt.get is deprecated.', DeprecationWarning)
    ...
    def list(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx_policy.infra.realized_state.enforcement_points.ip_sets.IpSetsNsxt.list is deprecated.', DeprecationWarning)
...
class _IpSetsNsxtStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/realized-state/enforcement-points/{enforcement-point-name}/ip-sets/ip-sets-nsxt/{ip-set-name}',
            path_variables={
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/realized-state/enforcement-points/{enforcement-point-name}/ip-sets/ip-sets-nsxt',
            path_variables={
                'enforcement_point_name': 'enforcement-point-name',
            },
             header_parameters={
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.realized_state.enforcement_points.ip_sets.ip_sets_nsxt',
