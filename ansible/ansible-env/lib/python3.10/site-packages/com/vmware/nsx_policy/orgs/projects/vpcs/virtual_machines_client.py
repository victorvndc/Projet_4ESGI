...
#
# vAPI stub file for package com.vmware.nsx_policy.orgs.projects.vpcs.virtual_machines.
#---------------------------------------------------------------------------
...
class Tags(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.orgs.projects.vpcs.virtual_machines.tags'
    """
    ...
    def create(self,
        ...
        """
        Allows an admin to apply multiple tags to a virtual machine under VPC.
        This operation does not store the intent on the policy side. It applies
        the tag directly on the specified enforcement point. This operation
        will replace the existing tags on the virtual machine with the ones
        that have been passed. If the application of tag fails on the
        enforcement point, then an error is reported. The admin will have to
        retry the operation again. Policy framework does not perform a retry.
        Failure could occur due to multiple reasons. For e.g enforcement point
        is down, Enforcement point could not apply the tag due to constraints
        like max tags limit exceeded, etc. NOTE: The \"virtual_machine_id\"
        field in the payload will be ignored and the virtual machine ID
        provided in the URL will be honored.
        ...
        :type  virtual_machine_id: :class:`str`
...
class _TagsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        create_input_type = type.StructType('operation-input', {
            ...
            'virtual_machine_id': type.StringType(),
        ...
        create_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/policy/api/v1/orgs/{org-id}/projects/{project-id}/vpcs/{vpc-id}/virtual-machines/{virtual-machine-id}/tags',
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.orgs.projects.vpcs.virtual_machines.tags',
