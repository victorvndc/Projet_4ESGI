...
#
# vAPI stub file for package com.vmware.nsx_policy.infra.tier_0s.locale_services.tunnels.statistics.
#---------------------------------------------------------------------------
...
class Summary(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.tier_0s.locale_services.tunnels.statistics.summary'
    """
    ...
    def get(self,
        ...
        :return: com.vmware.nsx_policy.model.AggregateTunnelTrafficStatistics
            The return value will contain all the attributes defined in
            :class:`com.vmware.nsx_policy.model_client.AggregateTunnelTrafficStatistics`.
...
class _SummaryStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/tier-0s/{tier-0-id}/locale-services/{locale-svc-id}/tunnels/{tunnel-id}/statistics/summary',
            path_variables={
                'tier0_id': 'tier-0-id',
        ...
        operations = {
            'get': {
                ...
                'output_type': type.DynamicStructType('vmware.vapi.dynamic_struct', {}, VapiStruct, [type.ReferenceType('com.vmware.nsx_policy.model_client', 'AggregateTunnelTrafficStatistics')]),
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.tier_0s.locale_services.tunnels.statistics.summary',
