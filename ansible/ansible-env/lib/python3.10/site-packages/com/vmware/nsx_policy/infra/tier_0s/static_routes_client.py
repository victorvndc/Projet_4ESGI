...
#
# vAPI stub file for package com.vmware.nsx_policy.infra.tier_0s.static_routes.
#---------------------------------------------------------------------------
...
class BfdPeers(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.tier_0s.static_routes.bfd_peers'
    """
    ...
    def delete(self,
        ...
        :param bfd_peer_id: BFD peer ID (required)
    ...
    def get(self,
        ...
        :type  bfd_peer_id: :class:`str`
        :param bfd_peer_id: BFD peer ID (required)
        :rtype: :class:`com.vmware.nsx_policy.model_client.StaticRouteBfdPeer`
    ...
    def list(self,
        ...
        :rtype: :class:`com.vmware.nsx_policy.model_client.StaticRouteBfdPeerListResult`
    ...
    def patch(self,
        ...
        :type  bfd_peer_id: :class:`str`
        :param bfd_peer_id: BFD peer ID (required)
        :type  static_route_bfd_peer: :class:`com.vmware.nsx_policy.model_client.StaticRouteBfdPeer`
        :param static_route_bfd_peer: (required)
        :raise: :class:`com.vmware.vapi.std.errors_client.InvalidRequest` 
            Bad Request, Precondition Failed
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized` 
            Forbidden
        ...
        return self._invoke('patch',
                            ...
                            'tier0_id': tier0_id,
                            'bfd_peer_id': bfd_peer_id,
                            'static_route_bfd_peer': static_route_bfd_peer,
                            })
...
class _BfdPeersStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        delete_rest_metadata = OperationRestMetadata(
            http_method='DELETE',
            url_template='/policy/api/v1/infra/tier-0s/{tier-0-id}/static-routes/bfd-peers/{bfd-peer-id}',
            path_variables={
                'tier0_id': 'tier-0-id',
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/tier-0s/{tier-0-id}/static-routes/bfd-peers',
            path_variables={
                'tier0_id': 'tier-0-id',
            },
             header_parameters={
        ...
        patch_input_type = type.StructType('operation-input', {
            'tier0_id': type.StringType(),
            'bfd_peer_id': type.StringType(),
            'static_route_bfd_peer': type.ReferenceType('com.vmware.nsx_policy.model_client', 'StaticRouteBfdPeer'),
        })
        patch_error_dict = {
            'com.vmware.vapi.std.errors.invalid_request':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidRequest'),
        ...
        patch_rest_metadata = OperationRestMetadata(
            http_method='PATCH',
            url_template='/policy/api/v1/infra/tier-0s/{tier-0-id}/static-routes/bfd-peers/{bfd-peer-id}',
            request_body_parameter='static_route_bfd_peer',
            path_variables={
                'tier0_id': 'tier-0-id',
                'bfd_peer_id': 'bfd-peer-id',
            },
        ...
        operations = {
            ...
            'get': {
                ...
                'output_type': type.ReferenceType('com.vmware.nsx_policy.model_client', 'StaticRouteBfdPeer'),
            ...
            'list': {
                ...
                'output_type': type.ReferenceType('com.vmware.nsx_policy.model_client', 'StaticRouteBfdPeerListResult'),
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.tier_0s.static_routes.bfd_peers',
...
class StubFactory(StubFactoryBase):
    _attrs = {
        'BfdPeers': BfdPeers,
        'bfd_peers': 'com.vmware.nsx_policy.infra.tier_0s.static_routes.bfd_peers_client.StubFactory',
    }
