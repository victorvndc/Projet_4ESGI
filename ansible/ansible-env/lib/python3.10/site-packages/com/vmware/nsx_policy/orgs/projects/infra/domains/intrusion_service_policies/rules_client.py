...
#
# vAPI stub file for package com.vmware.nsx_policy.orgs.projects.infra.domains.intrusion_service_policies.rules.
#---------------------------------------------------------------------------
...
class Statistics(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.orgs.projects.infra.domains.intrusion_service_policies.rules.statistics'
    """
    ...
    def list(self,
        ...
        """
        Get statistics of a IDS-IPS rule. - no enforcement point path
        ...
        :param ids_policy_id: IDS policy id (required)
        ...
        :rtype: :class:`com.vmware.nsx_policy.model_client.IdsRuleStatisticsListResult`
...
class _StatisticsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/orgs/{org-id}/projects/{project-id}/infra/domains/{domain-id}/intrusion-service-policies/{ids-policy-id}/rules/{rule-id}/statistics',
            path_variables={
                'org_id': 'org-id',
        ...
        operations = {
            'list': {
                ...
                'output_type': type.ReferenceType('com.vmware.nsx_policy.model_client', 'IdsRuleStatisticsListResult'),
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.orgs.projects.infra.domains.intrusion_service_policies.rules.statistics',
