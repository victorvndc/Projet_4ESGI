...
#
# vAPI stub file for package com.vmware.nsx_policy.orgs.projects.infra.session_timer_profiles.
#---------------------------------------------------------------------------
...
class Bindings(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.orgs.projects.infra.session_timer_profiles.bindings'
    """
    ...
    def list(self,
        ...
        :type  session_timer_profile_id: :class:`str`
        :param session_timer_profile_id: (required)
        ...
        :rtype: :class:`com.vmware.nsx_policy.model_client.SessionTimerProfileBindingListResult`
        :return: com.vmware.nsx_policy.model.SessionTimerProfileBindingListResult
        ...
        return self._invoke('list',
                            ...
                            'session_timer_profile_id': session_timer_profile_id,
                            'cursor': cursor,
...
class _BindingsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/orgs/{org-id}/projects/{project-id}/infra/session-timer-profiles/{session-timer-profile-id}/bindings',
            path_variables={
                'org_id': 'org-id',
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.orgs.projects.infra.session_timer_profiles.bindings',
