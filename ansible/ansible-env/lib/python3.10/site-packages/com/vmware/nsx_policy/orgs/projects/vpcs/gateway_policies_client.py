...
#
# vAPI stub file for package com.vmware.nsx_policy.orgs.projects.vpcs.gateway_policies.
#---------------------------------------------------------------------------
...
class Rules(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.orgs.projects.vpcs.gateway_policies.rules'
    """
    ...
    def delete(self,
        ...
        """
        Delete N-S Firewall Rule DELETE
        /orgs/org1/projects/project1/vpcs/vpc-1/gateway-policies/default/rules/rule-1
    ...
    def list(self,
        ...
        """
        List N-S Firewall Rules GET
        /orgs/org1/projects/project1/vpcs/vpc-1/gateway-policies/default/rules
    ...
    def patch(self,
        ...
        """
        Patch the N-S Firewall Rule. If a Rule for the given Rule-id is not
        present, the object will get created and if it is present it will be
        updated. This is a full replace PATCH
        /orgs/org1/projects/project1/vpcs/vpc-1/gateway-policies/default/rules/rule-1
    ...
    def update(self,
        ...
        """
        Update the N-S Firewall Rule. If a Rule with the rule-id is not already
        present, this API fails with a 404. Creation of Rules is not allowed
        using this API. PUT
        /orgs/org1/projects/project1/vpcs/vpc-1/gateway-policies/default/rules/rule-1
...
class Statistics(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.orgs.projects.vpcs.gateway_policies.statistics'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    def list(self,
        ...
        """
        Get statistics of a gateway policy. - no enforcement point path
        ...
        :type  gateway_policy_id: :class:`str`
        :param gateway_policy_id: Gateway policy id (required)
...
class _RulesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        delete_rest_metadata = OperationRestMetadata(
            http_method='DELETE',
            url_template='/policy/api/v1/orgs/{org-id}/projects/{project-id}/vpcs/{vpc-id}/gateway-policies/{gateway-policy-id}/rules/{rule-id}',
            path_variables={
                'org_id': 'org-id',
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/orgs/{org-id}/projects/{project-id}/vpcs/{vpc-id}/gateway-policies/{gateway-policy-id}/rules',
            path_variables={
                'org_id': 'org-id',
                'project_id': 'project-id',
                'vpc_id': 'vpc-id',
        ...
        revise_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/policy/api/v1/orgs/{org-id}/projects/{project-id}/vpcs/{vpc-id}/gateway-policies/{gateway-policy-id}/rules/{rule-id}?action=revise',
            request_body_parameter='rule',
            path_variables={
                'org_id': 'org-id',
                'project_id': 'project-id',
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.orgs.projects.vpcs.gateway_policies.rules',
...
class _StatisticsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/orgs/{org-id}/projects/{project-id}/vpcs/{vpc-id}/gateway-policies/{gateway-policy-id}/statistics',
            path_variables={
                'org_id': 'org-id',
                'project_id': 'project-id',
                'vpc_id': 'vpc-id',
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.orgs.projects.vpcs.gateway_policies.statistics',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class StubFactory(StubFactoryBase):
    _attrs = {
        ...
        'rules': 'com.vmware.nsx_policy.orgs.projects.vpcs.gateway_policies.rules_client.StubFactory',
    }
