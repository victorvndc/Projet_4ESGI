...
#
# vAPI stub file for package com.vmware.nsx_policy.infra.sites.enforcement_points.edge_clusters.
#---------------------------------------------------------------------------
...
class EdgeNodes(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.sites.enforcement_points.edge_clusters.edge_nodes'
    """
...
class FqdnAnalysisConfig(VapiInterface):
    """
    
    """

    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.sites.enforcement_points.edge_clusters.fqdn_analysis_config'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
        ...
        :param config: Configuration to be used for creating the stub.
        """
        VapiInterface.__init__(self, config, _FqdnAnalysisConfigStub)
        self._VAPI_OPERATION_IDS = {}
    ...
    def get(self,
        ...
        """
        Gets a FqdnAnalysisConfig. This returns the details of the config like
        whether the FQDN Analysis is activated or deactivated for the given
        edge cluster.
        ...
        :type  edge_cluster_id: :class:`str`
        :param edge_cluster_id: (required)
        :rtype: :class:`com.vmware.nsx_policy.model_client.FqdnAnalysisConfig`
    ...
    def patch(self,
        ...
        """
        Creates/Updates a FqdnAnalysisConfig object. If FqdnAnalysisConfig
        object does not exists for the passed edge-cluster node, create a new
        FqdnAnalysisConfig object. If it already exists, patch it.
        ...
        :type  edge_cluster_id: :class:`str`
        :param edge_cluster_id: (required)
        :type  fqdn_analysis_config: :class:`com.vmware.nsx_policy.model_client.FqdnAnalysisConfig`
        :param fqdn_analysis_config: (required)
        :rtype: :class:`com.vmware.nsx_policy.model_client.FqdnAnalysisConfig`
        :return: com.vmware.nsx_policy.model.FqdnAnalysisConfig
        :raise: :class:`com.vmware.vapi.std.errors_client.InvalidRequest` 
            Bad Request, Precondition Failed
        ...
        return self._invoke('patch',
                            ...
                            'enforcement_point_id': enforcement_point_id,
                            'edge_cluster_id': edge_cluster_id,
                            'fqdn_analysis_config': fqdn_analysis_config,
                            })
    ...
    def update(self,
        ...
        """
        Creates/Updates FqdnAnalysisConfig Object for the given edge cluster.
        If FqdnAnalysisConfig object is not already present, creates it. If it
        already exists, replace with this object.
...
class UrlCategorizationConfigs(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.sites.enforcement_points.edge_clusters.url_categorization_configs'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    def delete(self,
        ...
        categorization will be deactivated for that edge cluster.
    ...
    def get(self,
        ...
        config like whether the URL categorization is activated or deactivated,
        the id of the context profiles which are used to filter the categories,
        and the update frequency of the data from the cloud.
    ...
    def patch(self,
        ...
        the PolicyUrlCategorizationConfig will activate or deactivate URL
...
class _EdgeNodesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/sites/{site-id}/enforcement-points/{enforcementpoint-id}/edge-clusters/{edge-cluster-id}/edge-nodes/{edge-node-id}',
            path_variables={
                'site_id': 'site-id',
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/sites/{site-id}/enforcement-points/{enforcementpoint-id}/edge-clusters/{edge-cluster-id}/edge-nodes',
            path_variables={
                'site_id': 'site-id',
                'enforcementpoint_id': 'enforcementpoint-id',
                'edge_cluster_id': 'edge-cluster-id',
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.sites.enforcement_points.edge_clusters.edge_nodes',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)

class _FqdnAnalysisConfigStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        delete_rest_metadata = OperationRestMetadata(
            http_method='DELETE',
            url_template='/policy/api/v1/infra/sites/{site-id}/enforcement-points/{enforcement-point-id}/edge-clusters/{edge-cluster-id}/fqdn-analysis-config',
            path_variables={
                'site_id': 'site-id',
        ...
        patch_input_type = type.StructType('operation-input', {
            ...
            'enforcement_point_id': type.StringType(),
            'edge_cluster_id': type.StringType(),
            'fqdn_analysis_config': type.ReferenceType('com.vmware.nsx_policy.model_client', 'FqdnAnalysisConfig'),
        })
        patch_error_dict = {
            'com.vmware.vapi.std.errors.invalid_request':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidRequest'),
        ...
        patch_rest_metadata = OperationRestMetadata(
            http_method='PATCH',
            url_template='/policy/api/v1/infra/sites/{site-id}/enforcement-points/{enforcement-point-id}/edge-clusters/{edge-cluster-id}/fqdn-analysis-config',
            request_body_parameter='fqdn_analysis_config',
            path_variables={
                'site_id': 'site-id',
                'enforcement_point_id': 'enforcement-point-id',
                'edge_cluster_id': 'edge-cluster-id',
        ...
        operations = {
            ...
            'get': {
                'input_type': get_input_type,
                'output_type': type.ReferenceType('com.vmware.nsx_policy.model_client', 'FqdnAnalysisConfig'),
                'errors': get_error_dict,
                'input_value_validator_list': get_input_value_validator_list,
                'output_validator_list': get_output_validator_list,
                'task_type': TaskType.NONE,
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.sites.enforcement_points.edge_clusters.fqdn_analysis_config',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class _UrlCategorizationConfigsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        delete_rest_metadata = OperationRestMetadata(
            http_method='DELETE',
            url_template='/policy/api/v1/infra/sites/{site-id}/enforcement-points/{enforcement-point-id}/edge-clusters/{edge-cluster-id}/url-categorization-configs/{url-categorization-config-id}',
            path_variables={
                'site_id': 'site-id',
                'enforcement_point_id': 'enforcement-point-id',
                'edge_cluster_id': 'edge-cluster-id',
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.sites.enforcement_points.edge_clusters.url_categorization_configs',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class StubFactory(StubFactoryBase):
    _attrs = {
        'EdgeNodes': EdgeNodes,
        'FqdnAnalysisConfig': FqdnAnalysisConfig,
