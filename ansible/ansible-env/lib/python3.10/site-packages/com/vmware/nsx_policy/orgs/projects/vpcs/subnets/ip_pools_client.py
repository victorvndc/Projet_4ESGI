...
#
# vAPI stub file for package com.vmware.nsx_policy.orgs.projects.vpcs.subnets.ip_pools.
#---------------------------------------------------------------------------
...
class IpAllocations(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.orgs.projects.vpcs.subnets.ip_pools.ip_allocations'
    """
    ...
    def patch(self,
        ...
        """
        Create a VPC Subnet ip-allocation if it does not exist based on the
        IDs, or update existing ip-allocation
    ...
    def update(self,
        ...
        """
        Create a VPC Subnet ip allocation if it does not exist based on the
        IDs, or update existing ip-allocation information by replacing the port
...
class _IpAllocationsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        delete_rest_metadata = OperationRestMetadata(
            http_method='DELETE',
            url_template='/policy/api/v1/orgs/{org-id}/projects/{project-id}/vpcs/{vpc-id}/subnets/{subnet-id}/ip-pools/{ip-pool-id}/ip-allocations/{ip-allocation-id}',
            path_variables={
                'org_id': 'org-id',
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/orgs/{org-id}/projects/{project-id}/vpcs/{vpc-id}/subnets/{subnet-id}/ip-pools/{ip-pool-id}/ip-allocations',
            path_variables={
                'org_id': 'org-id',
                'project_id': 'project-id',
                'vpc_id': 'vpc-id',
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.orgs.projects.vpcs.subnets.ip_pools.ip_allocations',
