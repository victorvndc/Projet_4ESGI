...
#
# vAPI stub file for package com.vmware.nsx_policy.infra.realized_state.enforcement_points.mac_sets.
#---------------------------------------------------------------------------
...
class MacSetsNsxt(VapiInterface):
    """
    
    """

    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.realized_state.enforcement_points.mac_sets.mac_sets_nsxt'
    """
    ...
    def __init__(self, config):
        ...
        """
        VapiInterface.__init__(self, config, _MacSetsNsxtStub)
    ...
    def get(self,
        ...
        :type  mac_set_name: :class:`str`
        :param mac_set_name: MACSet name (required)
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx_policy.infra.realized_state.enforcement_points.mac_sets.MacSetsNsxt.get is deprecated.', DeprecationWarning)
        return self._invoke('get',
                            {
                            'enforcement_point_name': enforcement_point_name,
                            'mac_set_name': mac_set_name,
                            })
    ...
    def list(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx_policy.infra.realized_state.enforcement_points.mac_sets.MacSetsNsxt.list is deprecated.', DeprecationWarning)
...
class _MacSetsNsxtStub(ApiInterfaceStub):
    def __init__(self, config):
