...
#
# vAPI stub file for package com.vmware.nsx_policy.infra.tier_0s.nat.
#---------------------------------------------------------------------------
...
class NatRules(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.tier_0s.nat.nat_rules'
    """
    ...
    def delete(self,
        ...
        """
        Delete NAT Rule from Tier-0 denoted by Tier-0 ID, under NAT section
        denoted by <nat-id>. Under tier-0 there will be 3 different
    ...
    def get(self,
        ...
        PUT/PATCH API, the path returned in the GET response payload will be a
    ...
    def list(self,
        ...
        as Scope: Please note that old IPSecVpnSession policy path deprecated.
        If user specifiy old IPSecVpnSession path in the scope property in the
        PATCH/PUT API, the path returned in the GET response payload will be a
        new path instead of the deprecated IPSecVpnSession path Both old and
        new IPSecVpnSession path refer to same resource. there is no functional
        impact.
    ...
    def patch(self,
        ...
        already exists, update the NAT Rule. Under tier-0 there will be 3
        ...
        property in the PATCH API, the path returned in the GET response
    ...
    def update(self,
        ...
        """
        Create or update NAT Rule on Tier-0 denoted by Tier-0 ID, under NAT
        section denoted by <nat-id>. Under tier-0 there will be 3 different
        NATs(sections). (INTERNAL, USER and DEFAULT) For more details related
        to NAT section please refer to PolicyNAT schema. Note: IPSecVpnSession
        as Scope: Please note that old IPSecVpnSession policy path deprecated.
        If user specifiy old IPSecVpnSession path in the scope property in the
        PUT API, the path returned in the PUT/GET response payload will be a
        new path instead of the deprecated IPSecVpnSession path Both old and
        new IPSecVpnSession path refer to same resource. there is no functional
        impact.
...
class Statistics(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.tier_0s.nat.statistics'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class _NatRulesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        delete_rest_metadata = OperationRestMetadata(
            http_method='DELETE',
            url_template='/policy/api/v1/infra/tier-0s/{tier-0-id}/nat/{nat-id}/nat-rules/{nat-rule-id}',
            path_variables={
                'tier0_id': 'tier-0-id',
                'nat_id': 'nat-id',
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/tier-0s/{tier-0-id}/nat/{nat-id}/nat-rules',
            path_variables={
                'tier0_id': 'tier-0-id',
                'nat_id': 'nat-id',
            },
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.tier_0s.nat.nat_rules',
...
class _StatisticsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/tier-0s/{tier-0-id}/nat/statistics',
            path_variables={
                'tier0_id': 'tier-0-id',
            },
             header_parameters={
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.tier_0s.nat.statistics',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class StubFactory(StubFactoryBase):
    _attrs = {
        ...
        'nat_rules': 'com.vmware.nsx_policy.infra.tier_0s.nat.nat_rules_client.StubFactory',
    }
