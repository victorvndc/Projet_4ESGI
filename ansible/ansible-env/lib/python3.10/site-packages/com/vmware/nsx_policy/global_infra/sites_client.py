...
#
# vAPI stub file for package com.vmware.nsx_policy.global_infra.sites.
#---------------------------------------------------------------------------
...
class EnforcementPoints(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.global_infra.sites.enforcement_points'
    """
...
class ListenerCertificate(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.global_infra.sites.listener_certificate'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class _EnforcementPointsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/global-infra/sites/{site-id}/enforcement-points/{enforcementpoint-id}',
            path_variables={
                'site_id': 'site-id',
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/global-infra/sites/{site-id}/enforcement-points',
            path_variables={
                'site_id': 'site-id',
            },
             header_parameters={
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.global_infra.sites.enforcement_points',
...
class _ListenerCertificateStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/global-infra/sites/listener_certificate',
            path_variables={
            },
             header_parameters={
                 },
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.global_infra.sites.listener_certificate',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class StubFactory(StubFactoryBase):
    _attrs = {
        ...
        'enforcement_points': 'com.vmware.nsx_policy.global_infra.sites.enforcement_points_client.StubFactory',
    }
