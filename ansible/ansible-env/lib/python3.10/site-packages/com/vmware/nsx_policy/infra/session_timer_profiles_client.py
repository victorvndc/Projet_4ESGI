...
#
# vAPI stub file for package com.vmware.nsx_policy.infra.session_timer_profiles.
#---------------------------------------------------------------------------
...
class Bindings(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.session_timer_profiles.bindings'
    """
