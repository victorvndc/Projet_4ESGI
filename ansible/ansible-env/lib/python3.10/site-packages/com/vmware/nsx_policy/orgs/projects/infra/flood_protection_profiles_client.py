...
#
# vAPI stub file for package com.vmware.nsx_policy.orgs.projects.infra.flood_protection_profiles.
#---------------------------------------------------------------------------
...
class Bindings(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.orgs.projects.infra.flood_protection_profiles.bindings'
    """
    ...
    def list(self,
        ...
        :param flood_protection_profile_id: (required)
        ...
        :rtype: :class:`com.vmware.nsx_policy.model_client.FloodProtectionProfileBindingListResult`
...
class _BindingsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/orgs/{org-id}/projects/{project-id}/infra/flood-protection-profiles/{flood-protection-profile-id}/bindings',
            path_variables={
                'org_id': 'org-id',
        ...
        operations = {
            'list': {
                ...
                'output_type': type.ReferenceType('com.vmware.nsx_policy.model_client', 'FloodProtectionProfileBindingListResult'),
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.orgs.projects.infra.flood_protection_profiles.bindings',
