...
#
# vAPI stub file for package com.vmware.nsx_policy.orgs.projects.vpcs.subnets.dhcp_server_config.
#---------------------------------------------------------------------------
...
class Stats(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.orgs.projects.vpcs.subnets.dhcp_server_config.stats'
    """
    ...
    def get(self,
        ...
        """
        Read VPC Subnet DHCP server statistics along with ip pool usage
        information.
...
class Status(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.orgs.projects.vpcs.subnets.dhcp_server_config.status'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class _StatsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/orgs/{org-id}/projects/{project-id}/vpcs/{vpc-id}/subnets/{subnet-id}/dhcp-server-config/stats',
            path_variables={
                'org_id': 'org-id',
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.orgs.projects.vpcs.subnets.dhcp_server_config.stats',
...
class _StatusStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/orgs/{org-id}/projects/{project-id}/vpcs/{vpc-id}/subnets/{subnet-id}/dhcp-server-config/status',
            path_variables={
                'org_id': 'org-id',
                'project_id': 'project-id',
                'vpc_id': 'vpc-id',
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.orgs.projects.vpcs.subnets.dhcp_server_config.status',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
