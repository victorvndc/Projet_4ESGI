...
#
# vAPI stub file for package com.vmware.nsx_policy.global_infra.tier_0s.nat.
#---------------------------------------------------------------------------
...
class NatRules(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.global_infra.tier_0s.nat.nat_rules'
    """
...
class Statistics(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.global_infra.tier_0s.nat.statistics'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class _NatRulesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/global-infra/tier-0s/{tier-0-id}/nat/{nat-id}/nat-rules/{nat-rule-id}',
            path_variables={
                'tier0_id': 'tier-0-id',
                'nat_id': 'nat-id',
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/global-infra/tier-0s/{tier-0-id}/nat/{nat-id}/nat-rules',
            path_variables={
                'tier0_id': 'tier-0-id',
                'nat_id': 'nat-id',
            },
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.global_infra.tier_0s.nat.nat_rules',
...
class _StatisticsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/global-infra/tier-0s/{tier-0-id}/nat/statistics',
            path_variables={
                'tier0_id': 'tier-0-id',
            },
             header_parameters={
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.global_infra.tier_0s.nat.statistics',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class StubFactory(StubFactoryBase):
    _attrs = {
        ...
        'nat_rules': 'com.vmware.nsx_policy.global_infra.tier_0s.nat.nat_rules_client.StubFactory',
    }
