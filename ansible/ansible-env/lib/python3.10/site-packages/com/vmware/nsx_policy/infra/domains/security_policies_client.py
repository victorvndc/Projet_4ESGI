...
#
# vAPI stub file for package com.vmware.nsx_policy.infra.domains.security_policies.
#---------------------------------------------------------------------------
...
class ContainerClusterSpan(VapiInterface):
    """
    
    """

    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.domains.security_policies.container_cluster_span'
    """
    ...
    def __init__(self, config):
        ...
        """
        VapiInterface.__init__(self, config, _ContainerClusterSpanStub)
    ...
    def delete(self,
        ...
        :type  antrea_cluster1: :class:`str`
        :param antrea_cluster1: (required)
        ...
        return self._invoke('delete',
                            ...
                            'antrea_cluster1': antrea_cluster1,
                            })
    ...
    def get(self,
        ...
        :type  antrea_cluster1: :class:`str`
        :param antrea_cluster1: (required)
        :rtype: :class:`com.vmware.nsx_policy.model_client.SecurityPolicyContainerCluster`
    ...
    def list(self,
        ...
        :rtype: :class:`com.vmware.nsx_policy.model_client.SecurityPolicyContainerClusterListResult`
    ...
    def patch(self,
        ...
        """
        Add a container cluster as a span of this security policy. If there
        already exists another object containing the same container cluster
        path, an error will be thrown. The container cluster path cannot be
        modified If the path has to be modified, then delete this entity and
        add a new entity with the desired container cluster path
        ...
        :type  security_policy_container_cluster: :class:`com.vmware.nsx_policy.model_client.SecurityPolicyContainerCluster`
        :param security_policy_container_cluster: (required)
        :raise: :class:`com.vmware.vapi.std.errors_client.InvalidRequest` 
            Bad Request, Precondition Failed
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized` 
            Forbidden
        ...
        return self._invoke('patch',
                            ...
                            'security_policy_container_cluster': security_policy_container_cluster,
                            })
...
class Rules(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.domains.security_policies.rules'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class Statistics(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.domains.security_policies.statistics'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class _ContainerClusterSpanStub(ApiInterfaceStub):
    def __init__(self, config):
        # properties for delete operation
        delete_input_type = type.StructType('operation-input', {
            'domain_id': type.StringType(),
            'security_policy_id': type.StringType(),
            'antrea_cluster1': type.StringType(),
        })
        delete_error_dict = {
        ...
        delete_rest_metadata = OperationRestMetadata(
            http_method='DELETE',
            url_template='/policy/api/v1/infra/domains/{domain-id}/security-policies/{security-policy-id}/container-cluster-span/{antrea-cluster-1}',
            path_variables={
                'domain_id': 'domain-id',
                'security_policy_id': 'security-policy-id',
                'antrea_cluster1': 'antrea-cluster-1',
            },
             header_parameters={
                   },
            query_parameters={
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/domains/{domain-id}/security-policies/{security-policy-id}/container-cluster-span',
            path_variables={
                'domain_id': 'domain-id',
                'security_policy_id': 'security-policy-id',
            },
        ...
        patch_input_type = type.StructType('operation-input', {
            ...
            'security_policy_container_cluster': type.ReferenceType('com.vmware.nsx_policy.model_client', 'SecurityPolicyContainerCluster'),
        })
        patch_error_dict = {
            'com.vmware.vapi.std.errors.invalid_request':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidRequest'),
        ...
        patch_rest_metadata = OperationRestMetadata(
            http_method='PATCH',
            url_template='/policy/api/v1/infra/domains/{domain-id}/security-policies/{security-policy-id}/container-cluster-span/{container-cluster-id}',
            request_body_parameter='security_policy_container_cluster',
            path_variables={
                'domain_id': 'domain-id',
                'security_policy_id': 'security-policy-id',
        ...
        operations = {
            ...
            'get': {
                ...
                'output_type': type.ReferenceType('com.vmware.nsx_policy.model_client', 'SecurityPolicyContainerCluster'),
            ...
            'list': {
                ...
                'output_type': type.ReferenceType('com.vmware.nsx_policy.model_client', 'SecurityPolicyContainerClusterListResult'),
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.domains.security_policies.container_cluster_span',
...
class _RulesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        delete_rest_metadata = OperationRestMetadata(
            http_method='DELETE',
            url_template='/policy/api/v1/infra/domains/{domain-id}/security-policies/{security-policy-id}/rules/{rule-id}',
            path_variables={
                'domain_id': 'domain-id',
                'security_policy_id': 'security-policy-id',
                'rule_id': 'rule-id',
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/domains/{domain-id}/security-policies/{security-policy-id}/rules',
            path_variables={
                'domain_id': 'domain-id',
                'security_policy_id': 'security-policy-id',
            },
        ...
        revise_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/policy/api/v1/infra/domains/{domain-id}/security-policies/{security-policy-id}/rules/{rule-id}?action=revise',
            request_body_parameter='rule',
            path_variables={
                'domain_id': 'domain-id',
                'security_policy_id': 'security-policy-id',
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.domains.security_policies.rules',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class _StatisticsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/domains/{domain-id}/security-policies/{security-policy-id}/statistics',
            path_variables={
                'domain_id': 'domain-id',
                'security_policy_id': 'security-policy-id',
            },
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.domains.security_policies.statistics',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class StubFactory(StubFactoryBase):
    _attrs = {
        'ContainerClusterSpan': ContainerClusterSpan,
        'Rules': Rules,
        'Statistics': Statistics,
        'rules': 'com.vmware.nsx_policy.infra.domains.security_policies.rules_client.StubFactory',
    }
