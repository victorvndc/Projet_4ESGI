...
class ArpProxies(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.tier_0s.arp_proxies'
    """
...
class CommunityLists(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.tier_0s.community_lists'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    def patch(self,
        ...
        :type  community_list_id: :class:`str`
        :param community_list_id: (required)
        :type  community_list: :class:`com.vmware.nsx_policy.model_client.CommunityList`
        :param community_list: (required)
        :raise: :class:`com.vmware.vapi.std.errors_client.InvalidRequest` 
            Bad Request, Precondition Failed
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized` 
            Forbidden
    ...
    def update(self,
        ...
        """
        If a community list with the community-list-id is not already present,
        create a new community list. If it already exists, replace the
        community list instance with the new object.
...
class DnsForwarder(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.tier_0s.dns_forwarder'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class Evpn(VapiInterface):
    """
    
    """

    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.tier_0s.evpn'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
        ...
        :param config: Configuration to be used for creating the stub.
        """
        VapiInterface.__init__(self, config, _EvpnStub)
        self._VAPI_OPERATION_IDS = {}
    ...
    def get(self,
        ...
        :rtype: :class:`com.vmware.nsx_policy.model_client.EvpnConfig`
    ...
    def patch(self,
        ...
        """
        Create a evpn configuration if it is not already present, otherwise
        update the evpn configuration.

        :type  tier0_id: :class:`str`
        :param tier0_id: tier0 id (required)
        :type  evpn_config: :class:`com.vmware.nsx_policy.model_client.EvpnConfig`
        :param evpn_config: (required)
        :raise: :class:`com.vmware.vapi.std.errors_client.InvalidRequest` 
            Bad Request, Precondition Failed
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized` 
            Forbidden
...
class FloodProtectionProfileBindings(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.tier_0s.flood_protection_profile_bindings'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class ForwardingTable(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.tier_0s.forwarding_table'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class GatewayFirewall(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.tier_0s.gateway_firewall'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class Groups(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.tier_0s.groups'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    def patch(self,
        ...
        under the tier-0-id. Update if exists. The API valiates that Tier-0 is
...
class InterVrfRouting(VapiInterface):
    """
    
    """

    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.tier_0s.inter_vrf_routing'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
        ...
        :param config: Configuration to be used for creating the stub.
        """
        VapiInterface.__init__(self, config, _InterVrfRoutingStub)
        self._VAPI_OPERATION_IDS = {}


    def delete(self,
               tier0_id,
               inter_vrf_routing_id,
               ):
        """
        ...
        :type  tier0_id: :class:`str`
        :param tier0_id: (required)
        :type  inter_vrf_routing_id: :class:`str`
        :param inter_vrf_routing_id: (required)
        :raise: :class:`com.vmware.vapi.std.errors_client.InvalidRequest` 
            Bad Request, Precondition Failed
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized` 
            Forbidden
        ...
        return self._invoke('delete',
                            {
                            'tier0_id': tier0_id,
                            'inter_vrf_routing_id': inter_vrf_routing_id,
                            })
    ...
    def get(self,
        ...
        :type  inter_vrf_routing_id: :class:`str`
        :param inter_vrf_routing_id: (required)
        :rtype: :class:`com.vmware.nsx_policy.model_client.PolicyInterVrfRoutingConfig`
    ...
    def list(self,
        ...
        :type  sort_by: :class:`str` or ``None``
        :param sort_by: Field by which records are sorted (optional)
        :rtype: :class:`com.vmware.nsx_policy.model_client.PolicyInterVrfRoutingConfigListResult`
    ...
    def patch(self,
        ...
        :type  inter_vrf_routing_id: :class:`str`
        :param inter_vrf_routing_id: (required)
        :type  policy_inter_vrf_routing_config: :class:`com.vmware.nsx_policy.model_client.PolicyInterVrfRoutingConfig`
        :param policy_inter_vrf_routing_config: (required)
        :raise: :class:`com.vmware.vapi.std.errors_client.InvalidRequest` 
            Bad Request, Precondition Failed
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized` 
            Forbidden
        ...
        return self._invoke('patch',
                            ...
                            'tier0_id': tier0_id,
                            'inter_vrf_routing_id': inter_vrf_routing_id,
                            'policy_inter_vrf_routing_config': policy_inter_vrf_routing_config,
                            })
...
class IpsecVpnServices(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.tier_0s.ipsec_vpn_services'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    def update(self,
        ...
        """
        Create or fully replace IPSec VPN service under given Tier-0. Revision
        is optional for creation and required for update.
...
class L2vpnServices(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.tier_0s.l2vpn_services'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    def update(self,
        ...
        """
        Create or fully replace L2VPN service for given Tier-0. Revision is
...
class LocaleServices(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.tier_0s.locale_services'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class Nat(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.tier_0s.nat'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class NumberOfRoutes(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.tier_0s.number_of_routes'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class PrefixLists(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.tier_0s.prefix_lists'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    def patch(self,
        ...
        prefix list. If it already exists, patch prefix list for
        prefix-list-id. Note: Patching existing prefix-list's \"prefixes\"
        property will overwrite the existing prefixes. GET and PATCH is the
        expected set of operations to update or append new entries to the
        existig prefixes. Patching existing prefixes require order to be
        preserved to avoid traffic impact. During PATCH operation, reordering
        of existing prefixes may impact routes and eventually datapath. Order
        here is crucial and it all depends upon action. If action for every
        prefix is PERMIT then order may not impact but if there is DENY prefix
        then change in ordering could lead to traffic impact.
    ...
    def update(self,
        ...
        prefix-list-id. Note: Updating existing prefixes require order to be
        preserved to avoid traffic impact. During PATCH operation, reordering
        of existing prefixes may impact routes and eventually datapath. Order
        here is crucial and it all depends upon action. If action for every
        prefix is PERMIT then order may not impact but if there is DENY prefix
...
class RouteMaps(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.tier_0s.route_maps'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    def patch(self,
        ...
        """
        If a route map with the route-map-id is not already present, create a
        new route map. If it already exists, update the route map for specified
        attributes.
        ...
        :type  route_map_id: :class:`str`
        :param route_map_id: (required)
        :type  tier0_route_map: :class:`com.vmware.nsx_policy.model_client.Tier0RouteMap`
        :param tier0_route_map: (required)
        :raise: :class:`com.vmware.vapi.std.errors_client.InvalidRequest` 
            Bad Request, Precondition Failed
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized` 
            Forbidden
        ...
        return self._invoke('patch',
                            ...
                            'tier0_id': tier0_id,
                            'route_map_id': route_map_id,
                            'tier0_route_map': tier0_route_map,
                            })
    ...
    def update(self,
        ...
        """
        If a route map with the route-map-id is not already present, create a
        new route map. If it already exists, replace the route map instance
        with the new object.
...
class RoutingTable(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.tier_0s.routing_table'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class SecurityConfig(VapiInterface):
    ...
    """
    DELETE_FEATURE_IDFW = "IDFW"
    """
    Possible value for ``feature`` of method :func:`SecurityConfig.delete`.

    """
    DELETE_FEATURE_IDPS = "IDPS"
    """
    Possible value for ``feature`` of method :func:`SecurityConfig.delete`.
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.tier_0s.security_config'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    def delete(self,
        ...
        :param feature: Collection of T0 supported security features (optional)
        :type  included_fields: :class:`str` or ``None``
        :param included_fields: Comma separated list of fields that should be included in query
            result (optional)
        :type  page_size: :class:`long` or ``None``
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx_policy.infra.tier_0s.SecurityConfig.delete is deprecated.', DeprecationWarning)
        return self._invoke('delete',
                            {
                            'tier0_id': tier0_id,
                            'cursor': cursor,
    ...
    def get(self,
        ...
        :type  sort_by: :class:`str` or ``None``
        :param sort_by: Field by which records are sorted (optional)
        :rtype: :class:`com.vmware.nsx_policy.model_client.Tier0SecurityFeatures`
    ...
    def patch(self,
        ...
        :type  tier0_id: :class:`str`
        :param tier0_id: tier0 id (required)
        :type  tier0_security_features: :class:`com.vmware.nsx_policy.model_client.Tier0SecurityFeatures`
        :param tier0_security_features: (required)
        :rtype: :class:`com.vmware.nsx_policy.model_client.Tier0SecurityFeatures`
        :return: com.vmware.nsx_policy.model.Tier0SecurityFeatures
        :raise: :class:`com.vmware.vapi.std.errors_client.InvalidRequest` 
            Bad Request, Precondition Failed
        ...
        return self._invoke('patch',
                            {
                            'tier0_id': tier0_id,
                            'tier0_security_features': tier0_security_features,
                            })
...
class SessionTimerProfileBindings(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.tier_0s.session_timer_profile_bindings'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    def delete(self,
        ...
        """
        API will delete Session Timer Profile Binding for Tier-0 Logical
        Router.
...
class State(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.tier_0s.state'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class StaticRoutes(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.tier_0s.static_routes'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class _ArpProxiesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/tier-0s/{tier-0-id}/arp-proxies',
            path_variables={
                'tier0_id': 'tier-0-id',
            },
             header_parameters={
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.tier_0s.arp_proxies',
...
class _CommunityListsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        delete_rest_metadata = OperationRestMetadata(
            http_method='DELETE',
            url_template='/policy/api/v1/infra/tier-0s/{tier-0-id}/community-lists/{community-list-id}',
            path_variables={
                'tier0_id': 'tier-0-id',
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/tier-0s/{tier-0-id}/community-lists',
            path_variables={
                'tier0_id': 'tier-0-id',
            },
             header_parameters={
        ...
        patch_input_type = type.StructType('operation-input', {
            'tier0_id': type.StringType(),
            'community_list_id': type.StringType(),
            'community_list': type.ReferenceType('com.vmware.nsx_policy.model_client', 'CommunityList'),
        })
        patch_error_dict = {
            'com.vmware.vapi.std.errors.invalid_request':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidRequest'),
        ...
        patch_rest_metadata = OperationRestMetadata(
            http_method='PATCH',
            url_template='/policy/api/v1/infra/tier-0s/{tier-0-id}/community-lists/{community-list-id}',
            request_body_parameter='community_list',
            path_variables={
                'tier0_id': 'tier-0-id',
                'community_list_id': 'community-list-id',
            },
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.tier_0s.community_lists',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class _DnsForwarderStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        create_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/policy/api/v1/infra/tier-0s/{tier-0-id}/dns-forwarder',
            path_variables={
                'tier0_id': 'tier-0-id',
            },
             header_parameters={
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.tier_0s.dns_forwarder',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)

class _EvpnStub(ApiInterfaceStub):
    def __init__(self, config):
        # properties for get operation
        get_input_type = type.StructType('operation-input', {
            'tier0_id': type.StringType(),
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/tier-0s/{tier-0-id}/evpn',
            path_variables={
                'tier0_id': 'tier-0-id',
            },
             header_parameters={
        ...
        patch_input_type = type.StructType('operation-input', {
            'tier0_id': type.StringType(),
            'evpn_config': type.ReferenceType('com.vmware.nsx_policy.model_client', 'EvpnConfig'),
        })
        patch_error_dict = {
            'com.vmware.vapi.std.errors.invalid_request':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidRequest'),
        ...
        patch_rest_metadata = OperationRestMetadata(
            http_method='PATCH',
            url_template='/policy/api/v1/infra/tier-0s/{tier-0-id}/evpn',
            request_body_parameter='evpn_config',
            path_variables={
                'tier0_id': 'tier-0-id',
            },
             header_parameters={
        ...
        operations = {
            'get': {
                'input_type': get_input_type,
                'output_type': type.ReferenceType('com.vmware.nsx_policy.model_client', 'EvpnConfig'),
                'errors': get_error_dict,
                'input_value_validator_list': get_input_value_validator_list,
                'output_validator_list': get_output_validator_list,
                'task_type': TaskType.NONE,
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.tier_0s.evpn',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class _FloodProtectionProfileBindingsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        delete_rest_metadata = OperationRestMetadata(
            http_method='DELETE',
            url_template='/policy/api/v1/infra/tier-0s/{tier0-id}/flood-protection-profile-bindings/{flood-protection-profile-binding-id}',
            path_variables={
                'tier0_id': 'tier0-id',
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.tier_0s.flood_protection_profile_bindings',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class _ForwardingTableStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/tier-0s/{tier-0-id}/forwarding-table',
            path_variables={
                'tier0_id': 'tier-0-id',
            },
             header_parameters={
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.tier_0s.forwarding_table',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class _GatewayFirewallStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/tier-0s/{tier-0-id}/gateway-firewall',
            path_variables={
                'tier0_id': 'tier-0-id',
            },
             header_parameters={
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.tier_0s.gateway_firewall',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class _GroupsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        delete_rest_metadata = OperationRestMetadata(
            http_method='DELETE',
            url_template='/policy/api/v1/infra/tier-0s/{tier-0-id}/groups/{group-id}',
            path_variables={
                'tier0_id': 'tier-0-id',
                'group_id': 'group-id',
            },
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/tier-0s/{tier-0-id}/groups',
            path_variables={
                'tier0_id': 'tier-0-id',
            },
             header_parameters={
...
class _InterVrfRoutingStub(ApiInterfaceStub):
    def __init__(self, config):
        # properties for delete operation
        delete_input_type = type.StructType('operation-input', {
            'tier0_id': type.StringType(),
            'inter_vrf_routing_id': type.StringType(),
        })
        delete_error_dict = {
            'com.vmware.vapi.std.errors.invalid_request':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidRequest'),
        ...
        delete_rest_metadata = OperationRestMetadata(
            http_method='DELETE',
            url_template='/policy/api/v1/infra/tier-0s/{tier-0-id}/inter-vrf-routing/{inter-vrf-routing-id}',
            path_variables={
                'tier0_id': 'tier-0-id',
                'inter_vrf_routing_id': 'inter-vrf-routing-id',
            },
             header_parameters={
                 },
            query_parameters={
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/tier-0s/{tier-0-id}/inter-vrf-routing',
            path_variables={
                'tier0_id': 'tier-0-id',
            },
             header_parameters={
        ...
        patch_input_type = type.StructType('operation-input', {
            'tier0_id': type.StringType(),
            'inter_vrf_routing_id': type.StringType(),
            'policy_inter_vrf_routing_config': type.ReferenceType('com.vmware.nsx_policy.model_client', 'PolicyInterVrfRoutingConfig'),
        })
        patch_error_dict = {
            'com.vmware.vapi.std.errors.invalid_request':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidRequest'),
        ...
        patch_rest_metadata = OperationRestMetadata(
            http_method='PATCH',
            url_template='/policy/api/v1/infra/tier-0s/{tier-0-id}/inter-vrf-routing/{inter-vrf-routing-id}',
            request_body_parameter='policy_inter_vrf_routing_config',
            path_variables={
                'tier0_id': 'tier-0-id',
                'inter_vrf_routing_id': 'inter-vrf-routing-id',
            },
        ...
        operations = {
            ...
            'get': {
                'input_type': get_input_type,
                'output_type': type.ReferenceType('com.vmware.nsx_policy.model_client', 'PolicyInterVrfRoutingConfig'),
                'errors': get_error_dict,
                'input_value_validator_list': get_input_value_validator_list,
                'output_validator_list': get_output_validator_list,
                'task_type': TaskType.NONE,
            ...
            'list': {
                'input_type': list_input_type,
                'output_type': type.ReferenceType('com.vmware.nsx_policy.model_client', 'PolicyInterVrfRoutingConfigListResult'),
                'errors': list_error_dict,
                'input_value_validator_list': list_input_value_validator_list,
                'output_validator_list': list_output_validator_list,
                'task_type': TaskType.NONE,
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.tier_0s.inter_vrf_routing',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class _IpsecVpnServicesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        delete_rest_metadata = OperationRestMetadata(
            http_method='DELETE',
            url_template='/policy/api/v1/infra/tier-0s/{tier-0-id}/ipsec-vpn-services/{service-id}',
            path_variables={
                'tier0_id': 'tier-0-id',
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/tier-0s/{tier-0-id}/ipsec-vpn-services',
            path_variables={
                'tier0_id': 'tier-0-id',
            },
             header_parameters={
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.tier_0s.ipsec_vpn_services',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class _L2vpnServicesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        delete_rest_metadata = OperationRestMetadata(
            http_method='DELETE',
            url_template='/policy/api/v1/infra/tier-0s/{tier-0-id}/l2vpn-services/{service-id}',
            path_variables={
                'tier0_id': 'tier-0-id',
                'service_id': 'service-id',
            },
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/tier-0s/{tier-0-id}/l2vpn-services',
            path_variables={
                'tier0_id': 'tier-0-id',
            },
             header_parameters={
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.tier_0s.l2vpn_services',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class _NatStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/tier-0s/{tier-0-id}/nat',
            path_variables={
                'tier0_id': 'tier-0-id',
            },
             header_parameters={
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.tier_0s.nat',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class _NumberOfRoutesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/tier-0s/{tier-0-id}/number-of-routes',
            path_variables={
                'tier0_id': 'tier-0-id',
            },
             header_parameters={
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.tier_0s.number_of_routes',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class _RouteMapsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        delete_rest_metadata = OperationRestMetadata(
            http_method='DELETE',
            url_template='/policy/api/v1/infra/tier-0s/{tier-0-id}/route-maps/{route-map-id}',
            path_variables={
                'tier0_id': 'tier-0-id',
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/tier-0s/{tier-0-id}/route-maps',
            path_variables={
                'tier0_id': 'tier-0-id',
            },
             header_parameters={
        ...
        patch_input_type = type.StructType('operation-input', {
            'tier0_id': type.StringType(),
            'route_map_id': type.StringType(),
            'tier0_route_map': type.ReferenceType('com.vmware.nsx_policy.model_client', 'Tier0RouteMap'),
        })
        patch_error_dict = {
            'com.vmware.vapi.std.errors.invalid_request':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidRequest'),
        ...
        patch_rest_metadata = OperationRestMetadata(
            http_method='PATCH',
            url_template='/policy/api/v1/infra/tier-0s/{tier-0-id}/route-maps/{route-map-id}',
            request_body_parameter='tier0_route_map',
            path_variables={
                'tier0_id': 'tier-0-id',
                'route_map_id': 'route-map-id',
            },
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.tier_0s.route_maps',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class _SecurityConfigStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        delete_rest_metadata = OperationRestMetadata(
            http_method='DELETE',
            url_template='/policy/api/v1/infra/tier-0s/{tier-0-id}/security-config',
            path_variables={
                'tier0_id': 'tier-0-id',
            },
             header_parameters={
        ...
        patch_input_type = type.StructType('operation-input', {
            'tier0_id': type.StringType(),
            'tier0_security_features': type.ReferenceType('com.vmware.nsx_policy.model_client', 'Tier0SecurityFeatures'),
        })
        patch_error_dict = {
            'com.vmware.vapi.std.errors.invalid_request':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidRequest'),
        ...
        patch_rest_metadata = OperationRestMetadata(
            http_method='PATCH',
            url_template='/policy/api/v1/infra/tier-0s/{tier-0-id}/security-config',
            request_body_parameter='tier0_security_features',
            path_variables={
                'tier0_id': 'tier-0-id',
            },
             header_parameters={
        ...
        operations = {
            ...
            'get': {
                'input_type': get_input_type,
                'output_type': type.ReferenceType('com.vmware.nsx_policy.model_client', 'Tier0SecurityFeatures'),
                'errors': get_error_dict,
                'input_value_validator_list': get_input_value_validator_list,
                'output_validator_list': get_output_validator_list,
                'task_type': TaskType.NONE,
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.tier_0s.security_config',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class _SessionTimerProfileBindingsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        delete_rest_metadata = OperationRestMetadata(
            http_method='DELETE',
            url_template='/policy/api/v1/infra/tier-0s/{tier0-id}/session-timer-profile-bindings/{session-timer-profile-binding-id}',
            path_variables={
                'tier0_id': 'tier0-id',
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.tier_0s.session_timer_profile_bindings',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class _StateStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/tier-0s/{tier-0-id}/state',
            path_variables={
                'tier0_id': 'tier-0-id',
            },
             header_parameters={
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.tier_0s.state',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class StubFactory(StubFactoryBase):
    _attrs = {
        ...
        'Groups': Groups,
        'InterVrfRouting': InterVrfRouting,
        ...
        'dns_forwarder': 'com.vmware.nsx_policy.infra.tier_0s.dns_forwarder_client.StubFactory',
        'inter_vrf_routing': 'com.vmware.nsx_policy.infra.tier_0s.inter_vrf_routing_client.StubFactory',
        'ipsec_vpn_services': 'com.vmware.nsx_policy.infra.tier_0s.ipsec_vpn_services_client.StubFactory',
        'l2vpn_services': 'com.vmware.nsx_policy.infra.tier_0s.l2vpn_services_client.StubFactory',
        'locale_services': 'com.vmware.nsx_policy.infra.tier_0s.locale_services_client.StubFactory',
        'nat': 'com.vmware.nsx_policy.infra.tier_0s.nat_client.StubFactory',
        'static_routes': 'com.vmware.nsx_policy.infra.tier_0s.static_routes_client.StubFactory',
        'tier_1_interface': 'com.vmware.nsx_policy.infra.tier_0s.tier_1_interface_client.StubFactory',
    }
