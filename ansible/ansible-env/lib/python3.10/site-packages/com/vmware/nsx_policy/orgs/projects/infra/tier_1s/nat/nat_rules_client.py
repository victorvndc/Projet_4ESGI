...
#
# vAPI stub file for package com.vmware.nsx_policy.orgs.projects.infra.tier_1s.nat.nat_rules.
#---------------------------------------------------------------------------
...
class Statistics(VapiInterface):
    ...
    """
    LIST_ACTION_AGGREGATE = "aggregate"
    """
    Possible value for ``action`` of method :func:`Statistics.list`.

    """

    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.orgs.projects.infra.tier_1s.nat.nat_rules.statistics'
    """
    ...
    def list(self,
        ...
        """
        Get NAT Rule Statistics from Tier-1 denoted by Tier-1 ID, under NAT
        ...
        :rtype: :class:`com.vmware.nsx_policy.model_client.PolicyNatRuleStatisticsListResult`
...
class _StatisticsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/orgs/{org-id}/projects/{project-id}/infra/tier-1s/{tier-1-id}/nat/{nat-id}/nat-rules/{nat-rule-id}/statistics',
            path_variables={
                'org_id': 'org-id',
        ...
        operations = {
            'list': {
                ...
                'output_type': type.ReferenceType('com.vmware.nsx_policy.model_client', 'PolicyNatRuleStatisticsListResult'),
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.orgs.projects.infra.tier_1s.nat.nat_rules.statistics',
