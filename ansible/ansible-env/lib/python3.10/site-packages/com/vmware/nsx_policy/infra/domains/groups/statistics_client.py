...
#
# vAPI stub file for package com.vmware.nsx_policy.infra.domains.groups.statistics.
#---------------------------------------------------------------------------
...
class VirtualMachines(VapiInterface):
    ...
    def list(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx_policy.infra.domains.groups.statistics.VirtualMachines.list is deprecated.', DeprecationWarning)
...
class _VirtualMachinesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/domains/{domain-id}/groups/{group-id}/statistics/virtual-machines',
            path_variables={
                'domain_id': 'domain-id',
                'group_id': 'group-id',
            },
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.domains.groups.statistics.virtual_machines',
