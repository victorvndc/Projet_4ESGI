...
#
# vAPI stub file for package com.vmware.nsx_policy.global_infra.segments.inter_site_forwarder.
#---------------------------------------------------------------------------
...
class SiteSpanInfo(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.global_infra.segments.inter_site_forwarder.site_span_info'
    """
...
class Status(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.global_infra.segments.inter_site_forwarder.status'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class _SiteSpanInfoStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/global-infra/segments/{segment-id}/inter-site-forwarder/site-span-info',
            path_variables={
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.global_infra.segments.inter_site_forwarder.site_span_info',
...
class _StatusStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/global-infra/segments/{segment-id}/inter-site-forwarder/status',
            path_variables={
                'segment_id': 'segment-id',
            },
             header_parameters={
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.global_infra.segments.inter_site_forwarder.status',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
