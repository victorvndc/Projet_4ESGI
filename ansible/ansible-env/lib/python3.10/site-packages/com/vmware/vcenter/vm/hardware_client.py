...
class Disk(VapiInterface):
    ...
    class HostBusAdapterType(Enum):
        ...
        NVME = None
        """
        Disk is attached to a NVMe adapter. This class attribute was added in
        vSphere API 7.0.0.1.
    ...
    class Info(VapiStruct):
        ...
        _validator_list = [
            UnionValidator(
                'type',
                {
                    'VMXNET3' : [('upt_compatibility_enabled', True), ('upt_v2_compatibility_enabled', True)],
                    'E1000' : [],
                    'E1000E' : [],
                    'PCNET32' : [],
                    'VMXNET' : [],
...
class Memory(VapiInterface):
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param hot_add_increment_size_mib: 
