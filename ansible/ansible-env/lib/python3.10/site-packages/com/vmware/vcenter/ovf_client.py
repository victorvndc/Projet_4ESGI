...
class WarningType(Enum):
    ...
    """
    The certificate used for signing the OVF package content is expired. This
...
class LibraryItem(VapiInterface):
    ...
    class VmConfigSpecProvider(Enum):
        ...
        ``LibraryItem.VmConfigSpec`` used when deploying an OVF template. This
        enumeration was added in vSphere API 8.0.2.0.
    ...
    class VmConfigSpec(VapiStruct):
        ...
        OVF descriptor acts as a disk descriptor. This class was added in vSphere
        API 8.0.2.0.
        ...
        def __init__(self,
            ...
            :param provider: The :attr:`LibraryItem.VmConfigSpec.provider` selects a provider
                from the list of available providers. This attribute was added in
                vSphere API 8.0.2.0.
            :type  xml: :class:`str`
            :param xml: The :attr:`LibraryItem.VmConfigSpec.xml` is a conditional
                ...
                to XML and base64 encoded. This attribute was added in vSphere API
                8.0.2.0.
                This attribute is optional and it is only relevant when the value
    ...
    class ResourcePoolDeploymentSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param vm_config_spec: The :attr:`LibraryItem.ResourcePoolDeploymentSpec.vm_config_spec`
                ...
                will also be honored. This attribute was added in vSphere API
                8.0.2.0.
...
class _LibraryItemStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        deploy_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/ovf/library-item/{ovfLibraryItemId}',
            path_variables={
