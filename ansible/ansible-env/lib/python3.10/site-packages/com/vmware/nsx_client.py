...
class Alarms(VapiInterface):
    ...
    def list(self,
        ...
        :type  event_tag: :class:`str` or ``None``
        :param event_tag: Event tag (optional)
...
class Associations(VapiInterface):
    ...
    def list(self,
        ...
        parameter. 
        This API is deprecated. Please use below policy API
        /infra/virtual-machine-group-associations?vm_external_id=<ext-id>
        /infra/virtual-network-interface-group-associations?vif_external_id=<ext-id>
        /infra/ip-address-group-associations?ip_address=10.1.19.10
        /infra/group-associations?intent_path=<intent-path> to get policy
        groups associated with the given resource.
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.Associations.list is deprecated.', DeprecationWarning)
        return self._invoke('list',
                            {
...
class Batch(VapiInterface):
    ...
    def create(self,
        ...
        :param atomic: Ignored (transactional atomicity flag) (optional, default to false)
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.Batch.create is deprecated.', DeprecationWarning)
...
class BridgeEndpoints(VapiInterface):
    ...
    def create(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.BridgeEndpoints.create is deprecated.', DeprecationWarning)
        return self._invoke('create',
                            {
    ...
    def delete(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.BridgeEndpoints.delete is deprecated.', DeprecationWarning)
        return self._invoke('delete',
                            {
    ...
    def update(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.BridgeEndpoints.update is deprecated.', DeprecationWarning)
        return self._invoke('update',
                            {
                            'bridgeendpoint_id': bridgeendpoint_id,
                            'bridge_endpoint': bridge_endpoint,
...
class EdgeClusters(VapiInterface):
    ...
    def relocateandremove(self,
                          edge_cluster_id,
                          edge_cluster_member_index,
                          ):
        """
        Relocate auto allocated service contexts from edge node at given index.
        For API to perform relocate and remove action the edge node at given
        index must only have auto allocated service contexts. If any manually
        allocated service context is present on the edge cluster member, then
        the task will not be performed. Also, it is recommended to move edge
        node for which relocate and remove action is being performed into
        maintenance mode, before executing the API. If edge is not not moved
        into maintenance mode, then API will move edge node into maintenance
        mode before performing the actual relocate and remove task.To maintain
        high availability, Edge cluster should have at least two healthy edge
        nodes for relocate and removal. Once relocate action is performed
        successfully, the edge node will be removed from the edge cluster.

        :type  edge_cluster_id: :class:`str`
        :param edge_cluster_id: (required)
        :type  edge_cluster_member_index: :class:`com.vmware.nsx.model_client.EdgeClusterMemberIndex`
        :param edge_cluster_member_index: (required)
        :raise: :class:`com.vmware.vapi.std.errors_client.InvalidRequest` 
            Bad Request, Precondition Failed
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized` 
            Forbidden
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        return self._invoke('relocateandremove',
                            {
                            'edge_cluster_id': edge_cluster_id,
...
class GlobalConfigs(VapiInterface):
    ...
    def get(self,
        ...
        """
        Returns global configurations that belong to the config type. This rest
        routine is deprecated, and will be removed after a year. 
        
        Use the following Policy APIs for different global configs - 
        OperationCollectorGlobalConfig GET
    ...
    def list(self):
        ...
        configurations. This rest routine is deprecated, and will be removed
        after a year. 
    ...
    def resyncconfig(self,
        ...
        push state. This rest routine is deprecated, and will be removed after
        a year. 
        
        Use the following Policy APIs for different global configs - 
        OperationCollectorGlobalConfig PUT
        /policy/api/v1/infra/ops-global-config 
        ...
        SwitchingGlobalConfig PUT
        /policy/api/v1/infra/connectivity-global-config 
        FirewallGlobalConfig PUT
    ...
    def update(self,
        ...
        must include the updated values along with the unmodified values. The
        values that are updated(different) would trigger update to config-type
        specific state. However, the realization of the new configurations is
        config-type specific. Refer to config-type specific documentation for
        details about the config- uration push state. This rest routine is
        deprecated, and will be removed after a year. 
...
class HostSwitchProfiles(VapiInterface):
    ...
    """
    LIST_HOSTSWITCH_PROFILE_TYPE_VTEPHAHOSTSWITCHPROFILE = "VtepHAHostSwitchProfile"
    """
    Possible value for ``hostswitchProfileType`` of method
    :func:`HostSwitchProfiles.list`.

    """
    LIST_HOSTSWITCH_PROFILE_TYPE_HIGHPERFORMANCEHOSTSWITCHPROFILE = "HighPerformanceHostSwitchProfile"
    """
    Possible value for ``hostswitchProfileType`` of method
    :func:`HostSwitchProfiles.list`.
    ...
    def create(self,
        ...
        This api is now deprecated. Please use new api - PUT
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.HostSwitchProfiles.create is deprecated.', DeprecationWarning)
        return self._invoke('create',
                            {
    ...
    def delete(self,
        ...
        This api is now deprecated. Please use new api - DELETE
        policy/api/v1/infra/host-switch-profiles/uplinkProfile1
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.HostSwitchProfiles.delete is deprecated.', DeprecationWarning)
        return self._invoke('delete',
                            {
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.HostSwitchProfiles.get is deprecated.', DeprecationWarning)
        return self._invoke('get',
                            {
                            'host_switch_profile_id': host_switch_profile_id,
                            })
    ...
    def list(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.HostSwitchProfiles.list is deprecated.', DeprecationWarning)
        return self._invoke('list',
                            {
                            'cursor': cursor,
    ...
    def update(self,
        ...
        This api is now deprecated. Please use new api - PATCH
        policy/api/v1/infra/host-switch-profiles/uplinkProfile1
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.HostSwitchProfiles.update is deprecated.', DeprecationWarning)
        return self._invoke('update',
                            {
                            'host_switch_profile_id': host_switch_profile_id,
                            'base_host_switch_profile': base_host_switch_profile,
...
class IpSets(VapiInterface):
    ...
    def create(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.IpSets.create is deprecated.', DeprecationWarning)
        return self._invoke('create',
                            {
                            'ip_set': ip_set,
                            })
    ...
    def create_0(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.IpSets.create_0 is deprecated.', DeprecationWarning)
    ...
    def delete(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.IpSets.delete is deprecated.', DeprecationWarning)
        return self._invoke('delete',
                            {
                            'ip_set_id': ip_set_id,
                            'force': force,
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.IpSets.get is deprecated.', DeprecationWarning)
        return self._invoke('get',
                            {
                            'ip_set_id': ip_set_id,
                            })
    ...
    def list(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.IpSets.list is deprecated.', DeprecationWarning)
        return self._invoke('list',
                            {
                            'cursor': cursor,
                            'included_fields': included_fields,
    ...
    def update(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.IpSets.update is deprecated.', DeprecationWarning)
        return self._invoke('update',
                            {
                            'ip_set_id': ip_set_id,
                            'ip_set': ip_set,
...
class IpfixCollectorProfiles(VapiInterface):
    ...
    def create(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.IpfixCollectorProfiles.create is deprecated.', DeprecationWarning)
        return self._invoke('create',
                            {
    ...
    def delete(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.IpfixCollectorProfiles.delete is deprecated.', DeprecationWarning)
        return self._invoke('delete',
                            {
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.IpfixCollectorProfiles.get is deprecated.', DeprecationWarning)
        return self._invoke('get',
                            {
                            'ipfix_collector_profile_id': ipfix_collector_profile_id,
                            })
    ...
    def list(self,
        ...
        /infra/ipfix-l2-collector-profiles instead.
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.IpfixCollectorProfiles.list is deprecated.', DeprecationWarning)
        return self._invoke('list',
                            {
                            'cursor': cursor,
                            'included_fields': included_fields,
    ...
    def update(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.IpfixCollectorProfiles.update is deprecated.', DeprecationWarning)
        return self._invoke('update',
                            {
                            'ipfix_collector_profile_id': ipfix_collector_profile_id,
                            'ipfix_collector_upm_profile': ipfix_collector_upm_profile,
...
class IpfixProfiles(VapiInterface):
    ...
    def create(self,
        ...
        This API is deprecated. Please use Policy API /infra/ipfix-l2-profiles
        instead.
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.IpfixProfiles.create is deprecated.', DeprecationWarning)
        return self._invoke('create',
                            {
    ...
    def delete(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.IpfixProfiles.delete is deprecated.', DeprecationWarning)
        return self._invoke('delete',
                            {
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.IpfixProfiles.get is deprecated.', DeprecationWarning)
        return self._invoke('get',
                            {
                            'ipfix_profile_id': ipfix_profile_id,
                            })
    ...
    def list(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.IpfixProfiles.list is deprecated.', DeprecationWarning)
        return self._invoke('list',
                            {
    ...
    def update(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.IpfixProfiles.update is deprecated.', DeprecationWarning)
        return self._invoke('update',
                            {
                            'ipfix_profile_id': ipfix_profile_id,
                            'ipfix_upm_profile': ipfix_upm_profile,
...
class LatencyProfiles(VapiInterface):
    ...
    def create(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.LatencyProfiles.create is deprecated.', DeprecationWarning)
        return self._invoke('create',
                            {
    ...
    def delete(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.LatencyProfiles.delete is deprecated.', DeprecationWarning)
        return self._invoke('delete',
                            {
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.LatencyProfiles.get is deprecated.', DeprecationWarning)
        return self._invoke('get',
                            {
                            'latency_profile_id': latency_profile_id,
                            })
    ...
    def list(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.LatencyProfiles.list is deprecated.', DeprecationWarning)
        return self._invoke('list',
                            {
                            'cursor': cursor,
                            'included_fields': included_fields,
    ...
    def update(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.LatencyProfiles.update is deprecated.', DeprecationWarning)
        return self._invoke('update',
                            {
                            'latency_profile_id': latency_profile_id,
                            'latency_stat_profile': latency_stat_profile,
...
class Licenses(VapiInterface):
    ...
    def delete(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.Licenses.delete is deprecated.', DeprecationWarning)
        return self._invoke('delete',
                            {
    ...
    def get(self):
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.Licenses.get is deprecated.', DeprecationWarning)
        return self._invoke('get', None)
    ...
    def getlicensebykey(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.Licenses.getlicensebykey is deprecated.', DeprecationWarning)
    ...
    def update(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.Licenses.update is deprecated.', DeprecationWarning)
        return self._invoke('update',
                            {
                            'license': license,
                            })
class Livetraces(VapiInterface):
    ...
    def create(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.Livetraces.create is deprecated.', DeprecationWarning)
        return self._invoke('create',
                            {
    ...
    def delete(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.Livetraces.delete is deprecated.', DeprecationWarning)
        return self._invoke('delete',
                            {
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.Livetraces.get is deprecated.', DeprecationWarning)
        return self._invoke('get',
                            {
                            'livetrace_session_id': livetrace_session_id,
                            })
    ...
    def list(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.Livetraces.list is deprecated.', DeprecationWarning)
        return self._invoke('list',
                            {
                            'cursor': cursor,
                            'included_fields': included_fields,
...
class LogicalPorts(VapiInterface):
    ...
    def create(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.LogicalPorts.create is deprecated.', DeprecationWarning)
        return self._invoke('create',
                            {
    ...
    def delete(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.LogicalPorts.delete is deprecated.', DeprecationWarning)
        return self._invoke('delete',
                            {
                            'lport_id': lport_id,
                            'detach': detach,
    ...
    def get(self,
        ...
        Please use corresponding policy API
        /infra/segments/<segment-id>/ports/<lport-id>
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.LogicalPorts.get is deprecated.', DeprecationWarning)
        return self._invoke('get',
                            {
                            'lport_id': lport_id,
                            })
    ...
    def list(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.LogicalPorts.list is deprecated.', DeprecationWarning)
        return self._invoke('list',
                            {
    ...
    def update(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.LogicalPorts.update is deprecated.', DeprecationWarning)
        return self._invoke('update',
                            {
                            'lport_id': lport_id,
                            'logical_port': logical_port,
...
class LogicalRouterPorts(VapiInterface):
    ...
    """
    LIST_RESOURCE_TYPE_LOGICALROUTERGRETUNNELPORT = "LogicalRouterGreTunnelPort"
    """
    Possible value for ``resourceType`` of method :func:`LogicalRouterPorts.list`.
    ...
    def create(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.LogicalRouterPorts.create is deprecated.', DeprecationWarning)
        return self._invoke('create',
                            {
    ...
    def delete(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.LogicalRouterPorts.delete is deprecated.', DeprecationWarning)
        return self._invoke('delete',
                            {
    ...
    def get(self,
        ...
        GET
        /policy/api/v1/infra/tier-1s/<tier-1-id>/locale-services/<locale-service-id>/interfaces/<interface-id>
        GET /policy/api/v1/infra/tier-1s/<tier-1-id>/segments/<segment-id> for
        DOWNLINK 
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.LogicalRouterPorts.get is deprecated.', DeprecationWarning)
        return self._invoke('get',
                            {
                            'logical_router_port_id': logical_router_port_id,
                            })
    ...
    def list(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.LogicalRouterPorts.list is deprecated.', DeprecationWarning)
        return self._invoke('list',
                            {
                            'cursor': cursor,
                            'included_fields': included_fields,
    ...
    def update(self,
        ...
        PUT
        /policy/api/v1/infra/tier-1s/<tier-1-id>/locale-services/<locale-service-id>/interfaces/<interface-id>
        PUT /policy/api/v1/infra/tier-1s/<tier-1-id>/segments/<segment-id> for
        DOWNLINK 
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.LogicalRouterPorts.update is deprecated.', DeprecationWarning)
        return self._invoke('update',
                            {
                            'logical_router_port_id': logical_router_port_id,
                            'logical_router_port': logical_router_port,
...
class LogicalRouters(VapiInterface):
    ...
    def create(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.LogicalRouters.create is deprecated.', DeprecationWarning)
        return self._invoke('create',
                            {
    ...
    def delete(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.LogicalRouters.delete is deprecated.', DeprecationWarning)
        return self._invoke('delete',
                            {
                            'logical_router_id': logical_router_id,
                            'cascade_delete_linked_ports': cascade_delete_linked_ports,
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.LogicalRouters.get is deprecated.', DeprecationWarning)
        return self._invoke('get',
                            {
                            'logical_router_id': logical_router_id,
                            })
    ...
    def list(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.LogicalRouters.list is deprecated.', DeprecationWarning)
        return self._invoke('list',
                            {
                            'cursor': cursor,
                            'included_fields': included_fields,
    ...
    def reallocate(self,
        ...
        In policy there will be no equivalent API but it will be achieved
        automatically when you will change edge cluster or will remove edge
        nodes from tier1 locale service
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.LogicalRouters.reallocate is deprecated.', DeprecationWarning)
    ...
    def reprocess(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.LogicalRouters.reprocess is deprecated.', DeprecationWarning)
    ...
    def update(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.LogicalRouters.update is deprecated.', DeprecationWarning)
        return self._invoke('update',
                            {
                            'logical_router_id': logical_router_id,
                            'logical_router': logical_router,
...
class LogicalSwitches(VapiInterface):
    ...
    """
    LIST_SWITCH_TYPE_DEFAULT = "DEFAULT"
    """
    Possible value for ``switchType`` of method :func:`LogicalSwitches.list`.

    """
    LIST_SWITCH_TYPE_SERVICE_PLANE = "SERVICE_PLANE"
    """
    Possible value for ``switchType`` of method :func:`LogicalSwitches.list`.

    """
    LIST_SWITCH_TYPE_DHCP_RELAY = "DHCP_RELAY"
    """
    Possible value for ``switchType`` of method :func:`LogicalSwitches.list`.

    """
    LIST_SWITCH_TYPE_GLOBAL = "GLOBAL"
    """
    Possible value for ``switchType`` of method :func:`LogicalSwitches.list`.

    """
    LIST_SWITCH_TYPE_INTER_ROUTER = "INTER_ROUTER"
    """
    Possible value for ``switchType`` of method :func:`LogicalSwitches.list`.

    """
    LIST_SWITCH_TYPE_EVPN = "EVPN"
    """
    Possible value for ``switchType`` of method :func:`LogicalSwitches.list`.

    """
    LIST_SWITCH_TYPE_DVPG = "DVPG"
    """
    Possible value for ``switchType`` of method :func:`LogicalSwitches.list`.
    ...
    def create(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.LogicalSwitches.create is deprecated.', DeprecationWarning)
        return self._invoke('create',
                            {
    ...
    def delete(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.LogicalSwitches.delete is deprecated.', DeprecationWarning)
        return self._invoke('delete',
                            {
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.LogicalSwitches.get is deprecated.', DeprecationWarning)
        return self._invoke('get',
                            {
                            'lswitch_id': lswitch_id,
                            })
    ...
    def list(self,
        ...
        :type  sort_by: :class:`str` or ``None``
        :param sort_by: Field by which records are sorted (optional)
        :type  switch_type: :class:`str` or ``None``
        :param switch_type: Logical Switch type (optional)
        :type  switching_profile_id: :class:`str` or ``None``
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.LogicalSwitches.list is deprecated.', DeprecationWarning)
        return self._invoke('list',
                            {
                            'cursor': cursor,
                            'diagnostic': diagnostic,
    ...
    def update(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.LogicalSwitches.update is deprecated.', DeprecationWarning)
        return self._invoke('update',
                            {
                            'lswitch_id': lswitch_id,
                            'logical_switch': logical_switch,
...
class MacSets(VapiInterface):
    ...
    def create(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.MacSets.create is deprecated.', DeprecationWarning)
        return self._invoke('create',
                            {
                            'm_ac_set': m_ac_set,
                            })
    ...
    def delete(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.MacSets.delete is deprecated.', DeprecationWarning)
        return self._invoke('delete',
                            {
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.MacSets.get is deprecated.', DeprecationWarning)
        return self._invoke('get',
                            {
                            'mac_set_id': mac_set_id,
                            })
    ...
    def list(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.MacSets.list is deprecated.', DeprecationWarning)
        return self._invoke('list',
                            {
                            'cursor': cursor,
                            'included_fields': included_fields,
    ...
    def update(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.MacSets.update is deprecated.', DeprecationWarning)
        return self._invoke('update',
                            {
                            'mac_set_id': mac_set_id,
                            'm_ac_set': m_ac_set,
                            })
class ManagementPlaneHealth(VapiInterface):
    """
    
    """

    _VAPI_SERVICE_ID = 'com.vmware.nsx.management_plane_health'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
        ...
        :param config: Configuration to be used for creating the stub.
        """
        VapiInterface.__init__(self, config, _ManagementPlaneHealthStub)
        self._VAPI_OPERATION_IDS = {}
...
class MdProxies(VapiInterface):
    ...
    def create(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.MdProxies.create is deprecated.', DeprecationWarning)
        return self._invoke('create',
                            {
    ...
    def delete(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.MdProxies.delete is deprecated.', DeprecationWarning)
        return self._invoke('delete',
                            {
                            'proxy_id': proxy_id,
                            })
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.MdProxies.get is deprecated.', DeprecationWarning)
        return self._invoke('get',
                            {
                            'proxy_id': proxy_id,
                            })
    ...
    def list(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.MdProxies.list is deprecated.', DeprecationWarning)
        return self._invoke('list',
                            {
                            'cursor': cursor,
                            'included_fields': included_fields,
    ...
    def update(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.MdProxies.update is deprecated.', DeprecationWarning)
        return self._invoke('update',
                            {
                            'proxy_id': proxy_id,
                            'metadata_proxy': metadata_proxy,
...
class MirrorSessions(VapiInterface):
    ...
    def create(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.MirrorSessions.create is deprecated.', DeprecationWarning)
        return self._invoke('create',
                            {
    ...
    def delete(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.MirrorSessions.delete is deprecated.', DeprecationWarning)
        return self._invoke('delete',
                            {
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.MirrorSessions.get is deprecated.', DeprecationWarning)
        return self._invoke('get',
                            {
                            'mirror_session_id': mirror_session_id,
                            })
    ...
    def update(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.MirrorSessions.update is deprecated.', DeprecationWarning)
        return self._invoke('update',
                            {
                            'mirror_session_id': mirror_session_id,
                            'port_mirroring_session': port_mirroring_session,
...
class Node(VapiInterface):
    ...
    def setcoredumpconfig(self,
                          core_dump_config,
                          ):
        """
        Update node configuration for core dump generation and rotation policy

        :type  core_dump_config: :class:`com.vmware.nsx.model_client.CoreDumpConfig`
        :param core_dump_config: (required)
        :raise: :class:`com.vmware.vapi.std.errors_client.InvalidRequest` 
            Bad Request, Precondition Failed
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized` 
            Forbidden
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        return self._invoke('setcoredumpconfig',
                            {
...
class Normalizations(VapiInterface):
    ...
    def list(self,
        ...
        This API has been deprecated, please use below effective membership
        APIs 
        ...
        /ns-groups/<ns-group-id>/effective-cloud-native-service-instance-members
        GET /ns-groups/<ns-group-id>/effective-physical-server-members GET
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.Normalizations.list is deprecated.', DeprecationWarning)
        return self._invoke('list',
                            {
...
class NsGroups(VapiInterface):
    ...
    def create(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.NsGroups.create is deprecated.', DeprecationWarning)
        return self._invoke('create',
                            {
                            'ns_group': ns_group,
                            })
    ...
    def delete(self,
        ...
        This API is deprecated. Please use below policy API
        /infra/domains/<domain-id>/groups/<group-id> to delete a group.
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.NsGroups.delete is deprecated.', DeprecationWarning)
        return self._invoke('delete',
                            {
                            'ns_group_id': ns_group_id,
                            'force': force,
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.NsGroups.get is deprecated.', DeprecationWarning)
        return self._invoke('get',
                            {
                            'ns_group_id': ns_group_id,
    ...
    def list(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.NsGroups.list is deprecated.', DeprecationWarning)
        return self._invoke('list',
                            {
                            'cursor': cursor,
                            'included_fields': included_fields,
    ...
    def update(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.NsGroups.update is deprecated.', DeprecationWarning)
        return self._invoke('update',
                            {
                            'ns_group_id': ns_group_id,
                            'ns_group': ns_group,
...
class NsProfiles(VapiInterface):
    ...
    def create(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.NsProfiles.create is deprecated.', DeprecationWarning)
        return self._invoke('create',
                            {
    ...
    def delete(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.NsProfiles.delete is deprecated.', DeprecationWarning)
        return self._invoke('delete',
                            {
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.NsProfiles.get is deprecated.', DeprecationWarning)
        return self._invoke('get',
                            {
                            'ns_profile_id': ns_profile_id,
                            })
    ...
    def list(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.NsProfiles.list is deprecated.', DeprecationWarning)
        return self._invoke('list',
                            {
    ...
    def update(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.NsProfiles.update is deprecated.', DeprecationWarning)
        return self._invoke('update',
                            {
                            'ns_profile_id': ns_profile_id,
                            'ns_profile': ns_profile,
...
class NsServiceGroups(VapiInterface):
    ...
    def create(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.NsServiceGroups.create is deprecated.', DeprecationWarning)
        return self._invoke('create',
                            {
    ...
    def delete(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.NsServiceGroups.delete is deprecated.', DeprecationWarning)
        return self._invoke('delete',
                            {
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.NsServiceGroups.get is deprecated.', DeprecationWarning)
        return self._invoke('get',
                            {
                            'ns_service_group_id': ns_service_group_id,
                            })
    ...
    def list(self,
        ...
        This API is deprecated. Please use policy API /infra/services to fetch
        all services.
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.NsServiceGroups.list is deprecated.', DeprecationWarning)
        return self._invoke('list',
                            {
                            'cursor': cursor,
    ...
    def update(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.NsServiceGroups.update is deprecated.', DeprecationWarning)
        return self._invoke('update',
                            {
                            'ns_service_group_id': ns_service_group_id,
                            'ns_service_group': ns_service_group,
...
class NsServices(VapiInterface):
    ...
    def create(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.NsServices.create is deprecated.', DeprecationWarning)
        return self._invoke('create',
                            {
    ...
    def delete(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.NsServices.delete is deprecated.', DeprecationWarning)
        return self._invoke('delete',
                            {
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.NsServices.get is deprecated.', DeprecationWarning)
        return self._invoke('get',
                            {
                            'ns_service_id': ns_service_id,
                            })
    ...
    def list(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.NsServices.list is deprecated.', DeprecationWarning)
        return self._invoke('list',
                            {
                            'cursor': cursor,
                            'default_service': default_service,
    ...
    def update(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.NsServices.update is deprecated.', DeprecationWarning)
        return self._invoke('update',
                            {
                            'ns_service_id': ns_service_id,
                            'ns_service': ns_service,
...
class NvdsUrt(VapiInterface):
    ...
    def cleanup(self):
        ...
        requested. This will clean up precheck configuration, vds topology from
        last request.
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.NvdsUrt.cleanup is deprecated.', DeprecationWarning)
    ...
    def ignoremigratestatus(self):
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.NvdsUrt.ignoremigratestatus is deprecated.', DeprecationWarning)
...
class ServiceConfigs(VapiInterface):
    ...
    def create(self,
        ...
        Please use APIs in the Policy section corresponding to the profile type
        - IPFIX_SWITCH_PROFILE - Policy > Monitoring > IPFIX > Switch IPFIX
        Profiles IPFIX_COLLECTOR_PROFILE - Policy > Monitoring > IPFIX > Switch
        IPFIX Collectors DFW_CPU_MEM_THRESHOLDS_PROFILE - Policy > Security >
        Security Profiles > Cpu Memory Thresholds Profiles
        DFW_SESSIONTIMER_PROFILE - Policy > Security > Security Profiles > DNS
        Security Profiles GI_SERVICE_PROFILE - Policy > Security > Service
        Insertion > Service References DFW_FLOOD_PROTECTION_PROFILE - Policy >
        Security > Security Profiles > Flood Protection Profiles
        GENERAL_SECURITY_SETTINGS_PROFILE - Policy > Security > Security
        Profiles > General Security Profiles DFW_DNS_PROFILE - Policy >
        Security > Security Profiles > DNS Security Profiles
        PACE_HOST_CONFIG_PROFILE SHA_PROFILE - Policy > Monitoring > System
        Health Agent LATENCY_STAT_PROFILE - Policy > Monitoring > Latency
        IP_DISCOVERY_SWITCHING_UPM_PROFILE - Policy > Networking > Connectivity
        > Segments > Segment Profiles > IP Discovery Profiles
        SYSTEM_HEALTH_PLUGIN_PROFILE - Policy > Monitoring > System Health
        Agent COMMON_AGENT_HOST_CONFIG_PROFILE ODS_PROFILE - Policy >
        Monitoring > Online Diagnostic System ODS_DYNAMIC_INSTANCE - Policy >
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.ServiceConfigs.create is deprecated.', DeprecationWarning)
        return self._invoke('create',
                            {
    ...
    def delete(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.ServiceConfigs.delete is deprecated.', DeprecationWarning)
        return self._invoke('delete',
                            {
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.ServiceConfigs.get is deprecated.', DeprecationWarning)
        return self._invoke('get',
                            {
                            'config_set_id': config_set_id,
                            })
    ...
    def list(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.ServiceConfigs.list is deprecated.', DeprecationWarning)
        return self._invoke('list',
                            {
                            'cursor': cursor,
                            'included_fields': included_fields,
    ...
    def update(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.ServiceConfigs.update is deprecated.', DeprecationWarning)
        return self._invoke('update',
                            {
                            'config_set_id': config_set_id,
                            'service_config': service_config,
...
class Sites(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx.sites'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    def get(self):
        ...
        :rtype: :class:`com.vmware.nsx.model_client.FederationConfiguration`
    ...
    def get_0(self):
        """
        Get the site configuration, some attributes won't be shown based on
        version
    ...
    def get_1(self):
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        return self._invoke('get_1', None)
    ...
    def get_2(self):
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        return self._invoke('get_2', None)
class SwitchingProfiles(VapiInterface):
    ...
    def create(self,
        ...
        This api is now deprecated. Please use new api - For eg. for QOS
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.SwitchingProfiles.create is deprecated.', DeprecationWarning)
        return self._invoke('create',
                            {
    ...
    def delete(self,
        ...
        This api is now deprecated. Use new api - for QOS profile, please use -
        DELETE /infra/qos-profiles/<qos-profile-id>
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.SwitchingProfiles.delete is deprecated.', DeprecationWarning)
        return self._invoke('delete',
                            {
                            'switching_profile_id': switching_profile_id,
                            'unbind': unbind,
    ...
    def get(self,
        ...
        This api is now deprecated. Please use new api - for QOS profile,
        please use - /infra/qos-profiles/<qos-profile-id>
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.SwitchingProfiles.get is deprecated.', DeprecationWarning)
        return self._invoke('get',
                            {
                            'switching_profile_id': switching_profile_id,
                            })
    ...
    def list(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.SwitchingProfiles.list is deprecated.', DeprecationWarning)
        return self._invoke('list',
                            {
                            'cursor': cursor,
                            'include_system_owned': include_system_owned,
    ...
    def update(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.SwitchingProfiles.update is deprecated.', DeprecationWarning)
        return self._invoke('update',
                            {
                            'switching_profile_id': switching_profile_id,
                            'base_switching_profile': base_switching_profile,
...
class Traceflows(VapiInterface):
    ...
    def create(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.Traceflows.create is deprecated.', DeprecationWarning)
        return self._invoke('create',
                            {
    ...
    def delete(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.Traceflows.delete is deprecated.', DeprecationWarning)
        return self._invoke('delete',
                            {
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.Traceflows.get is deprecated.', DeprecationWarning)
        return self._invoke('get',
                            {
                            'traceflow_id': traceflow_id,
                            })
    ...
    def list(self,
        ...
        This API is deprecated. Please use policy API /infra/traceflows to list
        all traceflows.
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.Traceflows.list is deprecated.', DeprecationWarning)
        return self._invoke('list',
                            {
                            'cursor': cursor,
                            'included_fields': included_fields,
...
class TransportNodeProfiles(VapiInterface):
    ...
    def create(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.TransportNodeProfiles.create is deprecated.', DeprecationWarning)
        return self._invoke('create',
                            {
    ...
    def delete(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.TransportNodeProfiles.delete is deprecated.', DeprecationWarning)
        return self._invoke('delete',
                            {
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.TransportNodeProfiles.get is deprecated.', DeprecationWarning)
        return self._invoke('get',
                            {
                            'transport_node_profile_id': transport_node_profile_id,
                            })
    ...
    def list(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.TransportNodeProfiles.list is deprecated.', DeprecationWarning)
        return self._invoke('list',
                            {
                            'cursor': cursor,
                            'included_fields': included_fields,
    ...
    def update(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.TransportNodeProfiles.update is deprecated.', DeprecationWarning)
        return self._invoke('update',
                            {
                            'transport_node_profile_id': transport_node_profile_id,
                            'transport_node_profile': transport_node_profile,
...
class TransportNodes(VapiInterface):
    ...
    def addorupdateplacementreferences(self,
                                       node_id,
                                       transport_node_placement_config,
                                       ):
        """
        ...
        :type  node_id: :class:`str`
        :param node_id: (required)
        :type  transport_node_placement_config: :class:`com.vmware.nsx.model_client.TransportNodePlacementConfig`
        :param transport_node_placement_config: (required)
        :raise: :class:`com.vmware.vapi.std.errors_client.InvalidRequest` 
            Bad Request, Precondition Failed
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized` 
            Forbidden
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        return self._invoke('addorupdateplacementreferences',
                            {
                            'node_id': node_id,
                            'transport_node_placement_config': transport_node_placement_config,
                            })

    def cleanstaleentries(self):
        """
        Edge transport node maintains its entry in many internal tables. In
        some cases a few of these entries might not get cleaned up during edge
        transport node deletion. This api cleans up any stale entries that may
        exist in the internal tables that store the Edge Transport Node data.
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        return self._invoke('cleanstaleentries', None)
    ...
    def create(self,
        ...
        node, NSX Manager always configures the host switch. To preconfigure
        the host switches on a KVM host, pass an array of
        PreconfiguredHostSwitchSpec objects that describes those host switches.
        In the current NSX-T release, only one prefonfigured host switch can be
        specified. See the PreconfiguredHostSwitchSpec schema definition for
        documentation on the properties that must be provided. Preconfigured
        host switches are only supported on KVM hosts, not on ESXi hosts or NSX
        Edge nodes. To allow NSX to manage the host switch configuration on KVM
        hosts, ESXi hosts, or NSX Edge nodes, pass an array of
        ...
        for documentation on the properties that must be provided. Note:
        Previous versions of NSX-T also used a property named
        transport_zone_endpoints at TransportNode level. This property is
        deprecated which creates some combinations of new client along with old
        client payloads. Examples [1] & [2] show old/existing client request
        and response by populating transport_zone_endpoints property at
        TransportNode level. Example [3] shows TransportNode creation
        request/response by populating transport_zone_endpoints property at
        StandardHostSwitch level and other new properties. The request should
        either provide node_deployement_info or node_id. If the host node
        (hypervisor) or edge node (router) is already added in system then it
        can be converted to transport node by providing node_id in request. If
        host node (hypervisor) or edge node (router) is not already present in
    ...
    def delete(self,
        ...
        gateway nodes is not supported. Force delete is not supported if
        transport node is part of a cluster on which Transport node profile is
        applied. If transport node delete is called with query param force not
        being set or set to false and uninstall of NSX components in the host
        fails, TransportNodeState object will be retained. If transport node
        delete is called with query param force set to true and uninstall of
        NSX components in the host fails, TransportNodeState object will be
        deleted. It also removes the specified node (host or edge) from system.
    ...
    def redeploy(self,
        ...
        identifier <node-id>. If NSX Manager can access the specified edge
        node, then the node is put into maintenance mode and then the
        associated VM is deleted. This is a means to reset all configuration on
        the edge node. The communication channel between NSX Manager and edge
        is established after this operation.
    ...
    def refreshnodeconfiguration(self,
        ...
        configuration and find a discrepancy in Edge configuration at NSX
        Manager in compare with realized, then use this API to refresh
        configuration at NSX Manager. It refreshes the Edge configuration from
        sources external to NSX Manager like vSphere Server or the Edge node
        CLI. After this action, Edge configuration at NSX Manager is updated
        and the API GET api/v1/transport-nodes will show refreshed data. From
        3.2 release onwards, refresh API updates the MP intent by default.

        :type  transport_node_id: :class:`str`
        :param transport_node_id: (required)
        :type  read_only: :class:`bool` or ``None``
        :param read_only: Read-only flag for Refresh API (optional, default to false)
        :raise: :class:`com.vmware.vapi.std.errors_client.InvalidRequest` 
            Bad Request, Precondition Failed
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized` 
            Forbidden
    ...
    def restoreclusterconfig(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.TransportNodes.restoreclusterconfig is deprecated.', DeprecationWarning)
...
class TransportZones(VapiInterface):
    ...
    def create(self,
        ...
        """
        Creates a new transport zone. The required parameters is transport_type
        (OVERLAY or VLAN). The optional parameters are description and
        display_name. 
        This api is now deprecated. Please use new api - PUT
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.TransportZones.create is deprecated.', DeprecationWarning)
        return self._invoke('create',
                            {
    ...
    def delete(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.TransportZones.delete is deprecated.', DeprecationWarning)
        return self._invoke('delete',
                            {
                            'zone_id': zone_id,
                            })
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.TransportZones.get is deprecated.', DeprecationWarning)
        return self._invoke('get',
                            {
                            'zone_id': zone_id,
                            })
    ...
    def list(self,
        ...
        :param display_name: The transport zone's display name (optional)
        :type  include_system_owned: :class:`bool` or ``None``
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.TransportZones.list is deprecated.', DeprecationWarning)
        return self._invoke('list',
                            {
                            'cursor': cursor,
    ...
    def update(self,
        ...
        is_default, description, and display_name. 
        This api is now deprecated. Use new api - PATCH
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.TransportZones.update is deprecated.', DeprecationWarning)
        return self._invoke('update',
                            {
                            'zone_id': zone_id,
                            'transport_zone': transport_zone,
...
class TransportzoneProfiles(VapiInterface):
    ...
    def create(self,
        ...
        This api is now deprecated. Please use new api - PUT
        /policy/api/v1/infra/transport-zone-profiles/<tz-profile>
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.TransportzoneProfiles.create is deprecated.', DeprecationWarning)
        return self._invoke('create',
                            {
    ...
    def delete(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.TransportzoneProfiles.delete is deprecated.', DeprecationWarning)
        return self._invoke('delete',
                            {
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.TransportzoneProfiles.get is deprecated.', DeprecationWarning)
        return self._invoke('get',
                            {
                            'transportzone_profile_id': transportzone_profile_id,
                            })
    ...
    def list(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.TransportzoneProfiles.list is deprecated.', DeprecationWarning)
        return self._invoke('list',
                            {
                            'cursor': cursor,
                            'include_system_owned': include_system_owned,
    ...
    def update(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.TransportzoneProfiles.update is deprecated.', DeprecationWarning)
        return self._invoke('update',
                            {
                            'transportzone_profile_id': transportzone_profile_id,
                            'transport_zone_profile': transport_zone_profile,
...
class Watermark(VapiInterface):
    """
    
    """

    _VAPI_SERVICE_ID = 'com.vmware.nsx.watermark'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
        ...
        :param config: Configuration to be used for creating the stub.
        """
        VapiInterface.__init__(self, config, _WatermarkStub)
        self._VAPI_OPERATION_IDS = {}


    def create(self,
               n_sx_manager_deployment_info,
               ):
        """
        This is an API called by VCF to store or update deployment information.

        :type  n_sx_manager_deployment_info: :class:`com.vmware.nsx.model_client.NSXManagerDeploymentInfo`
        :param n_sx_manager_deployment_info: (required)
        :rtype: :class:`com.vmware.nsx.model_client.NSXManagerDeploymentInfo`
        ...
        return self._invoke('create',
                            {
                            'n_sx_manager_deployment_info': n_sx_manager_deployment_info,
                            })
...
class _AlarmsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_input_type = type.StructType('operation-input', {
            ...
            'event_tag': type.OptionalType(type.StringType()),
            ...
            'org': type.OptionalType(type.StringType()),
            'page_size': type.OptionalType(type.IntegerType()),
            'project': type.OptionalType(type.StringType()),
...
class _EdgeClustersStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        # properties for relocateandremove operation
        relocateandremove_input_type = type.StructType('operation-input', {
            'edge_cluster_id': type.StringType(),
            'edge_cluster_member_index': type.ReferenceType('com.vmware.nsx.model_client', 'EdgeClusterMemberIndex'),
        })
        relocateandremove_error_dict = {
            'com.vmware.vapi.std.errors.invalid_request':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidRequest'),
            'com.vmware.vapi.std.errors.unauthorized':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'),
        ...
        relocateandremove_input_value_validator_list = [
        ]
        relocateandremove_output_validator_list = [
        ]
        relocateandremove_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/api/v1/edge-clusters/{edge-cluster-id}?action=relocate_and_remove',
            request_body_parameter='edge_cluster_member_index',
            path_variables={
                'edge_cluster_id': 'edge-cluster-id',
            },
             header_parameters={
        ...
        operations = {
            ...
            'relocateandremove': {
                'input_type': relocateandremove_input_type,
                'output_type': type.VoidType(),
                'errors': relocateandremove_error_dict,
                'input_value_validator_list': relocateandremove_input_value_validator_list,
                'output_validator_list': relocateandremove_output_validator_list,
                'task_type': TaskType.NONE,
            },
        ...
        rest_metadata = {
            ...
            'get': get_rest_metadata,
            'list': list_rest_metadata,
            'relocateandremove': relocateandremove_rest_metadata,
...
class _LogicalSwitchesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_input_type = type.StructType('operation-input', {
            ...
            'sort_ascending': type.OptionalType(type.BooleanType()),
            'sort_by': type.OptionalType(type.StringType()),
            'switch_type': type.OptionalType(type.StringType()),
            'switching_profile_id': type.OptionalType(type.StringType()),
...
class _ManagementPlaneHealthStub(ApiInterfaceStub):
    def __init__(self, config):
        # properties for get operation
        get_input_type = type.StructType('operation-input', {})
        get_error_dict = {
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/api/v1/management-plane-health',
            path_variables={
            },
             header_parameters={
             },
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx.management_plane_health',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class _NodeStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        # properties for setcoredumpconfig operation
        setcoredumpconfig_input_type = type.StructType('operation-input', {
            'core_dump_config': type.ReferenceType('com.vmware.nsx.model_client', 'CoreDumpConfig'),
        })
        setcoredumpconfig_error_dict = {
            'com.vmware.vapi.std.errors.invalid_request':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidRequest'),
            'com.vmware.vapi.std.errors.unauthorized':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'),
        ...
        setcoredumpconfig_input_value_validator_list = [
        ]
        setcoredumpconfig_output_validator_list = [
        ]
        setcoredumpconfig_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/api/v1/node?action=set_coredump_config',
            request_body_parameter='core_dump_config',
            path_variables={
            },
             header_parameters={
               },
        ...
        operations = {
            ...
            'setcoredumpconfig': {
                'input_type': setcoredumpconfig_input_type,
                'output_type': type.VoidType(),
                'errors': setcoredumpconfig_error_dict,
                'input_value_validator_list': setcoredumpconfig_input_value_validator_list,
                'output_validator_list': setcoredumpconfig_output_validator_list,
                'task_type': TaskType.NONE,
            },
            'setsystemtime': {
        ...
        rest_metadata = {
            ...
            'setcoredumpconfig': setcoredumpconfig_rest_metadata,
...
class _SitesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_0_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/api/v1/sites?version=3.0.2',
            path_variables={
            },
             header_parameters={
             },
        ...
        get_1_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/api/v1/sites?version=3.1.0',
            path_variables={
            },
             header_parameters={
             },
        ...
        # properties for get_2 operation
        get_2_input_type = type.StructType('operation-input', {})
        get_2_error_dict = {
            'com.vmware.vapi.std.errors.invalid_request':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidRequest'),
            'com.vmware.vapi.std.errors.unauthorized':
        ...
        get_2_input_value_validator_list = [
        ]
        get_2_output_validator_list = [
        ]
        get_2_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/api/v1/sites?version=latest',
            path_variables={
            },
             header_parameters={
             },
        ...
        operations = {
            'get': {
                'input_type': get_input_type,
                'output_type': type.ReferenceType('com.vmware.nsx.model_client', 'FederationConfiguration'),
                'errors': get_error_dict,
                'input_value_validator_list': get_input_value_validator_list,
                'output_validator_list': get_output_validator_list,
                'task_type': TaskType.NONE,
            ...
            'get_2': {
                'input_type': get_2_input_type,
                'output_type': type.ReferenceType('com.vmware.nsx.model_client', 'FederationConfiguration'),
                'errors': get_2_error_dict,
                'input_value_validator_list': get_2_input_value_validator_list,
                'output_validator_list': get_2_output_validator_list,
                'task_type': TaskType.NONE,
            },
        }
        rest_metadata = {
            ...
            'get_0': get_0_rest_metadata,
            'get_1': get_1_rest_metadata,
            'get_2': get_2_rest_metadata,
        }
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx.sites',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class _TransportNodesStub(ApiInterfaceStub):
    def __init__(self, config):
        # properties for addorupdateplacementreferences operation
        addorupdateplacementreferences_input_type = type.StructType('operation-input', {
            'node_id': type.StringType(),
            'transport_node_placement_config': type.ReferenceType('com.vmware.nsx.model_client', 'TransportNodePlacementConfig'),
        })
        addorupdateplacementreferences_error_dict = {
            'com.vmware.vapi.std.errors.invalid_request':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidRequest'),
            'com.vmware.vapi.std.errors.unauthorized':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'),
        ...
        addorupdateplacementreferences_input_value_validator_list = [
            HasFieldsOfValidator()
        ]
        addorupdateplacementreferences_output_validator_list = [
        ]
        addorupdateplacementreferences_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/api/v1/transport-nodes/{node-id}?action=addOrUpdatePlacementReferences',
            request_body_parameter='transport_node_placement_config',
            path_variables={
                'node_id': 'node-id',
            },
             header_parameters={
        ...
        # properties for cleanstaleentries operation
        cleanstaleentries_input_type = type.StructType('operation-input', {})
        cleanstaleentries_error_dict = {
            'com.vmware.vapi.std.errors.invalid_request':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidRequest'),
            'com.vmware.vapi.std.errors.unauthorized':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'),
        ...
        cleanstaleentries_input_value_validator_list = [
        ]
        cleanstaleentries_output_validator_list = [
        ]
        cleanstaleentries_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/api/v1/transport-nodes?action=clean_stale_entries',
            path_variables={
            },
             header_parameters={
             },
        ...
        operations = {
            'addorupdateplacementreferences': {
                'input_type': addorupdateplacementreferences_input_type,
                'output_type': type.VoidType(),
                'errors': addorupdateplacementreferences_error_dict,
                'input_value_validator_list': addorupdateplacementreferences_input_value_validator_list,
                'output_validator_list': addorupdateplacementreferences_output_validator_list,
                'task_type': TaskType.NONE,
            },
            'cleanstaleentries': {
                'input_type': cleanstaleentries_input_type,
                'output_type': type.VoidType(),
                'errors': cleanstaleentries_error_dict,
                'input_value_validator_list': cleanstaleentries_input_value_validator_list,
                'output_validator_list': cleanstaleentries_output_validator_list,
                'task_type': TaskType.NONE,
            },
            'create': {
                'input_type': create_input_type,
        ...
        rest_metadata = {
            'addorupdateplacementreferences': addorupdateplacementreferences_rest_metadata,
            'cleanstaleentries': cleanstaleentries_rest_metadata,
            'create': create_rest_metadata,
            'delete': delete_rest_metadata,
...
class _WatermarkStub(ApiInterfaceStub):
    def __init__(self, config):
        # properties for create operation
        create_input_type = type.StructType('operation-input', {
            'n_SX_manager_deployment_info': type.ReferenceType('com.vmware.nsx.model_client', 'NSXManagerDeploymentInfo'),
        })
        create_error_dict = {
            'com.vmware.vapi.std.errors.invalid_request':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidRequest'),
        ...
        create_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/api/v1/watermark',
            request_body_parameter='n_SX_manager_deployment_info',
            path_variables={
            },
             header_parameters={
               },
        ...
        operations = {
            'create': {
                'input_type': create_input_type,
                'output_type': type.ReferenceType('com.vmware.nsx.model_client', 'NSXManagerDeploymentInfo'),
                'errors': create_error_dict,
                'input_value_validator_list': create_input_value_validator_list,
                'output_validator_list': create_output_validator_list,
                'task_type': TaskType.NONE,
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx.watermark',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class StubFactory(StubFactoryBase):
    _attrs = {
        ...
        'malware_prevention': 'com.vmware.nsx.malware_prevention_client.StubFactory',
        ...
        'security': 'com.vmware.nsx.security_client.StubFactory',
        ...
        'sites': 'com.vmware.nsx.sites_client.StubFactory',
