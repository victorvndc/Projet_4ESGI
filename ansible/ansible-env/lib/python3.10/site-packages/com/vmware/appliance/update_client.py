...
class Summary(VapiStruct):
    ...
    def __init__(self,
        ...
        :type  name: :class:`str`
        :param name: Name of the update. This attribute was added in vSphere API 6.7.
        :type  description: :class:`com.vmware.vapi.std_client.LocalizableMessage`
        :param description: Description of the update. The short information what this update
            is. E.g. "Update2 for vCenter Server Appliance 6.5". This attribute
            was added in vSphere API 6.7.
...
class Pending(VapiInterface):
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param knowledge_base: URL for the knowledge base article describing this update. This
                attribute was added in vSphere API 6.7.
            :type  description: :class:`com.vmware.vapi.std_client.LocalizableMessage`
            :param description: Description of the update. The short information what this update
                is. E.g. "Update2 for vCenter Server Appliance 6.5". This attribute
    ...
    class UpgradeableComponent(VapiStruct):
        ...
        information. This class was added in vSphere API 8.0.0.1.
        ...
        def __init__(self,
            ...
            :param component: Name of the upgradeable component. Component is a service or a
                group of services providing asynchronous lifecycle. This attribute
                was added in vSphere API 8.0.0.1.
            :type  affected_services: :class:`list` of :class:`str`
            :param affected_services: List of services affected as part of the update. This attribute was
    ...
    def list(self,
        ...
        """
        Checks if there are any eligible updates. This method was added in
        vSphere API 6.7.
    ...
    def get(self,
        ...
        :param component: Name of the upgradeable component. This parameter was added in
            vSphere API 8.0.0.1.
    ...
    def list_upgradeable_components(self,
        ...
        individually without upgrading the whole vCenter to it. This method was
        added in vSphere API 8.0.0.1.
    ...
    def stage_and_install(self,
        ...
        :param user_data: map of user provided data with IDs
            ...
            ``com.vmware.applicance.update.pending.dataitem``.
        :type  component: :class:`str` or ``None``
        :param component: upgradeable component to be staged and installed. This parameter
            was added in vSphere API 8.0.0.1.
            This parameter is optional because it was added in a newer version
            than its parent node.
        :raise: :class:`com.vmware.vapi.std.errors_client.Error` 
    ...
    def rollback(self):
        ...
        **Caution:** This operation will perform a reboot of appliance.. This
        method was added in vSphere API 6.7.
...
class Staged(VapiInterface):
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :type  component: :class:`str` or ``None``
            :param component: Staged Component name. This attribute was added in vSphere API
                8.0.0.1.
