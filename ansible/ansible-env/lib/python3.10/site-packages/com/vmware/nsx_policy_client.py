...
class Batch(VapiInterface):
    ...
    def create(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx_policy.Batch.create is deprecated.', DeprecationWarning)
...
class GlobalInfra(VapiInterface):
    ...
    def patch(self,
        ...
        children of different types. System will resolve the dependencies of
...
class ManagementPlaneHealth(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.management_plane_health'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class OrgRoot(VapiInterface):
    """
    
    """

    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.org_root'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
        ...
        :param config: Configuration to be used for creating the stub.
        """
        VapiInterface.__init__(self, config, _OrgRootStub)
        self._VAPI_OPERATION_IDS = {}
    ...
    def get(self,
        ...
        """
        Read Org Root. Returns only the org root related properties. Inner
        object are not populated. For Hierarchical Get, base_path request
        ...
        :type  type_filter: :class:`str` or ``None``
        :param type_filter: Filter string to retrieve hierarchy. (optional)
        :rtype: :class:`com.vmware.nsx_policy.model_client.OrgRoot`
    ...
    def patch(self,
        ...
        hierarchy. Hierarchical API: Provides users a way to create entire or
        part of intent in single API invocation. Input is expressed in a tree
        format. Each node in tree can have multiple children of different
        types. System will resolve the dependecies of nodes within the intent
        tree and will create the model. Children for any node can be specified
        using ChildResourceReference or ChildPolicyConfigResource. If a
        resource is specified using ChildResourceReference then it will not be
        updated only its children will be updated. If Object is specified using
        ChildPolicyConfigResource, object along with its children will be
        updated. Hierarchical API can also be used to delete any sub-branch of
        entire tree.

        :type  org_root: :class:`com.vmware.nsx_policy.model_client.OrgRoot`
        :param org_root: (required)
        :type  enforce_revision_check: :class:`bool` or ``None``
        :param enforce_revision_check: Force revision check (optional, default to false)
        :raise: :class:`com.vmware.vapi.std.errors_client.InvalidRequest` 
            Bad Request, Precondition Failed
...
class Orgs(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.orgs'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    def get(self,
        ...
        :rtype: :class:`com.vmware.nsx_policy.model_client.Org`
    ...
    def list(self,
        ...
        :rtype: :class:`com.vmware.nsx_policy.model_client.OrgListResult`
...
class Watermark(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.watermark'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    def create(self,
        ...
        :type  n_sx_manager_deployment_info: :class:`com.vmware.nsx_policy.model_client.NSXManagerDeploymentInfo`
        :param n_sx_manager_deployment_info: (required)
        :rtype: :class:`com.vmware.nsx_policy.model_client.NSXManagerDeploymentInfo`
...
class _ManagementPlaneHealthStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/management-plane-health',
            path_variables={
            },
             header_parameters={
             },
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.management_plane_health',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)

class _OrgRootStub(ApiInterfaceStub):
    def __init__(self, config):
        # properties for get operation
        get_input_type = type.StructType('operation-input', {
            'base_path': type.OptionalType(type.StringType()),
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/org-root',
            path_variables={
            },
             header_parameters={
                   },
        ...
        # properties for patch operation
        patch_input_type = type.StructType('operation-input', {
            'org_root': type.ReferenceType('com.vmware.nsx_policy.model_client', 'OrgRoot'),
            'enforce_revision_check': type.OptionalType(type.BooleanType()),
        })
        patch_error_dict = {
            'com.vmware.vapi.std.errors.invalid_request':
        ...
        patch_rest_metadata = OperationRestMetadata(
            http_method='PATCH',
            url_template='/policy/api/v1/org-root',
            request_body_parameter='org_root',
            path_variables={
            },
             header_parameters={
                 },
        ...
        operations = {
            'get': {
                'input_type': get_input_type,
                'output_type': type.ReferenceType('com.vmware.nsx_policy.model_client', 'OrgRoot'),
                'errors': get_error_dict,
                'input_value_validator_list': get_input_value_validator_list,
                'output_validator_list': get_output_validator_list,
                'task_type': TaskType.NONE,
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.org_root',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class _OrgsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/orgs/{org-id}',
            path_variables={
                'org_id': 'org-id',
            },
             header_parameters={
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/orgs',
            path_variables={
            },
             header_parameters={
                         },
        ...
        operations = {
            'get': {
                'input_type': get_input_type,
                'output_type': type.ReferenceType('com.vmware.nsx_policy.model_client', 'Org'),
                'errors': get_error_dict,
                'input_value_validator_list': get_input_value_validator_list,
                'output_validator_list': get_output_validator_list,
                'task_type': TaskType.NONE,
            ...
            'list': {
                'input_type': list_input_type,
                'output_type': type.ReferenceType('com.vmware.nsx_policy.model_client', 'OrgListResult'),
                'errors': list_error_dict,
                'input_value_validator_list': list_input_value_validator_list,
                'output_validator_list': list_output_validator_list,
                'task_type': TaskType.NONE,
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.orgs',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class _WatermarkStub(ApiInterfaceStub):
    def __init__(self, config):
        # properties for create operation
        create_input_type = type.StructType('operation-input', {
            'n_SX_manager_deployment_info': type.ReferenceType('com.vmware.nsx_policy.model_client', 'NSXManagerDeploymentInfo'),
        })
        create_error_dict = {
            'com.vmware.vapi.std.errors.invalid_request':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidRequest'),
        ...
        create_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/policy/api/v1/watermark',
        ...
        operations = {
            'create': {
                'input_type': create_input_type,
                'output_type': type.ReferenceType('com.vmware.nsx_policy.model_client', 'NSXManagerDeploymentInfo'),
                'errors': create_error_dict,
                'input_value_validator_list': create_input_value_validator_list,
                'output_validator_list': create_output_validator_list,
                'task_type': TaskType.NONE,
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.watermark',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class StubFactory(StubFactoryBase):
    _attrs = {
        ...
        'malware_prevention': 'com.vmware.nsx_policy.malware_prevention_client.StubFactory',
        'model': 'com.vmware.nsx_policy.model_client.StubFactory',
        'observability': 'com.vmware.nsx_policy.observability_client.StubFactory',
        'orgs': 'com.vmware.nsx_policy.orgs_client.StubFactory',
        'search': 'com.vmware.nsx_policy.search_client.StubFactory',
        'security': 'com.vmware.nsx_policy.security_client.StubFactory',
