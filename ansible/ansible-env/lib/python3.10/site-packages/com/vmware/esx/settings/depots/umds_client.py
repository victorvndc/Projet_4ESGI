...
class Content(VapiInterface):
    ...
    ESX lifecycle management. This class was added in vSphere API 7.0.3.0.
    """
    ...
    class Info(VapiStruct):
        ...
        matadata bundles of the UMDS depot. This class was added in vSphere API
        7.0.3.0.
    ...
    def get(self):
        """
        Gets the information of content about the UMDS depot. This method was
