...
class Apply(VapiInterface):
    ...
    applied to an ESXi host. This class was added in vSphere API 8.0.0.1.
    """
    ...
    def get(self,
        ...
        """
        Returns the configured policy that has been set for the ESXi host. This
    ...
    def set(self,
        ...
        """
        This API will set the configured policy for an ESXi host. This method
        was added in vSphere API 8.0.0.1.
