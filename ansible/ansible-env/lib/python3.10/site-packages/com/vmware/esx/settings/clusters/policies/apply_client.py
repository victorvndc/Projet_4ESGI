...
Inc. All rights reserved. VMware Confidential Copyright 2019-2023 VMware, Inc.
...
class Effective(VapiInterface):
    ...
    class EffectivePolicySpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param parallel_remediation_action: Enable parallel remediation of hosts in maintenance mode. This
                attribute was added in vSphere API 8.0.0.1.
                This attribute is optional because it was added in a newer version
                than its parent node.
