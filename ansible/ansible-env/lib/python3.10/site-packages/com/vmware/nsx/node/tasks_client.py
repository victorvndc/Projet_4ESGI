...
#
# vAPI stub file for package com.vmware.nsx.node.tasks.
#---------------------------------------------------------------------------
...
class Response(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx.node.tasks.response'
    """
...
class _ResponseStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/api/v1/node/tasks/{task-id}/response',
            path_variables={
                'task_id': 'task-id',
            },
             header_parameters={
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx.node.tasks.response',
