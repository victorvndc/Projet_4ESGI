...
#
# vAPI stub file for package com.vmware.nsx.mac_sets.
#---------------------------------------------------------------------------
...
class Members(VapiInterface):
    ...
    def __init__(self, config):
        ...
        """
        VapiInterface.__init__(self, config, _MembersStub)
    ...
    def create(self,
        ...
        :param mac_set_id: MAC Set Id (required)
        :type  m_ac_address_element: :class:`com.vmware.nsx.model_client.MACAddressElement`
        :param m_ac_address_element: (required)
        :rtype: :class:`com.vmware.nsx.model_client.MACAddressElement`
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.mac_sets.Members.create is deprecated.', DeprecationWarning)
        return self._invoke('create',
                            {
                            'mac_set_id': mac_set_id,
                            'm_ac_address_element': m_ac_address_element,
                            })
    ...
    def delete(self,
        ...
        :param mac_address: MAC address to be removed (required)
        :raise: :class:`com.vmware.vapi.std.errors_client.InvalidRequest` 
            Bad Request, Precondition Failed
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized` 
            Forbidden
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.mac_sets.Members.delete is deprecated.', DeprecationWarning)
    ...
    def list(self,
        ...
        :type  mac_set_id: :class:`str`
        :param mac_set_id: MAC Set Id (required)
        :rtype: :class:`com.vmware.nsx.model_client.MACAddressElementListResult`
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.mac_sets.Members.list is deprecated.', DeprecationWarning)
        return self._invoke('list',
                            {
                            'mac_set_id': mac_set_id,
                            })
class _MembersStub(ApiInterfaceStub):
    def __init__(self, config):
