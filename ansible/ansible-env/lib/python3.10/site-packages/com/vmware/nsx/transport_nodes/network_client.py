...
#
# vAPI stub file for package com.vmware.nsx.transport_nodes.network.
#---------------------------------------------------------------------------
...
class Interfaces(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx.transport_nodes.network.interfaces'
    """
...
class _InterfacesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/api/v1/transport-nodes/{transport-node-id}/network/interfaces/{interface-id}',
            path_variables={
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/api/v1/transport-nodes/{transport-node-id}/network/interfaces',
            path_variables={
                'transport_node_id': 'transport-node-id',
            },
             header_parameters={
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx.transport_nodes.network.interfaces',
...
class StubFactory(StubFactoryBase):
    _attrs = {
        ...
        'interfaces': 'com.vmware.nsx.transport_nodes.network.interfaces_client.StubFactory',
    }
