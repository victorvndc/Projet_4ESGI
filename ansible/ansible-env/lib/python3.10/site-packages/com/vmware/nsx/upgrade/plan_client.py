...
#
# vAPI stub file for package com.vmware.nsx.upgrade.plan.
#---------------------------------------------------------------------------
...
class Settings(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx.upgrade.plan.settings'
    """
    ...
    def update(self,
        ...
        return self._invoke('update',
                            {
                            'component_type': component_type,
                            'upgrade_plan_settings': upgrade_plan_settings,
                            })
class _SettingsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/api/v1/upgrade/plan/{component_type}/settings',
            path_variables={
                'component_type': 'component_type',
            },
             header_parameters={
        ...
        update_input_type = type.StructType('operation-input', {
            'component_type': type.StringType(),
            'upgrade_plan_settings': type.ReferenceType('com.vmware.nsx.model_client', 'UpgradePlanSettings'),
        })
        update_error_dict = {
            'com.vmware.vapi.std.errors.invalid_request':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidRequest'),
        ...
        update_rest_metadata = OperationRestMetadata(
            http_method='PUT',
            url_template='/api/v1/upgrade/plan/{component_type}/settings',
            request_body_parameter='upgrade_plan_settings',
            path_variables={
                'component_type': 'component_type',
            },
             header_parameters={
        ...
        operations = {
            'get': {
                ...
                'output_type': type.ReferenceType('com.vmware.nsx.model_client', 'UpgradePlanSettings'),
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx.upgrade.plan.settings',
