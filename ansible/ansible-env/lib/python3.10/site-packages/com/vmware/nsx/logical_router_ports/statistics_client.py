...
#
# vAPI stub file for package com.vmware.nsx.logical_router_ports.statistics.
#---------------------------------------------------------------------------
...
class Summary(VapiInterface):
    ...
    def get(self,
        ...
        GET
        /policy/api/v1/infra/tier-0s/<tier-0-id>/locale-services/<locale-service-id>/interfaces/<interface-id>/statistics/summmary?enforcement_point_path=/infra/sites/default/enforcement-points/default
        GET
        /policy/api/v1/infra/tier-1s/<tier-1-id>/locale-services/<locale-service-id>/interfaces/<interface-id>/statistics/summmary?enforcement_point_path=/infra/sites/default/enforcement-points/default
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.logical_router_ports.statistics.Summary.get is deprecated.', DeprecationWarning)
...
class _SummaryStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/api/v1/logical-router-ports/{logical-router-port-id}/statistics/summary',
            path_variables={
        ...
        operations = {
            'get': {
                ...
                'output_type': type.ReferenceType('com.vmware.nsx.model_client', 'LogicalRouterPortStatisticsSummary'),
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx.logical_router_ports.statistics.summary',
