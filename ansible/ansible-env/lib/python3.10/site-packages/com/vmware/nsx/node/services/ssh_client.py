...
#
# vAPI stub file for package com.vmware.nsx.node.services.ssh.
#---------------------------------------------------------------------------
...
class NotifyMpa(VapiInterface):
    """
    
    """

    _VAPI_SERVICE_ID = 'com.vmware.nsx.node.services.ssh.notify_mpa'
    """
    ...
    def __init__(self, config):
        ...
        """
        VapiInterface.__init__(self, config, _NotifyMpaStub)
...
class Status(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx.node.services.ssh.status'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class _NotifyMpaStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        restart_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/api/v1/node/services/ssh/notify_mpa?action=restart',
            path_variables={
            },
             header_parameters={
             },
        ...
        start_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/api/v1/node/services/ssh/notify_mpa?action=start',
            path_variables={
            },
             header_parameters={
             },
        ...
        stop_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/api/v1/node/services/ssh/notify_mpa?action=stop',
            path_variables={
            },
             header_parameters={
             },
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx.node.services.ssh.notify_mpa',
...
class _StatusStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/api/v1/node/services/ssh/status',
            path_variables={
            },
             header_parameters={
             },
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx.node.services.ssh.status',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
