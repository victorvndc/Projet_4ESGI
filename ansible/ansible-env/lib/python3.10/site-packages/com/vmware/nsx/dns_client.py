...
class Forwarders(VapiInterface):
    ...
    def clearcache(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.dns.Forwarders.clearcache is deprecated.', DeprecationWarning)
    ...
    def create(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.dns.Forwarders.create is deprecated.', DeprecationWarning)
    ...
    def delete(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.dns.Forwarders.delete is deprecated.', DeprecationWarning)
    ...
    def disable(self,
        ...
        Please use Policy API: PUT or PATCH
        /policy/api/v1/infra/tier-0s/{tier-0-id}/dns-forwarder {
        \"display_name\" : \"dns-forwarder\", \"listener_ip\" : \"5.5.5.5\",
        \"default_forwarder_zone_path\" :
        \"/infra/dns-forwarder-zones/default-1\",
        \"conditional_forwarder_zone_paths\" :
        [\"/infra/dns-forwarder-zones/conditional-1\"], \"enabled\": false,
        \"_revision\" : 0 } PUT or PATCH
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.dns.Forwarders.disable is deprecated.', DeprecationWarning)
    ...
    def enable(self,
        ...
        \"/infra/dns-forwarder-zones/default-1\",
        \"conditional_forwarder_zone_paths\" :
        [\"/infra/dns-forwarder-zones/conditional-1\"], \"enabled\": true,
        \"_revision\" : 0 } PUT or PATCH
        /policy/api/v1/infra/tier-1s/{tier-1-id}/dns-forwarder {
        \"display_name\" : \"dns-forwarder\", \"listener_ip\" : \"5.5.5.5\",
        \"default_forwarder_zone_path\" :
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.dns.Forwarders.enable is deprecated.', DeprecationWarning)
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.dns.Forwarders.get is deprecated.', DeprecationWarning)
    ...
    def list(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.dns.Forwarders.list is deprecated.', DeprecationWarning)
    ...
    def update(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.dns.Forwarders.update is deprecated.', DeprecationWarning)
