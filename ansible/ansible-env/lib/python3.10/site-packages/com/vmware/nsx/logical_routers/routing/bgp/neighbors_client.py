...
class AdvertisedRoutes(VapiInterface):
    ...
    def get(self,
        ...
        GET
        /policy/api/v1/infra/tier-0s/<tier-0-id>/locale-services/<locale-service-id>/bgp/neighbors/to-onprem/advertised-routes
        GET
        /policy/api/v1/infra/tier-1s/<tier-1-id>/locale-services/<locale-service-id>/bgp/neighbors/to-onprem/advertised-routes
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.logical_routers.routing.bgp.neighbors.AdvertisedRoutes.get is deprecated.', DeprecationWarning)
...
class Routes(VapiInterface):
    ...
    def get(self,
        ...
        Please use below Policy API. 
        GET
        /policy/api/v1/infra/tier-0s/<tier-0-id>/locale-services/<locale-service-id>/bgp/neighbors/to-onprem/routes
        GET
        /policy/api/v1/infra/tier-1s/<tier-1-id>/locale-services/<locale-service-id>/bgp/neighbors/to-onprem/routes
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.logical_routers.routing.bgp.neighbors.Routes.get is deprecated.', DeprecationWarning)
        return self._invoke('get',
                            {
                            'logical_router_id': logical_router_id,
                            'neighbor_id': neighbor_id,
...
class Status(VapiInterface):
    ...
    """
    LIST_TYPE_INTER_SR = "INTER_SR"
    """
    Possible value for ``type`` of method :func:`Status.list`.
    ...
    def list(self,
        ...
        """
        Returns the status of all the BGP neighbors for the Logical Router of
        the given id. To get BGP neighbors status for the logical router from
        particular node, parameter \"transport_node_id=<transportnode_id>\"
        ...
        :param type: BGP neighbor type (optional)
        :rtype: :class:`com.vmware.nsx.model_client.BgpNeighborsStatusListResult`
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.logical_routers.routing.bgp.neighbors.Status.list is deprecated.', DeprecationWarning)
...
class _StatusStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/api/v1/logical-routers/{logical-router-id}/routing/bgp/neighbors/status',
            path_variables={
                'logical_router_id': 'logical-router-id',
            },
             header_parameters={
        ...
        operations = {
            'list': {
                ...
                'output_type': type.ReferenceType('com.vmware.nsx.model_client', 'BgpNeighborsStatusListResult'),
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx.logical_routers.routing.bgp.neighbors.status',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
