...
class Data(VapiInterface):
    ...
    """
    DELETE_FILE_TYPE_VRA_INPUT = "VRA_INPUT"
    """
    Possible value for ``fileType`` of method :func:`Data.delete`.

    """
    DELETE_FILE_TYPE_EDGE_CUTOVER_MAPPING = "EDGE_CUTOVER_MAPPING"
    """
    Possible value for ``fileType`` of method :func:`Data.delete`.

    """
    DELETE_FILE_TYPE_BYOT_L3_MAPPING = "BYOT_L3_MAPPING"
    """
    Possible value for ``fileType`` of method :func:`Data.delete`.

    """
    DELETE_FILE_TYPE_AVI_LB_MAPPING = "AVI_LB_MAPPING"
    """
    Possible value for ``fileType`` of method :func:`Data.delete`.
    ...
    """
    GET_FILE_TYPE_VRA_OUTPUT = "VRA_OUTPUT"
    """
    Possible value for ``fileType`` of method :func:`Data.get`.
    ...
    """
    GET_FILE_TYPE_BYOT_L3_MAPPING = "BYOT_L3_MAPPING"
    """
    Possible value for ``fileType`` of method :func:`Data.get`.

    """
    GET_FILE_TYPE_AVI_LB_MAPPING = "AVI_LB_MAPPING"
    """
    Possible value for ``fileType`` of method :func:`Data.get`.

    """
    GET_FILE_TYPE_MIGRATION_REPORT = "MIGRATION_REPORT"
    """
    Possible value for ``fileType`` of method :func:`Data.get`.
    ...
    def delete(self,
        ...
        :param file_type: Type of the Migration data file that needs to be deleted.
            (required)
...
class FeedbackRequests(VapiInterface):
    ...
    """
    LIST_NETWORK_LAYER_L2 = "L2"
    """
    Possible value for ``networkLayer`` of method :func:`FeedbackRequests.list`.

    """
    LIST_NETWORK_LAYER_L3_L7 = "L3_L7"
    """
    Possible value for ``networkLayer`` of method :func:`FeedbackRequests.list`.
    ...
    def list(self,
        ...
        :param included_fields: Comma separated list of fields that should be included in query
            result (optional)
        :type  network_layer: :class:`str` or ``None``
        :param network_layer: Network layer for which feedback is generated (optional)
        :type  page_size: :class:`long` or ``None``
        :param page_size: Maximum number of results to return in this page (server may return
            fewer) (optional, default to 1000)
        :type  sort_ascending: :class:`bool` or ``None``
...
class FeedbackResponse(VapiInterface):
    ...
    """
    ACCEPTRECOMMENDED_NETWORK_LAYER_L2 = "L2"
    """
    Possible value for ``networkLayer`` of method
    :func:`FeedbackResponse.acceptrecommended`.

    """
    ACCEPTRECOMMENDED_NETWORK_LAYER_L3_L7 = "L3_L7"
    """
    Possible value for ``networkLayer`` of method
    :func:`FeedbackResponse.acceptrecommended`.

    """
    UPDATE_NETWORK_LAYER_L2 = "L2"
    """
    Possible value for ``networkLayer`` of method :func:`FeedbackResponse.update`.

    """
    UPDATE_NETWORK_LAYER_L3_L7 = "L3_L7"
    """
    Possible value for ``networkLayer`` of method :func:`FeedbackResponse.update`.
    ...
    def acceptrecommended(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        return self._invoke('acceptrecommended',
                            {
                            'network_layer': network_layer,
                            })
...
class FeedbackSummary(VapiInterface):
    ...
    LIST_NETWORK_LAYER_L2 = "L2"
    """
    Possible value for ``networkLayer`` of method :func:`FeedbackSummary.list`.
...
class GroupedFeedbackRequests(VapiInterface):
    ...
    """
    Possible value for ``networkLayer`` of method
    :func:`GroupedFeedbackRequests.list`.
...
class MigratedResources(VapiInterface):
    """
    
    """
    LIST_RESOURCE_TYPE_IPBLOCK = "IPBLOCK"
    """
    Possible value for ``resourceType`` of method :func:`MigratedResources.list`.

    """
    LIST_RESOURCE_TYPE_IPPOOL = "IPPOOL"
    """
    Possible value for ``resourceType`` of method :func:`MigratedResources.list`.

    """
    LIST_RESOURCE_TYPE_IPBLOCK_SUBNET = "IPBLOCK_SUBNET"
    """
    Possible value for ``resourceType`` of method :func:`MigratedResources.list`.

    """
    LIST_RESOURCE_TYPE_IPPOOL_ALLOCATION = "IPPOOL_ALLOCATION"
    """
    Possible value for ``resourceType`` of method :func:`MigratedResources.list`.

    """
    LIST_RESOURCE_TYPE_TIER0 = "TIER0"
    """
    Possible value for ``resourceType`` of method :func:`MigratedResources.list`.

    """
    LIST_RESOURCE_TYPE_TIER1 = "TIER1"
    """
    Possible value for ``resourceType`` of method :func:`MigratedResources.list`.

    """
    LIST_RESOURCE_TYPE_TIER0_LOGICAL_ROUTER_PORT = "TIER0_LOGICAL_ROUTER_PORT"
    """
    Possible value for ``resourceType`` of method :func:`MigratedResources.list`.

    """
    LIST_RESOURCE_TYPE_TIER1_LOGICAL_ROUTER_PORT = "TIER1_LOGICAL_ROUTER_PORT"
    """
    Possible value for ``resourceType`` of method :func:`MigratedResources.list`.

    """
    LIST_RESOURCE_TYPE_TIER0_LOGICAL_ROUTER_CONFIG = "TIER0_LOGICAL_ROUTER_CONFIG"
    """
    Possible value for ``resourceType`` of method :func:`MigratedResources.list`.

    """
    LIST_RESOURCE_TYPE_SPOOFGUARD_PROFILES = "SPOOFGUARD_PROFILES"
    """
    Possible value for ``resourceType`` of method :func:`MigratedResources.list`.

    """
    LIST_RESOURCE_TYPE_LOGICAL_SWITCH = "LOGICAL_SWITCH"
    """
    Possible value for ``resourceType`` of method :func:`MigratedResources.list`.

    """
    LIST_RESOURCE_TYPE_LOGICAL_PORT = "LOGICAL_PORT"
    """
    Possible value for ``resourceType`` of method :func:`MigratedResources.list`.

    """
    LIST_RESOURCE_TYPE_NAT = "NAT"
    """
    Possible value for ``resourceType`` of method :func:`MigratedResources.list`.

    """
    LIST_RESOURCE_TYPE_IP_SET = "IP_SET"
    """
    Possible value for ``resourceType`` of method :func:`MigratedResources.list`.

    """
    LIST_RESOURCE_TYPE_NS_GROUP = "NS_GROUP"
    """
    Possible value for ``resourceType`` of method :func:`MigratedResources.list`.

    """
    LIST_RESOURCE_TYPE_CERTIFICATE = "CERTIFICATE"
    """
    Possible value for ``resourceType`` of method :func:`MigratedResources.list`.

    """
    LIST_RESOURCE_TYPE_CRL = "CRL"
    """
    Possible value for ``resourceType`` of method :func:`MigratedResources.list`.

    """
    LIST_RESOURCE_TYPE_LB_MONITOR = "LB_MONITOR"
    """
    Possible value for ``resourceType`` of method :func:`MigratedResources.list`.

    """
    LIST_RESOURCE_TYPE_LB_POOL = "LB_POOL"
    """
    Possible value for ``resourceType`` of method :func:`MigratedResources.list`.

    """
    LIST_RESOURCE_TYPE_LB_PERSISTENCE_PROFILE = "LB_PERSISTENCE_PROFILE"
    """
    Possible value for ``resourceType`` of method :func:`MigratedResources.list`.

    """
    LIST_RESOURCE_TYPE_LB_APPLICATION_PROFILE = "LB_APPLICATION_PROFILE"
    """
    Possible value for ``resourceType`` of method :func:`MigratedResources.list`.

    """
    LIST_RESOURCE_TYPE_LB_SERVICE = "LB_SERVICE"
    """
    Possible value for ``resourceType`` of method :func:`MigratedResources.list`.

    """
    LIST_RESOURCE_TYPE_LB_CLIENT_SSL_PROFILE = "LB_CLIENT_SSL_PROFILE"
    """
    Possible value for ``resourceType`` of method :func:`MigratedResources.list`.

    """
    LIST_RESOURCE_TYPE_LB_VIRTUAL_SERVER = "LB_VIRTUAL_SERVER"
    """
    Possible value for ``resourceType`` of method :func:`MigratedResources.list`.

    """
    LIST_RESOURCE_TYPE_DFW_SECTION = "DFW_SECTION"
    """
    Possible value for ``resourceType`` of method :func:`MigratedResources.list`.

    """

    _VAPI_SERVICE_ID = 'com.vmware.nsx.migration.migrated_resources'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
        ...
        :param config: Configuration to be used for creating the stub.
        """
        VapiInterface.__init__(self, config, _MigratedResourcesStub)
        self._VAPI_OPERATION_IDS = {}
    ...
    def list(self,
        ...
        """
        List migrated resources.This API is applicable for mp2Policy migration
        mode only.
        ...
        :param resource_id: Resource id (optional)
        :type  sort_ascending: :class:`bool` or ``None``
        :param sort_ascending: (optional)
        :type  sort_by: :class:`str` or ``None``
        :param sort_by: Field by which records are sorted (optional)
        :rtype: :class:`com.vmware.nsx.model_client.MigratedObjectListResult`
...
class MpToPolicy(VapiInterface):
    """
    
    """

    _VAPI_SERVICE_ID = 'com.vmware.nsx.migration.mp_to_policy'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
        ...
        :param config: Configuration to be used for creating the stub.
        """
        VapiInterface.__init__(self, config, _MpToPolicyStub)
        self._VAPI_OPERATION_IDS = {}
    ...
    def create(self,
        ...
        :type  mp_migration_data: :class:`com.vmware.nsx.model_client.MpMigrationData`
        :param mp_migration_data: (required)
        :raise: :class:`com.vmware.vapi.std.errors_client.InvalidRequest` 
            Bad Request, Precondition Failed
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized` 
            Forbidden
        ...
        return self._invoke('create',
                            {
                            'mp_migration_data': mp_migration_data,
                            })
...
class Plan(VapiInterface):
    ...
    def updatesitemigrationstate(self,
                                 federation_site_migration_state,
                                 ):
        """
        This API updates the migration-state of host groups which are part of
        provided federation site/s.

        :type  federation_site_migration_state: :class:`com.vmware.nsx.model_client.FederationSiteMigrationState`
        :param federation_site_migration_state: (required)
        :raise: :class:`com.vmware.vapi.std.errors_client.InvalidRequest` 
            Bad Request, Precondition Failed
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized` 
            Forbidden
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        return self._invoke('updatesitemigrationstate',
                            {
                            'federation_site_migration_state': federation_site_migration_state,
                            })
class Setup(VapiInterface):
    """
    
    """
    SETESGTOROUTERMAPPINGOPTION_MAPPING_OPTION_UI = "UI"
    """
    Possible value for ``mappingOption`` of method
    :func:`Setup.setesgtoroutermappingoption`.

    """
    SETESGTOROUTERMAPPINGOPTION_MAPPING_OPTION_FILE_UPLOAD = "FILE_UPLOAD"
    """
    Possible value for ``mappingOption`` of method
    :func:`Setup.setesgtoroutermappingoption`.

    """
    SETESGTOROUTERMAPPINGOPTION_MAPPING_OPTION_NO_MAPPING = "NO_MAPPING"
    """
    Possible value for ``mappingOption`` of method
    :func:`Setup.setesgtoroutermappingoption`.
    ...
    def addalbinfo(self,
        ...
        :type  avi_end_point: :class:`com.vmware.nsx.model_client.AviEndPoint`
        :param avi_end_point: (required)
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthenticated` 
            Unauthorized
        :raise: :class:`com.vmware.vapi.std.errors_client.InvalidRequest` 
            Bad Request, Precondition Failed
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        return self._invoke('addalbinfo',
                            {
                            'avi_end_point': avi_end_point,
                            })

    def addv2tsitemapping(self,
                          v2t_site_mapping_spec,
                          ):
        """
        Add NSX-V to NSX-T site mapping.

        :type  v2t_site_mapping_spec: :class:`com.vmware.nsx.model_client.V2tSiteMappingSpec`
        :param v2t_site_mapping_spec: (required)
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthenticated` 
            Unauthorized
        :raise: :class:`com.vmware.vapi.std.errors_client.InvalidRequest` 
            Bad Request, Precondition Failed
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        return self._invoke('addv2tsitemapping',
                            {
                            'v2t_site_mapping_spec': v2t_site_mapping_spec,
                            })
    ...
    def migratenewlyaddedhosttransportnode(self,
                                           new_host_transport_node_spec,
                                           ):
        """
        This API is to support the add Host workflow on NSX-T once the V2T
        migration process has started. There are two high level cases. For each
        case, please refer to the detailed steps. Case - 1 : For migration mode
        - CONFIG_AND_EDGE_MIGRATION_WITH_BYOT,
        CONFIG_AND_EDGE_MIGRATION_WITH_BYOT_ON_FEDERATION 1. Verify that
        overall migration status is in SUCCESS state in migration co-ordinator.
        This means all migration stages are completed and we are at a point
        where we can move workloads using the pre-migrate, post-migrate API's.
        2. Follow steps mentioned in product documentation to add a new host to
        cluster. 3. Invoke this API (Accept Host Transport Node) to perform the
        V2T migration steps on newly added host transport node. Once API is
        successful, make sure that newly added HOST can take worklods (Ex:
        Traffic checks, etc.,). For Case-1, this API should be invoked only
        when following conditions are met. - The overall migration status is in
        SUCCESS status. - All the migration stages are completed and we are at
        a point where we can move workloads. - The migration mode selected has
        to be among the ones designated for case-1 - The new host has been
        added to a cluster by following all the steps mentioned in product
        documentation. Case - 2 : For migration modes that perform HOST
        migration. 1. Verify that overall migration status is in PAUSED state
        in migration co-ordinator. 2. Follow steps mentioned in product
        documentation to add a new host to cluster. 3. Invoke the migration
        co-ordinator sync HOST groups API. This will result in migration
        co-ordinator updating its inventory and accouting for the newly added
        host transport node. At this point, the list host upgrade units API
        call to MC will also show the newly added host transport node. But do
        NOT resume the migration. Since this host transport node is added after
        the V2T migration has started, we need to perform migration steps on
        this host through this special API (Accept Host Transport Node) 4.
        Invoke this API (Accept Host Transport Node) to perform the V2T
        migration steps on newly added host transport node. Once the API is
        successful, we should be seeing that migration status has been marked
        as SUCCESS for the newly added host transport node. Very Importnant
        Note : Make sure that migration status is PAUSED in migration
        co-ordinator when performing steps 2 through 4. Also ensure that all
        the steps 2 through 4 pass without failures. For Case-2, this API
        should be invoked only when following conditions are met. - The overall
        migration status is in PAUSED status. - The migration mode selected has
        HOST component in it. - All the migration stages before HOST stage are
        completed. - The new host has been added to a cluster by following all
        the steps mentioned in product documentation.

        :type  new_host_transport_node_spec: :class:`com.vmware.nsx.model_client.NewHostTransportNodeSpec`
        :param new_host_transport_node_spec: (required)
        :raise: :class:`com.vmware.vapi.std.errors_client.InvalidRequest` 
            Bad Request, Precondition Failed
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized` 
            Forbidden
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        return self._invoke('migratenewlyaddedhosttransportnode',
                            {
                            'new_host_transport_node_spec': new_host_transport_node_spec,
                            })

    def setesgtoroutermappingoption(self,
                                    mapping_option,
                                    ):
        """
        Set the NSX-V ESG to NSX-T Router mapping option.

        :type  mapping_option: :class:`str`
        :param mapping_option: Mapping option (required)
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthenticated` 
            Unauthorized
        :raise: :class:`com.vmware.vapi.std.errors_client.InvalidRequest` 
            Bad Request, Precondition Failed
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        return self._invoke('setesgtoroutermappingoption',
                            {
...
class _FeedbackRequestsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_input_type = type.StructType('operation-input', {
            ...
            'included_fields': type.OptionalType(type.StringType()),
            'network_layer': type.OptionalType(type.StringType()),
            'page_size': type.OptionalType(type.IntegerType()),
            'sort_ascending': type.OptionalType(type.BooleanType()),
            'sort_by': type.OptionalType(type.StringType()),
...
class _MigratedResourcesStub(ApiInterfaceStub):
    def __init__(self, config):
        # properties for list operation
        list_input_type = type.StructType('operation-input', {
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/api/v1/migration/migrated-resources',
            path_variables={
            },
             header_parameters={
                           },
        ...
        operations = {
            'list': {
                'input_type': list_input_type,
                'output_type': type.ReferenceType('com.vmware.nsx.model_client', 'MigratedObjectListResult'),
                'errors': list_error_dict,
                'input_value_validator_list': list_input_value_validator_list,
                'output_validator_list': list_output_validator_list,
                'task_type': TaskType.NONE,
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx.migration.migrated_resources',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class _MpToPolicyStub(ApiInterfaceStub):
    def __init__(self, config):
        # properties for create operation
        create_input_type = type.StructType('operation-input', {
            'mp_migration_data': type.ReferenceType('com.vmware.nsx.model_client', 'MpMigrationData'),
        })
        create_error_dict = {
            'com.vmware.vapi.std.errors.invalid_request':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidRequest'),
        ...
        create_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/api/v1/migration/mp-to-policy',
            request_body_parameter='mp_migration_data',
            path_variables={
            },
             header_parameters={
               },
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx.migration.mp_to_policy',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class _PlanStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        # properties for updatesitemigrationstate operation
        updatesitemigrationstate_input_type = type.StructType('operation-input', {
            'federation_site_migration_state': type.ReferenceType('com.vmware.nsx.model_client', 'FederationSiteMigrationState'),
        })
        updatesitemigrationstate_error_dict = {
            'com.vmware.vapi.std.errors.invalid_request':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidRequest'),
            'com.vmware.vapi.std.errors.unauthorized':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'),
        ...
        updatesitemigrationstate_input_value_validator_list = [
        ]
        updatesitemigrationstate_output_validator_list = [
        ]
        updatesitemigrationstate_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/api/v1/migration/plan?action=update_site_migration_state',
            request_body_parameter='federation_site_migration_state',
            path_variables={
            },
             header_parameters={
               },
        ...
        operations = {
            ...
            'updatesitemigrationstate': {
                'input_type': updatesitemigrationstate_input_type,
                'output_type': type.VoidType(),
                'errors': updatesitemigrationstate_error_dict,
                'input_value_validator_list': updatesitemigrationstate_input_value_validator_list,
                'output_validator_list': updatesitemigrationstate_output_validator_list,
                'task_type': TaskType.NONE,
            },
        }
        rest_metadata = {
            ...
            'updatesitemigrationstate': updatesitemigrationstate_rest_metadata,
        }
        ApiInterfaceStub.__init__(
...
class _SetupStub(ApiInterfaceStub):
    def __init__(self, config):
        # properties for addalbinfo operation
        addalbinfo_input_type = type.StructType('operation-input', {
            'avi_end_point': type.ReferenceType('com.vmware.nsx.model_client', 'AviEndPoint'),
        })
        addalbinfo_error_dict = {
            'com.vmware.vapi.std.errors.unauthenticated':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'),
            'com.vmware.vapi.std.errors.invalid_request':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidRequest'),
        ...
        addalbinfo_input_value_validator_list = [
        ]
        addalbinfo_output_validator_list = [
        ]
        addalbinfo_rest_metadata = OperationRestMetadata(
            http_method='PUT',
            url_template='/api/v1/migration/setup?action=addAlbInfo',
            request_body_parameter='avi_end_point',
            path_variables={
            },
             header_parameters={
               },
        ...
        # properties for addv2tsitemapping operation
        addv2tsitemapping_input_type = type.StructType('operation-input', {
            'v2t_site_mapping_spec': type.ReferenceType('com.vmware.nsx.model_client', 'V2tSiteMappingSpec'),
        })
        addv2tsitemapping_error_dict = {
            'com.vmware.vapi.std.errors.unauthenticated':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'),
            'com.vmware.vapi.std.errors.invalid_request':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidRequest'),
        ...
        addv2tsitemapping_input_value_validator_list = [
        ]
        addv2tsitemapping_output_validator_list = [
        ]
        addv2tsitemapping_rest_metadata = OperationRestMetadata(
            http_method='PUT',
            url_template='/api/v1/migration/setup?action=addV2tSiteMapping',
            request_body_parameter='v2t_site_mapping_spec',
            path_variables={
            },
             header_parameters={
               },
        ...
        # properties for migratenewlyaddedhosttransportnode operation
        migratenewlyaddedhosttransportnode_input_type = type.StructType('operation-input', {
            'new_host_transport_node_spec': type.ReferenceType('com.vmware.nsx.model_client', 'NewHostTransportNodeSpec'),
        })
        migratenewlyaddedhosttransportnode_error_dict = {
            'com.vmware.vapi.std.errors.invalid_request':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidRequest'),
            'com.vmware.vapi.std.errors.unauthorized':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'),
        ...
        migratenewlyaddedhosttransportnode_input_value_validator_list = [
        ]
        migratenewlyaddedhosttransportnode_output_validator_list = [
        ]
        migratenewlyaddedhosttransportnode_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/api/v1/migration/setup?action=migrate_newly_added_host_transport_node',
            request_body_parameter='new_host_transport_node_spec',
            path_variables={
            },
             header_parameters={
               },
        ...
        # properties for setesgtoroutermappingoption operation
        setesgtoroutermappingoption_input_type = type.StructType('operation-input', {
            'mapping_option': type.StringType(),
        })
        setesgtoroutermappingoption_error_dict = {
            'com.vmware.vapi.std.errors.unauthenticated':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'),
            'com.vmware.vapi.std.errors.invalid_request':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidRequest'),
        ...
        setesgtoroutermappingoption_input_value_validator_list = [
        ]
        setesgtoroutermappingoption_output_validator_list = [
        ]
        setesgtoroutermappingoption_rest_metadata = OperationRestMetadata(
            http_method='PUT',
            url_template='/api/v1/migration/setup?action=setEsgToRouterMappingOption',
            path_variables={
            },
             header_parameters={
               },
        ...
        operations = {
            'addalbinfo': {
                'input_type': addalbinfo_input_type,
                'output_type': type.VoidType(),
                'errors': addalbinfo_error_dict,
                'input_value_validator_list': addalbinfo_input_value_validator_list,
                'output_validator_list': addalbinfo_output_validator_list,
                'task_type': TaskType.NONE,
            },
            'addv2tsitemapping': {
                'input_type': addv2tsitemapping_input_type,
                'output_type': type.VoidType(),
                'errors': addv2tsitemapping_error_dict,
                'input_value_validator_list': addv2tsitemapping_input_value_validator_list,
                'output_validator_list': addv2tsitemapping_output_validator_list,
                'task_type': TaskType.NONE,
            },
            'get': {
                'input_type': get_input_type,
            ...
            'migratenewlyaddedhosttransportnode': {
                'input_type': migratenewlyaddedhosttransportnode_input_type,
                'output_type': type.VoidType(),
                'errors': migratenewlyaddedhosttransportnode_error_dict,
                'input_value_validator_list': migratenewlyaddedhosttransportnode_input_value_validator_list,
                'output_validator_list': migratenewlyaddedhosttransportnode_output_validator_list,
                'task_type': TaskType.NONE,
            },
            'setesgtoroutermappingoption': {
                'input_type': setesgtoroutermappingoption_input_type,
                'output_type': type.VoidType(),
                'errors': setesgtoroutermappingoption_error_dict,
                'input_value_validator_list': setesgtoroutermappingoption_input_value_validator_list,
                'output_validator_list': setesgtoroutermappingoption_output_validator_list,
                'task_type': TaskType.NONE,
            },
            'update': {
                'input_type': update_input_type,
        ...
        rest_metadata = {
            'addalbinfo': addalbinfo_rest_metadata,
            'addv2tsitemapping': addv2tsitemapping_rest_metadata,
            'get': get_rest_metadata,
            'migratenewlyaddedhosttransportnode': migratenewlyaddedhosttransportnode_rest_metadata,
            'setesgtoroutermappingoption': setesgtoroutermappingoption_rest_metadata,
            'update': update_rest_metadata,
        }
        ApiInterfaceStub.__init__(
...
class StubFactory(StubFactoryBase):
    _attrs = {
        ...
        'mp_policy_promotion': 'com.vmware.nsx.migration.mp_policy_promotion_client.StubFactory',
        'mp_to_policy': 'com.vmware.nsx.migration.mp_to_policy_client.StubFactory',
        'overlay_adoption': 'com.vmware.nsx.migration.overlay_adoption_client.StubFactory',
