...
#
# vAPI stub file for package com.vmware.nsx.transport_node_collections.
#---------------------------------------------------------------------------
...
class State(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx.transport_node_collections.state'
    """
    ...
    def get(self,
        ...
        :rtype: :class:`com.vmware.nsx.model_client.TransportNodeCollectionState`
        :return: com.vmware.nsx.model.TransportNodeCollectionState
...
class _StateStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/api/v1/transport-node-collections/{transport-node-collection-id}/state',
            path_variables={
        ...
        operations = {
            'get': {
                ...
                'output_type': type.ReferenceType('com.vmware.nsx.model_client', 'TransportNodeCollectionState'),
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx.transport_node_collections.state',
