...
#
# vAPI stub file for package com.vmware.nsx.dhcp.servers.static_bindings.
#---------------------------------------------------------------------------
...
class State(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx.dhcp.servers.static_bindings.state'
    """
    ...
    def get(self,
        ...
        """
        Return realized state information of a dhcp static binding. After a
        dhcp static binding is created or updated, you can invoke this API to
        get the realization information of the static binding.
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.dhcp.servers.static_bindings.State.get is deprecated.', DeprecationWarning)
...
class _StateStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/api/v1/dhcp/servers/{server-id}/static-bindings/{binding-id}/state',
            path_variables={
                'server_id': 'server-id',
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx.dhcp.servers.static_bindings.state',
