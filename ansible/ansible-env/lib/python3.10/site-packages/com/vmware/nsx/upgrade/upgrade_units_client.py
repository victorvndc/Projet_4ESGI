...
#
# vAPI stub file for package com.vmware.nsx.upgrade.upgrade_units.
#---------------------------------------------------------------------------
...
class AggregateInfo(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx.upgrade.upgrade_units.aggregate_info'
    """
    ...
    def list(self,
             ...
             sort_ascending=None,
             sort_by=None,
             upgrade_unit_display_name=None,
             ):
        """
        ...
        :type  upgrade_unit_display_name: :class:`str` or ``None``
        :param upgrade_unit_display_name: Display name of upgrade unit (optional)
        ...
        return self._invoke('list',
                            ...
                            'sort_by': sort_by,
                            'upgrade_unit_display_name': upgrade_unit_display_name,
                            })
class _AggregateInfoStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_input_type = type.StructType('operation-input', {
            ...
            'upgrade_unit_display_name': type.OptionalType(type.StringType()),
        })
        list_error_dict = {
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/api/v1/upgrade/upgrade-units/aggregate-info',
            path_variables={
            },
             header_parameters={
                                   },
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx.upgrade.upgrade_units.aggregate_info',
