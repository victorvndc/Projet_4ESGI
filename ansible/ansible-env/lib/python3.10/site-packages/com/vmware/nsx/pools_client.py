...
class IpBlocks(VapiInterface):
    ...
    def create(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.pools.IpBlocks.create is deprecated.', DeprecationWarning)
    ...
    def delete(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.pools.IpBlocks.delete is deprecated.', DeprecationWarning)
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.pools.IpBlocks.get is deprecated.', DeprecationWarning)
    ...
    def list(self,
        ...
        This rest routine is deprecated. Use /infra/ip-blocks to get list of
        configured IP address blocks.
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.pools.IpBlocks.list is deprecated.', DeprecationWarning)
    ...
    def update(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.pools.IpBlocks.update is deprecated.', DeprecationWarning)
...
class IpPools(VapiInterface):
    ...
    def allocateorrelease(self,
        ...
        """
        Allocates or releases an IP address from the specified IP pool. To
        allocate an address, include ?action=ALLOCATE in the request and
        \"allocation_id\":null in the request body. When the request is
        successful, the response is \"allocation_id\": \"<ip-address>\", where
        <ip-address> is an IP address from the specified pool. To release an IP
        address (return it back to the pool), include ?action=RELEASE in the
        request and \"allocation_id\":<ip-address> in the request body, where
        <ip-address> is the address to be released. When the request is
        successful, the response is NULL. Tags, display_name and description
        attributes are not supported for AllocationIpAddress in this release. 
        
        This rest routine is deprecated. Use
        /infra/ip-pools/<ip-pool-id>/ip-allocations/<ip-allocation-id> to
        Allocate or Release an IP Address from an IP Subnet.
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.pools.IpPools.allocateorrelease is deprecated.', DeprecationWarning)
    ...
    def create(self,
        ...
        This rest routine is deprecated. Use /infra/ip-pools/<ip-pool-id> with
        method type as PATCH for creation of a new IP address pool.
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.pools.IpPools.create is deprecated.', DeprecationWarning)
        return self._invoke('create',
                            {
                            'ip_pool': ip_pool,
                            })
    ...
    def delete(self,
        ...
        This rest routine is deprecated. Use /infra/ip-pools/<ip-pool-id> to
        delete a ip pool with specified id.
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.pools.IpPools.delete is deprecated.', DeprecationWarning)
        return self._invoke('delete',
                            {
                            'pool_id': pool_id,
                            'force': force,
    ...
    def get(self,
        ...
        This rest routine is deprecated. Use /infra/ip-pools/<ip-pool-id> to
        get information about the IP address pool with specified id.
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.pools.IpPools.get is deprecated.', DeprecationWarning)
        return self._invoke('get',
                            {
                            'pool_id': pool_id,
                            })
    ...
    def list(self,
        ...
        This rest routine is deprecated. Use /infra/ip-pools to get a paginated
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.pools.IpPools.list is deprecated.', DeprecationWarning)
        return self._invoke('list',
                            {
                            'cursor': cursor,
                            'included_fields': included_fields,
    ...
    def update(self,
        ...
        This rest routine is deprecated. Use /infra/ip-pools/<ip-pool-id> with
        method type as PUT for updating an IP address pool.
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.pools.IpPools.update is deprecated.', DeprecationWarning)
        return self._invoke('update',
                            {
                            'pool_id': pool_id,
                            'ip_pool': ip_pool,
...
class IpSubnets(VapiInterface):
    ...
    def allocateorreleasefromipblocksubnet(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.pools.IpSubnets.allocateorreleasefromipblocksubnet is deprecated.', DeprecationWarning)
    ...
    def create(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.pools.IpSubnets.create is deprecated.', DeprecationWarning)
        return self._invoke('create',
                            {
    ...
    def delete(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.pools.IpSubnets.delete is deprecated.', DeprecationWarning)
        return self._invoke('delete',
                            {
                            'subnet_id': subnet_id,
                            })
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.pools.IpSubnets.get is deprecated.', DeprecationWarning)
        return self._invoke('get',
                            {
                            'subnet_id': subnet_id,
                            })
    ...
    def list(self,
        ...
        This rest routine is deprecated. Use
        /infra/ip-pools/<ip-pool-id>/ip-subnets to list ip block subnets.
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.pools.IpSubnets.list is deprecated.', DeprecationWarning)
        return self._invoke('list',
                            {
                            'block_id': block_id,
                            'cursor': cursor,
...
class VniPools(VapiInterface):
    ...
    def update(self,
        ...
        modified for any existing range which has allocated VNIs. Range
        shrinking or deletion is not allowed if it affects any allocated VNIs.
