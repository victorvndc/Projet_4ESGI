...
class Statistics(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx.loadbalancer.services.pools.statistics'
    """
    ...
    def get(self,
        ...
        balancer serives id and load balancer pool id. Currently, only realtime
        mode is supported.
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.loadbalancer.services.pools.Statistics.get is deprecated.', DeprecationWarning)
    ...
    def list(self,
        ...
        balancer service. Currently, only realtime mode is supported.
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.loadbalancer.services.pools.Statistics.list is deprecated.', DeprecationWarning)
...
class Status(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx.loadbalancer.services.pools.status'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.loadbalancer.services.pools.Status.get is deprecated.', DeprecationWarning)
        return self._invoke('get',
                            {
                            'service_id': service_id,
                            'pool_id': pool_id,
    ...
    def list(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.loadbalancer.services.pools.Status.list is deprecated.', DeprecationWarning)
        return self._invoke('list',
                            {
                            'service_id': service_id,
                            'source': source,
