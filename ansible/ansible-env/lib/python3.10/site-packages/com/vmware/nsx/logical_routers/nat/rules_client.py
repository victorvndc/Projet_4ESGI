...
class Statistics(VapiInterface):
    ...
    def getperlogicalrouter(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.logical_routers.nat.rules.Statistics.getperlogicalrouter is deprecated.', DeprecationWarning)
    ...
    def getperrule(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.logical_routers.nat.rules.Statistics.getperrule is deprecated.', DeprecationWarning)
