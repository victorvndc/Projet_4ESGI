...
class Stats(VapiInterface):
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.firewall.sections.rules.Stats.get is deprecated.', DeprecationWarning)
    ...
    def get_0(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.firewall.sections.rules.Stats.get_0 is deprecated.', DeprecationWarning)
