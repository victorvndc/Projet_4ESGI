...
class Groups(VapiInterface):
    ...
    def list(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.directory.domains.Groups.list is deprecated.', DeprecationWarning)
...
class LdapServers(VapiInterface):
    ...
    def create(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.directory.domains.LdapServers.create is deprecated.', DeprecationWarning)
    ...
    def create_0(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.directory.domains.LdapServers.create_0 is deprecated.', DeprecationWarning)
    ...
    def delete(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.directory.domains.LdapServers.delete is deprecated.', DeprecationWarning)
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.directory.domains.LdapServers.get is deprecated.', DeprecationWarning)
    ...
    def list(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.directory.domains.LdapServers.list is deprecated.', DeprecationWarning)
        return self._invoke('list',
                            {
                            'domain_id': domain_id,
                            'cursor': cursor,
    ...
    def update(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.directory.domains.LdapServers.update is deprecated.', DeprecationWarning)
...
class OrgUnits(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx.directory.domains.org_units'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    def create(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.directory.domains.OrgUnits.create is deprecated.', DeprecationWarning)
        return self._invoke('create',
                            {
                            'domain_id': domain_id,
                            })
class SyncStats(VapiInterface):
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.directory.domains.SyncStats.get is deprecated.', DeprecationWarning)
        return self._invoke('get',
                            {
                            'domain_id': domain_id,
                            })
...
class _OrgUnitsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        create_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/api/v1/directory/domains/{domain-id}/org-units',
            path_variables={
                'domain_id': 'domain-id',
            },
             header_parameters={
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx.directory.domains.org_units',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
