...
class MacTable(VapiInterface):
    ...
    def list(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.logical_ports.MacTable.list is deprecated.', DeprecationWarning)
...
class State(VapiInterface):
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.logical_ports.State.get is deprecated.', DeprecationWarning)
        return self._invoke('get',
                            {
                            'lport_id': lport_id,
                            })
class Statistics(VapiInterface):
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.logical_ports.Statistics.get is deprecated.', DeprecationWarning)
        return self._invoke('get',
                            {
                            'lport_id': lport_id,
                            'source': source,
...
class Status(VapiInterface):
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.logical_ports.Status.get is deprecated.', DeprecationWarning)
        return self._invoke('get',
                            {
                            'lport_id': lport_id,
                            'source': source,
    ...
    def getall(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.logical_ports.Status.getall is deprecated.', DeprecationWarning)
