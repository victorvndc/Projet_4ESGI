...
#
# vAPI stub file for package com.vmware.nsx.cluster.nodes.network.interfaces.
#---------------------------------------------------------------------------
...
class Stats(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx.cluster.nodes.network.interfaces.stats'
    """
...
class _StatsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/api/v1/cluster/nodes/{node-id}/network/interfaces/{interface-id}/stats',
            path_variables={
                'node_id': 'node-id',
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx.cluster.nodes.network.interfaces.stats',
