...
#
# vAPI stub file for package com.vmware.nsx.cluster.nodes.network.
#---------------------------------------------------------------------------
...
class Interfaces(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx.cluster.nodes.network.interfaces'
    """
    ...
    def list(self,
        ...
        and the IP configuration method (static or DHCP). Note that if virtual
        IP (VIP) addresses are configured, virtual interfaces will not be
        returned.
...
class _InterfacesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/api/v1/cluster/nodes/{node-id}/network/interfaces/{interface-id}',
            path_variables={
                'node_id': 'node-id',
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/api/v1/cluster/nodes/{node-id}/network/interfaces',
            path_variables={
                'node_id': 'node-id',
            },
             header_parameters={
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx.cluster.nodes.network.interfaces',
...
class StubFactory(StubFactoryBase):
    _attrs = {
        ...
        'interfaces': 'com.vmware.nsx.cluster.nodes.network.interfaces_client.StubFactory',
    }
