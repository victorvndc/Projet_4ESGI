...
class Config(VapiInterface):
    ...
    def get(self):
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.cluster.restore.Config.get is deprecated.', DeprecationWarning)
    ...
    def update(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.cluster.restore.Config.update is deprecated.', DeprecationWarning)
...
class Status(VapiInterface):
    ...
    """
    GET_RESTORE_COMPONENT_LOCAL_MANAGER = "LOCAL_MANAGER"
    """
    Possible value for ``restoreComponent`` of method :func:`Status.get`.

    """
    GET_RESTORE_COMPONENT_GLOBAL_MANAGER = "GLOBAL_MANAGER"
    """
    Possible value for ``restoreComponent`` of method :func:`Status.get`.
    ...
    def get(self,
            restore_component=None,
            ):
        """
        Returns status information for the specified NSX cluster restore
        request.

        :type  restore_component: :class:`str` or ``None``
        :param restore_component: (optional, default to LOCAL_MANAGER)
...
class _StatusStub(ApiInterfaceStub):
    def __init__(self, config):
        # properties for get operation
        get_input_type = type.StructType('operation-input', {
            'restore_component': type.OptionalType(type.StringType()),
        })
        get_error_dict = {
            'com.vmware.vapi.std.errors.invalid_request':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidRequest'),
...
class StubFactory(StubFactoryBase):
    _attrs = {
        ...
        'Status': Status,
        'action': 'com.vmware.nsx.cluster.restore.action_client.StubFactory',
    }
