...
class Observations(VapiInterface):
    ...
    """
    LIST_COMPONENT_TYPE_EDGE_RTEP_TUNNEL = "EDGE_RTEP_TUNNEL"
    """
    Possible value for ``componentType`` of method :func:`Observations.list`.
    ...
    """
    LIST_COMPONENT_TYPE_ANTREA_SPOOFGUARD = "ANTREA_SPOOFGUARD"
    """
    Possible value for ``componentType`` of method :func:`Observations.list`.

    """
    LIST_COMPONENT_TYPE_ANTREA_LB = "ANTREA_LB"
    """
    Possible value for ``componentType`` of method :func:`Observations.list`.

    """
    LIST_COMPONENT_TYPE_ANTREA_ROUTING = "ANTREA_ROUTING"
    """
    Possible value for ``componentType`` of method :func:`Observations.list`.

    """
    LIST_COMPONENT_TYPE_ANTREA_DFW = "ANTREA_DFW"
    """
    Possible value for ``componentType`` of method :func:`Observations.list`.

    """
    LIST_COMPONENT_TYPE_ANTREA_FORWARDING = "ANTREA_FORWARDING"
    """
    Possible value for ``componentType`` of method :func:`Observations.list`.

    """
    LIST_COMPONENT_TYPE_HOST_SWITCH = "HOST_SWITCH"
    """
    Possible value for ``componentType`` of method :func:`Observations.list`.
    ...
    """
    LIST_RESOURCE_TYPE_TRACEFLOWOBSERVATIONPROTECTED = "TraceflowObservationProtected"
    """
    Possible value for ``resourceType`` of method :func:`Observations.list`.
    ...
    def list(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.traceflows.Observations.list is deprecated.', DeprecationWarning)
