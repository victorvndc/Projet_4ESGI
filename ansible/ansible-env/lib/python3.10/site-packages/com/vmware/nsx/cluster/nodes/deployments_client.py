...
#
# vAPI stub file for package com.vmware.nsx.cluster.nodes.deployments.
#---------------------------------------------------------------------------
...
class Status(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx.cluster.nodes.deployments.status'
    """
...
class _StatusStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/api/v1/cluster/nodes/deployments/{node-id}/status',
            path_variables={
                'node_id': 'node-id',
            },
             header_parameters={
        ...
        operations = {
            'get': {
                ...
                'output_type': type.ReferenceType('com.vmware.nsx.model_client', 'ClusterNodeVMDeploymentStatusReport'),
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx.cluster.nodes.deployments.status',
