...
class AggregateInfo(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx.migration.migration_unit_groups.aggregate_info'
    """
...
class MigrationUnit(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx.migration.migration_unit_groups.migration_unit'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class Status(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx.migration.migration_unit_groups.status'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    def list(self,
        ...
        """
        Get migration status for migration units in the specified group. User
        can specify whether to show only the migration units with errors.
