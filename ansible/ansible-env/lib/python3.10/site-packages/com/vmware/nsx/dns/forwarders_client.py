...
class FailedQueries(VapiInterface):
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.dns.forwarders.FailedQueries.get is deprecated.', DeprecationWarning)
...
class Nslookup(VapiInterface):
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.dns.forwarders.Nslookup.get is deprecated.', DeprecationWarning)
        return self._invoke('get',
                            {
                            'forwarder_id': forwarder_id,
                            'address': address,
...
class State(VapiInterface):
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.dns.forwarders.State.get is deprecated.', DeprecationWarning)
        return self._invoke('get',
                            {
                            'forwarder_id': forwarder_id,
...
class Statistics(VapiInterface):
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.dns.forwarders.Statistics.get is deprecated.', DeprecationWarning)
        return self._invoke('get',
                            {
                            'forwarder_id': forwarder_id,
                            })
class Status(VapiInterface):
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.dns.forwarders.Status.get is deprecated.', DeprecationWarning)
        return self._invoke('get',
                            {
                            'forwarder_id': forwarder_id,
                            })
