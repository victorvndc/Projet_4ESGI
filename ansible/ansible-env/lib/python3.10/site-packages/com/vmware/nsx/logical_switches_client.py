...
class State(VapiInterface):
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.logical_switches.State.get is deprecated.', DeprecationWarning)
    ...
    def list(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.logical_switches.State.list is deprecated.', DeprecationWarning)
        return self._invoke('list',
                            {
                            'status': status,
                            })
class Statistics(VapiInterface):
    ...
    def get(self,
        ...
        """
        Returns statistics of a specified logical switch. For real time
        statistics source, transport_node_id and stats_type are mandatory.
        ...
        :param stats_type: Logical switch statistics type. (optional)
        :type  transport_node_id: :class:`str` or ``None``
        :param transport_node_id: TransportNode Id (optional)
...
class Status(VapiInterface):
    ...
    """
    GET_SWITCH_TYPE_DEFAULT = "DEFAULT"
    """
    Possible value for ``switchType`` of method :func:`Status.get`.

    """
    GET_SWITCH_TYPE_SERVICE_PLANE = "SERVICE_PLANE"
    """
    Possible value for ``switchType`` of method :func:`Status.get`.

    """
    GET_SWITCH_TYPE_DHCP_RELAY = "DHCP_RELAY"
    """
    Possible value for ``switchType`` of method :func:`Status.get`.

    """
    GET_SWITCH_TYPE_GLOBAL = "GLOBAL"
    """
    Possible value for ``switchType`` of method :func:`Status.get`.

    """
    GET_SWITCH_TYPE_INTER_ROUTER = "INTER_ROUTER"
    """
    Possible value for ``switchType`` of method :func:`Status.get`.

    """
    GET_SWITCH_TYPE_EVPN = "EVPN"
    """
    Possible value for ``switchType`` of method :func:`Status.get`.

    """
    GET_SWITCH_TYPE_DVPG = "DVPG"
    """
    Possible value for ``switchType`` of method :func:`Status.get`.
...
class Summary(VapiInterface):
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.logical_switches.Summary.get is deprecated.', DeprecationWarning)
        return self._invoke('get',
                            {
                            'lswitch_id': lswitch_id,
                            })
...
class StubFactory(StubFactoryBase):
    _attrs = {
        ...
        'Summary': Summary,
        'VtepTable': VtepTable,
        'inter_site_forwarder': 'com.vmware.nsx.logical_switches.inter_site_forwarder_client.StubFactory',
    }
