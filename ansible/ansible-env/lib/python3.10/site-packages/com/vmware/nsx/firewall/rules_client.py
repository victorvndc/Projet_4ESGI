...
#
# vAPI stub file for package com.vmware.nsx.firewall.rules.
#---------------------------------------------------------------------------
...
class State(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx.firewall.rules.state'
    """
    ...
    def get(self,
        ...
        """
        Return realized state information of a firewall rule. Returned response
        is same as rule's section realization state response. 
        ...
        :rtype: :class:`com.vmware.nsx.model_client.RuleState`
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.firewall.rules.State.get is deprecated.', DeprecationWarning)
...
class _StateStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/api/v1/firewall/rules/{rule-id}/state',
            path_variables={
                'rule_id': 'rule-id',
            },
             header_parameters={
        ...
        operations = {
            'get': {
                ...
                'output_type': type.ReferenceType('com.vmware.nsx.model_client', 'RuleState'),
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx.firewall.rules.state',
