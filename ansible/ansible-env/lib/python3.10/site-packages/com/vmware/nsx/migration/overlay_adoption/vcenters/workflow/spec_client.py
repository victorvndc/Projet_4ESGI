...
#
# vAPI stub file for package com.vmware.nsx.migration.overlay_adoption.vcenters.workflow.spec.
#---------------------------------------------------------------------------
...
class Search(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx.migration.overlay_adoption.vcenters.workflow.spec.search'
    """
    ...
    def create(self,
        ...
        :return: com.vmware.nsx.model.WorkflowSpec
            The return value will contain all the attributes defined in
            :class:`com.vmware.nsx.model_client.WorkflowSpec`.
...
class _SearchStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        create_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/api/v1/migration/overlay-adoption/vcenters/{vcenter-id}/workflow/spec/search',
        ...
        operations = {
            'create': {
                ...
                'output_type': type.DynamicStructType('vmware.vapi.dynamic_struct', {}, VapiStruct, [type.ReferenceType('com.vmware.nsx.model_client', 'WorkflowSpec')]),
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx.migration.overlay_adoption.vcenters.workflow.spec.search',
