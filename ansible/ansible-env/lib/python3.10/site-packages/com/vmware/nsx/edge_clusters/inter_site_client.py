...
#
# vAPI stub file for package com.vmware.nsx.edge_clusters.inter_site.
#---------------------------------------------------------------------------
...
class Status(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx.edge_clusters.inter_site.status'
    """
    ...
    def get(self,
        ...
        :rtype: :class:`com.vmware.nsx.model_client.EdgeClusterInterSiteStatus`
...
class _StatusStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/api/v1/edge-clusters/{edge-cluster-id}/inter-site/status',
            path_variables={
        ...
        operations = {
            'get': {
                ...
                'output_type': type.ReferenceType('com.vmware.nsx.model_client', 'EdgeClusterInterSiteStatus'),
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx.edge_clusters.inter_site.status',
