...
#
# vAPI stub file for package com.vmware.nsx.directory.
#---------------------------------------------------------------------------
...
class DomainSize(VapiInterface):
    """
    
    """

    _VAPI_SERVICE_ID = 'com.vmware.nsx.directory.domain_size'
    """
    ...
    def __init__(self, config):
        ...
        """
        VapiInterface.__init__(self, config, _DomainSizeStub)
    ...
    def create(self,
        ...
        :param directory_domain: (required)
            ...
            :class:`com.vmware.nsx.model_client.DirectoryDomain`.
        :rtype: :class:`com.vmware.nsx.model_client.DirectoryDomainSize`
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.directory.DomainSize.create is deprecated.', DeprecationWarning)
...
class Domains(VapiInterface):
    ...
    """
    Possible value for ``action`` of method :func:`Domains.create_0`.
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx.directory.domains'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    def create(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.directory.Domains.create is deprecated.', DeprecationWarning)
        return self._invoke('create',
                            {
                            'directory_domain': directory_domain,
                            })
    ...
    def create_0(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.directory.Domains.create_0 is deprecated.', DeprecationWarning)
    ...
    def delete(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.directory.Domains.delete is deprecated.', DeprecationWarning)
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.directory.Domains.get is deprecated.', DeprecationWarning)
    ...
    def list(self,
        ...
        :rtype: :class:`com.vmware.nsx.model_client.DirectoryDomainListResults`
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.directory.Domains.list is deprecated.', DeprecationWarning)
    ...
    def update(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.directory.Domains.update is deprecated.', DeprecationWarning)
        return self._invoke('update',
                            {
                            'domain_id': domain_id,
                            'directory_domain': directory_domain,
                            })
class LdapServer(VapiInterface):
    """
    
    """
    CREATE_ACTION_CONNECTIVITY = "CONNECTIVITY"
    """
    Possible value for ``action`` of method :func:`LdapServer.create`.

    """

    _VAPI_SERVICE_ID = 'com.vmware.nsx.directory.ldap_server'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
        ...
        :param config: Configuration to be used for creating the stub.
        """
        VapiInterface.__init__(self, config, _LdapServerStub)
        self._VAPI_OPERATION_IDS = {}
    ...
    def create(self,
        ...
        :rtype: :class:`com.vmware.nsx.model_client.DirectoryLdapServerStatus`
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.directory.LdapServer.create is deprecated.', DeprecationWarning)
        return self._invoke('create',
                            {
...
class OrgUnits(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx.directory.org_units'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    def create(self,
        ...
        :type  directory_ldap_server: :class:`com.vmware.nsx.model_client.DirectoryLdapServer`
        :param directory_ldap_server: (required)
        :rtype: :class:`com.vmware.nsx.model_client.DirectoryOrgUnitListResults`
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            Not Found
        """
        warn('com.vmware.nsx.directory.OrgUnits.create is deprecated.', DeprecationWarning)
        return self._invoke('create',
                            {
                            'directory_ldap_server': directory_ldap_server,
                            })
class _DomainSizeStub(ApiInterfaceStub):
    def __init__(self, config):
        # properties for create operation
        create_input_type = type.StructType('operation-input', {
            'directory_domain': type.DynamicStructType('vmware.vapi.dynamic_struct', {}, VapiStruct, [type.ReferenceType('com.vmware.nsx.model_client', 'DirectoryDomain')]),
        })
        create_error_dict = {
        ...
        create_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/api/v1/directory/domain-size',
        ...
        operations = {
            'create': {
                ...
                'output_type': type.ReferenceType('com.vmware.nsx.model_client', 'DirectoryDomainSize'),
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx.directory.domain_size',
...
class _DomainsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        operations = {
            'create': {
                'input_type': create_input_type,
                'output_type': type.DynamicStructType('vmware.vapi.dynamic_struct', {}, VapiStruct, [type.ReferenceType('com.vmware.nsx.model_client', 'DirectoryDomain')]),
                'errors': create_error_dict,
                'input_value_validator_list': create_input_value_validator_list,
                'output_validator_list': create_output_validator_list,
                'task_type': TaskType.NONE,
            ...
            'list': {
                ...
                'output_type': type.ReferenceType('com.vmware.nsx.model_client', 'DirectoryDomainListResults'),
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx.directory.domains',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)

class _LdapServerStub(ApiInterfaceStub):
    def __init__(self, config):
        # properties for create operation
        create_input_type = type.StructType('operation-input', {
        ...
        create_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/api/v1/directory/ldap-server',
        ...
        operations = {
            'create': {
                'input_type': create_input_type,
                'output_type': type.ReferenceType('com.vmware.nsx.model_client', 'DirectoryLdapServerStatus'),
                'errors': create_error_dict,
                'input_value_validator_list': create_input_value_validator_list,
                'output_validator_list': create_output_validator_list,
                'task_type': TaskType.NONE,
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx.directory.ldap_server',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class _OrgUnitsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        create_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/api/v1/directory/org-units',
            request_body_parameter='directory_ldap_server',
            path_variables={
            },
             header_parameters={
        ...
        operations = {
            'create': {
                'input_type': create_input_type,
                'output_type': type.ReferenceType('com.vmware.nsx.model_client', 'DirectoryOrgUnitListResults'),
                'errors': create_error_dict,
                'input_value_validator_list': create_input_value_validator_list,
                'output_validator_list': create_output_validator_list,
                'task_type': TaskType.NONE,
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx.directory.org_units',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class StubFactory(StubFactoryBase):
    _attrs = {
        ...
        'OrgUnits': OrgUnits,
        'domains': 'com.vmware.nsx.directory.domains_client.StubFactory',
    }
