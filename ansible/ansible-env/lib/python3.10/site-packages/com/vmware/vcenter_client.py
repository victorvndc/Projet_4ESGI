...
class System(VapiInterface):
    ...
    class HelloResult(VapiStruct):
        ...
        parameters. This class was added in vSphere API 8.0.2.0.
        ...
        def __init__(self,
            ...
            :param api_release: The ID of a mutually-supported API release. This ID should be used
                ...
                the parties is much older than the other party.. This attribute was
    ...
    class HelloSpec(VapiStruct):
        """
        The ``System.HelloSpec`` class describes the API client preferences. This
        class was added in vSphere API 8.0.2.0.
        ...
        def __init__(self,
            ...
            :param api_releases: List of API release IDs that the client can work with in order of
                ...
                release ID. This attribute was added in vSphere API 8.0.2.0.
            """
    ...
    def hello(self,
        ...
        :attr:`System.HelloSpec.api_releases` list.. This method was added in
        vSphere API 8.0.2.0.
